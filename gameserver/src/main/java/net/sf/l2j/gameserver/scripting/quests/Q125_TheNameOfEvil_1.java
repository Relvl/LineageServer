...
public final class Q125_TheNameOfEvil_1 extends Quest {
    ...
    public Q125_TheNameOfEvil_1() {
        ...
        for (int i : ORNITHOMIMUS) { addKillId(i); }

        for (int i : DEINONYCHUS) { addKillId(i); }
    }
    ...
    public String onTalk(L2Npc npc, L2PcInstance player) {
        ...
        switch (st.getState()) {
            case QuestState.STATE_CREATED:
                ...
                if (first != null && first.isCompleted() && player.getLevel() >= 76) { htmltext = "32114-01.htm"; }
                else { htmltext = "32114-00.htm"; }
                break;
            ...
            case QuestState.STATE_STARTED:
                ...
                switch (npc.getNpcId()) {
                    case MUSHIKA:
                        if (cond == 1) { htmltext = "32114-07.htm"; }
                        else if (cond == 2) { htmltext = "32114-10.htm"; }
                        else if (cond > 2 && cond < 8) { htmltext = "32114-11.htm"; }
                        else if (cond == 8) {
                    ...
                    case KARAKAWEI:
                        if (cond == 2) { htmltext = "32117-01.htm"; }
                        else if (cond == 3) { htmltext = "32117-09.htm"; }
                        else if (cond == 4) {
                        ...
                        else if (cond == 5) { htmltext = "32117-15.htm"; }
                        else if (cond == 6 || cond == 7) { htmltext = "32117-16.htm"; }
                        else if (cond == 8) { htmltext = "32117-17.htm"; }
                        break;
                    ...
                    case ULU_KAIMU:
                        ...
                        else if (cond == 6) { htmltext = "32119-14.htm"; }
                        break;
                    ...
                    case BALU_KAIMU:
                        ...
                        else if (cond == 7) { htmltext = "32120-16.htm"; }
                        break;
                    ...
                    case CHUTA_KAIMU:
                        ...
                        else if (cond == 8) { htmltext = "32121-17.htm"; }
                        break;
                }
                break;
    ...
    public final String onKill(L2Npc npc, L2PcInstance player, boolean isPet) {
        ...
        if (Util.contains(ORNITHOMIMUS, npcId)) {
            if (st.dropItems(ORNITHOMIMUS_CLAW, 1, 2, 50000)) { if (st.getQuestItemsCount(DEINONYCHUS_BONE) == 2) { st.set("cond", "4"); } }
        }
        else if (Util.contains(DEINONYCHUS, npcId)) {
            if (st.dropItems(DEINONYCHUS_BONE, 1, 2, 50000)) { if (st.getQuestItemsCount(ORNITHOMIMUS_CLAW) == 2) { st.set("cond", "4"); } }
        }
        return null;
    }
}