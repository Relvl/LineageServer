    ...
    public String onTalk(L2Npc npc, L2PcInstance player) {
        ...
        switch (st.getState()) {
            ...
            case QuestState.STATE_STARTED:
                ...
                switch (npc.getNpcId()) {
                    case BOLTER:
                        if (cond == 1) { htmltext = "30554-04.htm"; }
                        else if (cond == 2) {
                    ...
                    case REED:
                        ...
                        else { htmltext = "30520-02.htm"; }
                        break;

                    case BRUNON:
                        if (cond == 1 && !st.hasQuestItems(MINERS_PICK)) { htmltext = "30526-01.htm"; }
                        else { htmltext = "30526-03.htm"; }
                        break;
                }
                break;
