...
public class Q123_TheLeaderAndTheFollower extends Quest {
    ...
    public String onAdvEvent(String event, L2Npc npc, L2PcInstance player) {
        ...
        if (event.equalsIgnoreCase("31961-02.htm")) {
            ...
            else { htmltext = "Incorrect item count"; }
        }
                ...
                if (apprentice != null) {
                    ...
                    if (apQuest != null) {
                        ...
                        if (st.getQuestItemsCount(1458) >= crystals) {
                            ...
                            apQuest.set("cond", "6");
                            apQuest.playSound(ESound.ItemSound_quest_middle);
                        }
                    }
                }
            }
        ...
        switch (st.getState()) {
            case QuestState.STATE_CREATED:
                ...
                if (player.getSponsor() > 0) {
                    if (player.getLevel() > 19 && player.getPledgeType() == -1) { return "31961-01.htm"; }
                }
                // Case of sponsor.
                    ...
                    if (cm != null && cm.isOnline()) {
                        ...
                        if (apprentice != null) {
                            ...
                            if (apQuest != null) {
                                ...
                                if (apCond == 3) { return "31961-09a.htm"; }
                                else if (apCond == 4) { return "31961-09b.htm"; }
                                else if (apCond == 5) { return "31961-09c.htm"; }
                            }
                        }
                    }
                }
            ...
            case QuestState.STATE_STARTED:
                ...
                // Case of academian.
                if (player.getSponsor() > 0) {
                    if (cond == 1) { htmltext = "31961-03.htm"; }
                    else if (cond == 2) { htmltext = "31961-04.htm"; }
                    else if (cond == 3) { htmltext = "31961-05d.htm"; }
                    else if (cond == 4) { htmltext = "31961-05e.htm"; }
                    else if (cond == 5) { htmltext = "31961-05f.htm"; }
                    else if (cond == 6) {
                        htmltext = "31961-06.htm";
                        st.set("cond", "7");
                        st.playSound(ESound.ItemSound_quest_middle);
                    }
                    else if (cond == 7) { htmltext = "31961-07.htm"; }
                    else if (cond == 8) {
    ...
    public String onKill(L2Npc npc, L2PcInstance player, boolean isPet) {
        ...
        switch (npc.getNpcId()) {
            case BRUIN_LIZARDMAN:
                if (st.getInt("cond") == 1 && st.dropItems(BLOOD, 1, 10, 600000)) { st.set("cond", "2"); }
                break;
            ...
            case PICOT_ARENEID:
                ...
                if (cmSponsor != null && cmSponsor.isOnline()) {
                    ...
                    if (sponsorHelper != null && player.isInsideRadius(sponsorHelper, 1100, true, false)) {
                        if (st.getInt("cond") == 7 && st.dropItems(LEG, 1, 8, 700000)) { st.set("cond", "8"); }
                    }
                }
                break;
        }
