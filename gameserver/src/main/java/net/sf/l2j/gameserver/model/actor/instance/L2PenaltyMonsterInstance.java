...
public class L2PenaltyMonsterInstance extends L2MonsterInstance {
    ...
    public void setPlayerToKill(L2PcInstance ptk) {
        if (Rnd.get(100) <= 80) { broadcastNpcSay("Your bait was too delicious! Now, I will kill you!"); }
    ...
    public boolean doDie(L2Character killer) {
        ...
        if (Rnd.get(100) <= 75) { broadcastNpcSay("I will tell fish not to take your bait!"); }
