...
public class Q337_AudienceWithTheLandDragon extends Quest {
    ...
    // Variables
    private static boolean _jewel1;
    private static boolean _jewel2;
    private static boolean _jewel3;
    ...
    public String onTalk(L2Npc npc, L2PcInstance player) {
        ...
        switch (st.getState()) {
            ...
            case QuestState.STATE_STARTED:
                ...
                switch (npc.getNpcId()) {
                    case GABRIELLE:
                        if (cond == 1) { htmltext = (st.getQuestItemsCount(MARK_OF_WATCHMAN) < 4) ? "30753-06.htm" : "30753-08.htm"; }
                        else if (cond == 2) {
                            if (st.getQuestItemsCount(MARK_OF_WATCHMAN) < 2) { htmltext = "30753-10.htm"; }
                            else {
                        ...
                        else if (cond == 3) { htmltext = "30753-12.htm"; }
                        else if (cond == 4) { htmltext = "30753-13.htm"; }
                        break;
                    ...
                    case ORVEN:
                        if (cond == 1) {
                            if (st.getInt("drop1") == 1) {
                                ...
                                else { htmltext = "30857-01.htm"; }
                            }
                            else if (st.getQuestItemsCount(MARK_OF_WATCHMAN) < 4) { htmltext = "30857-03.htm"; }
                            else { htmltext = "30857-04.htm"; }
                        }
                        break;
                    ...
                    case KENDRA:
                        if (cond == 1) {
                            if (st.getInt("drop2") == 1) {
                                ...
                                else { htmltext = "30851-01.htm"; }
                            }
                            else if (st.getQuestItemsCount(MARK_OF_WATCHMAN) < 4) { htmltext = "30851-03.htm"; }
                            else { htmltext = "30851-04.htm"; }
                        }
                        break;
                    ...
                    case CHAKIRIS:
                        if (cond == 1) {
                            if (st.getInt("drop3") == 1) {
                                ...
                                else { htmltext = "30705-01.htm"; }
                            }
                            else if (st.getQuestItemsCount(MARK_OF_WATCHMAN) < 4) { htmltext = "30705-03.htm"; }
                            else { htmltext = "30705-04.htm"; }
                        }
                        break;
                    ...
                    case KAIENA:
                        if (cond == 1) {
                            if (st.getInt("drop4") == 1) {
                                ...
                                else { htmltext = "30720-01.htm"; }
                            }
                            else if (st.getQuestItemsCount(MARK_OF_WATCHMAN) < 4) { htmltext = "30720-03.htm"; }
                            else { htmltext = "30720-04.htm"; }
                        }
                        break;
                        ...
                        if (cond == 2) {
                            switch (st.getInt("drop5")) {
                                ...
                                case 1:
                                    ...
                                    else { htmltext = "30498-02.htm"; }
                                    break;

                                case 0:
                                    if (st.getQuestItemsCount(MARK_OF_WATCHMAN) < 2) { htmltext = "30498-04.htm"; }
                                    else { htmltext = "30498-05.htm"; }
                                    break;
                            }
                        }
                        break;
                        ...
                        if (cond == 2) {
                            switch (st.getInt("drop6")) {
                                ...
                                case 1:
                                    ...
                                    else { htmltext = "30678-02.htm"; }
                                    break;

                                case 0:
                                    if (st.getQuestItemsCount(MARK_OF_WATCHMAN) < 2) { htmltext = "30678-04.htm"; }
                                    else { htmltext = "30678-05.htm"; }
                                    break;
                            }
                        }
                        break;
                    ...
                    case GILMORE:
                        if (cond == 1 || cond == 2) { htmltext = "30754-01.htm"; }
                        else if (cond == 3) {
                        ...
                        else if (cond == 4) { htmltext = (!st.hasQuestItems(THIRD_FRAGMENT_OF_ABYSS_JEWEL)) ? "30754-04.htm" : "30754-05.htm"; }
                        break;

                    case THEODRIC:
                        if (cond == 1 || cond == 2) { htmltext = "30755-01.htm"; }
                        else if (cond == 3) { htmltext = "30755-02.htm"; }
                        else if (cond == 4) { htmltext = (!st.hasQuestItems(THIRD_FRAGMENT_OF_ABYSS_JEWEL)) ? "30755-03.htm" : "30755-04.htm"; }
                        break;
                }
                break;
        }
    ...
    public String onAttack(L2Npc npc, L2PcInstance attacker, int damage, boolean isPet) {
        ...
        if (st == null) { return super.onAttack(npc, attacker, damage, isPet); }

        int npcId = npc.getNpcId();

        for (int[] npcInfo : DROP_ON_ATTACK) {
            if (npcInfo[0] != npcId) { continue; }

            if (npcInfo[1] != st.getInt("cond")) { break; }

            double percentHp = ((npc.getCurrentHp() + damage) * 100) / npc.getMaxHp();
            ...
            // spawn monsters and register spawned
                ...
                if (Rnd.get(100) < 33 && st.getInt("drop" + npcInfo[2]) == 1) {
                    boolean spawn;
                    if (npcId == ABYSSAL_JEWEL_3) { spawn = _jewel3; }
                    else if (npcId == ABYSSAL_JEWEL_2) { spawn = _jewel2; }
                    else { spawn = _jewel1; }
                    ...
                    if (spawn) {
                        ...
                        if (npcId == ABYSSAL_JEWEL_3) { _jewel3 = false; }
                        else if (npcId == ABYSSAL_JEWEL_2) { _jewel2 = false; }
                        else { _jewel1 = false; }
                    }
                }
            }
            // reset spawned if npc regenerated to 90% HP and more
                ...
                if (npcId == ABYSSAL_JEWEL_3) { _jewel3 = true; }
                else if (npcId == ABYSSAL_JEWEL_2) { _jewel2 = true; }
                else { _jewel1 = true; }
            }
            break;
        }
        ...
        switch (npcId) {
            ...
            case BLOOD_QUEEN:// Orven's request
                if (cond == 1 && st.getInt("drop1") == 1 && !st.hasQuestItems(REMAINS_OF_SACRIFIED)) {
                    for (int i = 0; i < 8; i++) { addSpawn(SACRIFICE_OF_THE_SACRIFICED, npc.getX() + Rnd.get(-100, 100), npc.getY() + Rnd.get(-100, 100), npc.getZ(), npc.getHeading(), true, 60000, false); }
                }
                break;
            ...
            case HARIT_LIZARDMAN_MATRIARCH:
                if (cond == 1 && Rnd.get(5) == 0 && st.getInt("drop2") == 1 && !st.hasQuestItems(TOTEM_OF_LAND_DRAGON)) {
                    for (int i = 0; i < 3; i++) { addSpawn(HARIT_LIZARDMAN_ZEALOT, npc.getX() + Rnd.get(-50, 50), npc.getY() + Rnd.get(-50, 50), npc.getZ(), npc.getHeading(), true, 60000, false); }
                }
                break;
