    ...
    public String onTalk(L2Npc npc, L2PcInstance player) {
        ...
        switch (st.getState()) {
            case QuestState.STATE_CREATED:
                if (player.getRace() != PlayerRace.DarkElf) { htmltext = "30476-02.htm"; }
                else if (player.getLevel() < 37 || player.getClassId().level() != 1) { htmltext = "30476-01.htm"; }
                else { htmltext = "30476-03.htm"; }
                break;
            ...
            case QuestState.STATE_STARTED:
                ...
                switch (npc.getNpcId()) {
                    case KAIRA:
                        if (cond == 1) { htmltext = "30476-06.htm"; }
                        else if (cond == 2 || cond == 3) { htmltext = "30476-07.htm"; }
                        else if (cond > 3 && cond < 9) { htmltext = "30476-08.htm"; }
                        else if (cond == 9) {
                        ...
                        else if (cond > 9 && cond < 13) { htmltext = "30476-10.htm"; }
                        else if (cond == 13) { htmltext = "30476-11.htm"; }
                        else if (cond == 14) {
                            if (player.getLevel() < 38) { htmltext = "30476-14.htm"; }
                            else {
                        ...
                        else if (cond == 15) { htmltext = "30476-16.htm"; }
                        else if (cond > 15) { htmltext = "30476-17.htm"; }
                        break;
                    ...
                    case METHEUS:
                        ...
                        else if (cond == 2) { htmltext = "30614-02.htm"; }
                        else if (cond == 3) {
                        ...
                        else if (cond > 3 && cond < 8) { htmltext = "30614-04.htm"; }
                        else if (cond == 8) {
                        ...
                        else if (cond > 8) { htmltext = "30614-06.htm"; }
                        break;
                    ...
                    case IXIA:
                        ...
                        else if (cond == 6) { htmltext = "30463-02.htm"; }
                        else if (cond == 7) {
                        ...
                        else if (cond == 8) { htmltext = "30463-04.htm"; }
                        else if (cond > 8) { htmltext = "30463-05.htm"; }
                        break;
                    ...
                    case ROA:
                        if (cond == 11) { htmltext = "30114-01.htm"; }
                        else if (cond == 12) { htmltext = "30114-05.htm"; }
                        else if (cond > 12) { htmltext = "30114-06.htm"; }
                        break;
                    ...
                    case NORMAN:
                        ...
                        else if (cond > 12) { htmltext = "30210-02.htm"; }
                        break;
                    ...
                    case THIFIELL:
                        ...
                        else if (cond == 16) { htmltext = "30358-02.htm"; }
                        else if (cond == 17) { htmltext = "30358-03.htm"; }
                        else if (cond == 18) {
                    ...
                    case ARKENIA:
                        if (cond == 16) { htmltext = "30419-01.htm"; }
                        else if (cond == 17) { htmltext = (st.hasQuestItems(BLIGHT_TREANT_SAP) && st.hasQuestItems(RED_FAIRY_DUST)) ? "30419-04.htm" : "30419-03.htm"; }
                        else if (cond == 18) { htmltext = "30419-06.htm"; }
                        break;
                    ...
                    case BLOODY_PIXY:
                        if (cond == 17) {
                            if (st.hasQuestItems(PIXY_GARNET)) {
                                ...
                                else { htmltext = "31845-03.htm"; }
                            }
                            else if (st.hasQuestItems(RED_FAIRY_DUST)) { htmltext = "31845-05.htm"; }
                            else { htmltext = "31845-01.htm"; }
                        }
                        else if (cond == 18) { htmltext = "31845-05.htm"; }
                        break;
                    ...
                    case BLIGHT_TREANT:
                        if (cond == 17) {
                            if (st.hasQuestItems(BLIGHT_TREANT_SEED)) {
                                ...
                                else { htmltext = "31850-03.htm"; }
                            }
                            else if (st.hasQuestItems(BLIGHT_TREANT_SAP)) { htmltext = "31850-05.htm"; }
                            else { htmltext = "31850-01.htm"; }
                        }
                        else if (cond == 18) { htmltext = "31850-05.htm"; }
                        break;
                }
                break;
        ...
        switch (npcId) {
            ...
            case DEAD_SEEKER:
                if (st.getInt("cond") == 6 && st.dropItems(DEAD_SEEKER_DUNG, 1, 10, CHANCES.get(npcId))) {
                    if (st.getQuestItemsCount(TYRANT_BLOOD) >= 10 && st.getQuestItemsCount(MEDUSA_ICHOR) >= 10 && st.getQuestItemsCount(NIGHTSHADE_ROOT) >= 10 && st.getQuestItemsCount(MARSH_SPIDER_FLUIDS) >= 10) { st.set("cond", "7"); }
                }
                break;
            ...
            case TYRANT_KINGPIN:
                if (st.getInt("cond") == 6 && st.dropItems(TYRANT_BLOOD, 1, 10, CHANCES.get(npcId))) {
                    if (st.getQuestItemsCount(DEAD_SEEKER_DUNG) >= 10 && st.getQuestItemsCount(MEDUSA_ICHOR) >= 10 && st.getQuestItemsCount(NIGHTSHADE_ROOT) >= 10 && st.getQuestItemsCount(MARSH_SPIDER_FLUIDS) >= 10) { st.set("cond", "7"); }
                }
                break;

            case MEDUSA:
                if (st.getInt("cond") == 6 && st.dropItems(MEDUSA_ICHOR, 1, 10, CHANCES.get(npcId))) {
                    if (st.getQuestItemsCount(DEAD_SEEKER_DUNG) >= 10 && st.getQuestItemsCount(TYRANT_BLOOD) >= 10 && st.getQuestItemsCount(NIGHTSHADE_ROOT) >= 10 && st.getQuestItemsCount(MARSH_SPIDER_FLUIDS) >= 10) { st.set("cond", "7"); }
                }
                break;
            ...
            case MARSH_STAKATO_DRONE:
                if (st.getInt("cond") == 6 && st.dropItems(NIGHTSHADE_ROOT, 1, 10, CHANCES.get(npcId))) {
                    if (st.getQuestItemsCount(DEAD_SEEKER_DUNG) >= 10 && st.getQuestItemsCount(TYRANT_BLOOD) >= 10 && st.getQuestItemsCount(MEDUSA_ICHOR) >= 10 && st.getQuestItemsCount(MARSH_SPIDER_FLUIDS) >= 10) { st.set("cond", "7"); }
                }
                break;

            case MARSH_SPIDER:
                if (st.getInt("cond") == 6 && st.dropItems(MARSH_SPIDER_FLUIDS, 1, 10, CHANCES.get(npcId))) {
                    if (st.getQuestItemsCount(DEAD_SEEKER_DUNG) >= 10 && st.getQuestItemsCount(TYRANT_BLOOD) >= 10 && st.getQuestItemsCount(MEDUSA_ICHOR) >= 10 && st.getQuestItemsCount(NIGHTSHADE_ROOT) >= 10) { st.set("cond", "7"); }
                }
                break;

            case GRANDIS:
                if (st.hasQuestItems(PIXY_GARNET)) { st.dropItemsAlways(GRANDIS_SKULL, 1, 10); }
                break;

            case LETO_LIZARDMAN_OVERLORD:
                if (st.hasQuestItems(PIXY_GARNET)) { st.dropItemsAlways(LETO_OVERLORD_SKULL, 1, 10); }
                break;

            case BREKA_ORC_OVERLORD:
                if (st.hasQuestItems(PIXY_GARNET)) { st.dropItemsAlways(BREKA_OVERLORD_SKULL, 1, 10); }
                break;

            case KARUL_BUGBEAR:
                if (st.hasQuestItems(PIXY_GARNET)) { st.dropItemsAlways(KARUL_BUGBEAR_SKULL, 1, 10); }
                break;

            case BLACK_WILLOW_LURKER:
                if (st.hasQuestItems(BLIGHT_TREANT_SEED)) { st.dropItemsAlways(BLACK_WILLOW_LEAF, 1, 1); }
                break;
        }
