    ...
    public String onTalk(L2Npc npc, L2PcInstance player) {
        ...
        switch (st.getState()) {
            case QuestState.STATE_CREATED:
                if (player.getRace() != PlayerRace.Orc) { htmltext = "30568-00.htm"; }
                else if (player.getLevel() < 12) { htmltext = "30568-01.htm"; }
                else { htmltext = "30568-02.htm"; }
                break;
            ...
            case QuestState.STATE_STARTED:
                ...
                switch (npc.getNpcId()) {
                    case HATOS:
                        if (cond == 1 || cond == 2) { htmltext = "30568-04.htm"; }
                        else if (cond == 3) { htmltext = "30568-05.htm"; }
                        else if (cond == 4 || cond == 6) { htmltext = "30568-09.htm"; }
                        else if (cond == 5) { htmltext = "30568-08.htm"; }
                        else if (cond == 7) {
