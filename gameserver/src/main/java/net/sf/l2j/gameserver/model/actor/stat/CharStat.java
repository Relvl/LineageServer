...
public class CharStat {
    ...
    public final double calcStat(Stats stat, double init, L2Character target, L2Skill skill) {
        if (_activeChar == null || stat == null) { return init; }
    ...
    public final int getMpConsume(L2Skill skill) {
        ...
        if (skill.isDance()) {
            if (_activeChar != null && _activeChar.getDanceCount() > 0) { mpConsume += _activeChar.getDanceCount() * skill.getNextDanceMpCost(); }
        }
