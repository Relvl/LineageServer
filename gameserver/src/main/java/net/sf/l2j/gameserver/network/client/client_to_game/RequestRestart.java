...
import net.sf.l2j.gameserver.network.client.game_to_client.RestartResponse;
...
public final class RequestRestart extends L2GameClientPacket {
    ...
    protected void runImpl() {
        ...
        if (player.isFestivalParticipant()) {
            ...
            if (player.isInParty()) { player.getParty().broadcastToPartyMembers(SystemMessage.sendString(player.getName() + " has been removed from the upcoming festival.")); }
        }
