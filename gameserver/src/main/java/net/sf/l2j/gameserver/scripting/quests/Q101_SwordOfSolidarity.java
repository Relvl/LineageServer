...
public class Q101_SwordOfSolidarity extends Quest {
    ...
    public String onTalk(L2Npc npc, L2PcInstance player) {
        ...
        switch (st.getState()) {
            case QuestState.STATE_CREATED:
                if (player.getRace() != PlayerRace.Human) { htmltext = "30008-01a.htm"; }
                else if (player.getLevel() < 9) { htmltext = "30008-01.htm"; }
                else { htmltext = "30008-02.htm"; }
                break;
            ...
            case QuestState.STATE_STARTED:
                ...
                switch (npc.getNpcId()) {
                    case ROIEN:
                        if (cond == 1) { htmltext = "30008-04.htm"; }
                        else if (cond == 2) { htmltext = "30008-03a.htm"; }
                        else if (cond == 3) { htmltext = "30008-06.htm"; }
                        else if (cond == 4) {
                        ...
                        else if (cond == 5) { htmltext = "30008-05a.htm"; }
                        break;

                    case ALTRAN:
                        if (cond == 1) { htmltext = "30283-01.htm"; }
                        else if (cond == 2) { htmltext = "30283-03.htm"; }
                        else if (cond == 3) {
                        ...
                        else if (cond == 4) { htmltext = "30283-04a.htm"; }
                        else if (cond == 5) { htmltext = "30283-05.htm"; }
                        break;
                }
                break;
    ...
    public String onKill(L2Npc npc, L2PcInstance player, boolean isPet) {
        ...
        if (!st.hasQuestItems(BROKEN_BLADE_TOP)) { st.dropItems(BROKEN_BLADE_TOP, 1, 1, 200000); }
        else if (st.dropItems(BROKEN_BLADE_BOTTOM, 1, 1, 200000)) { st.set("cond", "3"); }
