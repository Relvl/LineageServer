...
public class Q212_TrialOfDuty extends Quest {
            ...
            case QuestState.STATE_STARTED:
                ...
                switch (npc.getNpcId()) {
                    ...
                    case SIR_ARON:
                        ...
                        else if (cond == 2) { htmltext = "30653-02.htm"; }
                        else if (cond == 3) {
                        ...
                        else if (cond > 3) { htmltext = "30653-04.htm"; }
                        break;
                    ...
                    case SIR_KIEL:
                        ...
                        else if (cond == 5) { htmltext = "30654-02.htm"; }
                        else if (cond == 6) {
                        ...
                        else if (cond == 7) { htmltext = "30654-04.htm"; }
                        else if (cond == 9) {
                        ...
                        else if (cond > 9) { htmltext = "30654-06.htm"; }
                        break;
                    ...
                    case SILVERSHADOW:
                        if (cond == 10) {
                            if (player.getLevel() < 35) { htmltext = "30655-01.htm"; }
                            else {
                        ...
                        else if (cond == 11) { htmltext = "30655-03.htm"; }
                        else if (cond == 12) {
                        ...
                        else if (cond == 13) { htmltext = "30655-05.htm"; }
                        break;

                    case DUSTIN:
                        if (cond == 13) { htmltext = "30116-01.htm"; }
                        else if (cond == 14) { htmltext = "30116-06.htm"; }
                        else if (cond == 15) {
                        ...
                        else if (cond == 16) { htmltext = "30116-09.htm"; }
                        else if (cond == 17) {
                        ...
                        else if (cond == 18) { htmltext = "30116-10.htm"; }
                        break;
                    ...
                    case SIR_COLLIN:
                        ...
                        else if (cond > 16) { htmltext = "30311-02.htm"; }
                        break;
                }
                break;
    ...
    public String onKill(L2Npc npc, L2PcInstance player, boolean isPet) {
        ...
        switch (npc.getNpcId()) {
            ...
            case 27119:
                if (cond == 2 && st.getItemEquipped(EPaperdollSlot.PAPERDOLL_RHAND) == OLD_KNIGHT_SWORD) {
                    st.set("cond", "3");
                    st.playSound(ESound.ItemSound_quest_middle);
            ...
            case 20581:
            case 20582:
                if (cond == 11 && st.dropItemsAlways(MILITAS_ARTICLE, 1, 20)) { st.set("cond", "12"); }
                break;
