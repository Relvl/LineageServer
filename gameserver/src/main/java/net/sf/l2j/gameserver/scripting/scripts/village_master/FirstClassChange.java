    ...
    public String onAdvEvent(String event, L2Npc npc, L2PcInstance player) {
        ...
        if (Classes.containsKey(event)) {
            ...
            if (player.getClassId().getId() == array[1] && player.getRace().ordinal() == array[2]) {
                ...
                if (player.getLevel() < 20) { suffix = "-" + ((gotItem) ? array[4] : array[3]); }
                else {
                    if (gotItem) {
                        suffix = "-" + array[6];
            ...
            else { htmltext = npc.getNpcId() + "-" + array[8] + ".htm"; }
        }
        ...
        switch (npcId) {
            ...
            case 30462:
                if (player.getRace() == PlayerRace.DarkElf) {
                    if (player.getClassId().level() == 0) {
                        if (player.getClassId().getId() == 31) { htmltext = npcId + "-01.htm"; }
                        else if (player.getClassId().getId() == 38) { htmltext = npcId + "-08.htm"; }
                    }
                    else if (player.getClassId().level() == 1) { htmltext = npcId + "-32.htm"; }
                    else { htmltext = npcId + "-31.htm"; }
                }
                else { htmltext = npcId + "-33.htm"; }
                break;
            ...
            case 30358: // Thifiell (dark elf)
                if (player.getRace() == PlayerRace.DarkElf) {
                    if (player.getClassId().level() == 0) {
                        if (player.getClassId().getId() == 31) { htmltext = npcId + "-01.htm"; }
                        else if (player.getClassId().getId() == 38) { htmltext = npcId + "-02.htm"; }
                    }
                    else if (player.getClassId().level() == 1) { htmltext = npcId + "-12.htm"; }
                    else { htmltext = npcId + "-13.htm"; }
                }
                else { htmltext = npcId + "-11.htm"; }
                break;
            ...
            case 32097:
                if (player.getRace() == PlayerRace.Orc) {
                    if (player.getClassId().level() == 0) {
                        if (player.getClassId().getId() == 44) { htmltext = npcId + "-01.htm"; }
                        else if (player.getClassId().getId() == 49) { htmltext = npcId + "-06.htm"; }
                    }
                    else if (player.getClassId().level() == 1) { htmltext = npcId + "-21.htm"; }
                    else { htmltext = npcId + "-22.htm"; }
                }
                else { htmltext = npcId + "-23.htm"; }
                break;
            ...
            case 30565: // Kakai (Orcs)
                if (player.getRace() == PlayerRace.Orc) {
                    ...
                    else if (player.getClassId().level() == 1) { htmltext = npcId + "-09.htm"; }
                    else { htmltext = npcId + "-10.htm"; }
                }
                else { htmltext = npcId + "-11.htm"; }
                break;
            ...
            case 30499:
                if (player.getRace() == PlayerRace.Dwarf) {
                    if (player.getClassId().level() == 0) {
                        if (player.getClassId().getId() == 53) { htmltext = npcId + "-01.htm"; }
                    }
                    else if (player.getClassId().level() == 1) { htmltext = npcId + "-09.htm"; }
                    else { htmltext = npcId + "-10.htm"; }
                }
            ...
            case 30520:
                if (player.getRace() == PlayerRace.Dwarf) {
                    ...
                    else if (player.getClassId().level() == 1) { htmltext = npcId + "-05.htm"; }
                    else { htmltext = npcId + "-06.htm"; }
                }
                else { htmltext = npcId + "-07.htm"; }
                break;
            ...
            case 32098:
                if (player.getRace() == PlayerRace.Elf) {
                    if (player.isMageClass()) {
                        if (player.getClassId().level() == 0) {
                            if (player.getClassId().getId() == 25) { htmltext = npcId + "-01.htm"; }
                        }
                        else if (player.getClassId().level() == 1) { htmltext = npcId + "-31.htm"; }
                        else { htmltext = npcId + "-32.htm"; }
                    }
                    else { htmltext = npcId + "-33.htm"; }
                }
                    ...
                    if (player.isMageClass()) {
                        if (player.getClassId().level() == 0) {
                            if (player.getClassId().getId() == 10) { htmltext = npcId + "-08.htm"; }
                        }
                        else if (player.getClassId().level() == 1) { htmltext = npcId + "-31.htm"; }
                        else { htmltext = npcId + "-32.htm"; }
                    }
            ...
            case 30154: // Asterios (Elf fighters and mages)
                if (player.getRace() == PlayerRace.Elf) {
                    if (player.getClassId().level() == 0) {
                        if (player.getClassId().getId() == 18) { htmltext = npcId + "-01.htm"; }
                        else if (player.getClassId().getId() == 25) { htmltext = npcId + "-02.htm"; }
                    }
                    else if (player.getClassId().level() == 1) { htmltext = npcId + "-12.htm"; }
                    else { htmltext = npcId + "-13.htm"; }
                }
            ...
            case 30031: // Biotin (Human mages)
                if (player.getRace() == PlayerRace.Human) {
                    if (player.isMageClass()) {
                        if (player.getClassId().level() == 0) {
                            if (player.getClassId().getId() == 10) { htmltext = npcId + "-01.htm"; }
                        }
                        else if (player.getClassId().level() == 1) { htmltext = npcId + "-06.htm"; }
                        else { htmltext = npcId + "-07.htm"; }
                    }
                    else { htmltext = npcId + "-08.htm"; }
                }
                else { htmltext = npcId + "-08.htm"; }
                break;
            ...
            case 30066:
                if (player.getRace() == PlayerRace.Human) {
                    if (player.getClassId().level() == 0) {
                        if (player.getClassId().getId() == 0) { htmltext = npcId + "-08.htm"; }
                        else { htmltext = npcId + "-40.htm"; }
                    }
                    else if (player.getClassId().level() == 1) { htmltext = npcId + "-38.htm"; }
                    else { htmltext = npcId + "-39.htm"; }
                }
                else if (player.getRace() == PlayerRace.Elf) {
                    if (player.getClassId().level() == 0) {
                        if (player.getClassId().getId() == 18) { htmltext = npcId + "-01.htm"; }
                        else { htmltext = npcId + "-40.htm"; }
                    }
            ...
            case 30026: // Bitz (Human fighters)
                if (player.getRace() == PlayerRace.Human) {
                    if (player.getClassId().level() == 0) {
                        if (player.getClassId().getId() == 0) { htmltext = npcId + "-01.htm"; }
                        else { htmltext = npcId + "-10.htm"; }
                    }
                    else if (player.getClassId().level() == 1) { htmltext = npcId + "-08.htm"; }
                    else { htmltext = npcId + "-09.htm"; }
                }
                else { htmltext = npcId + "-10.htm"; }
                break;
        }
