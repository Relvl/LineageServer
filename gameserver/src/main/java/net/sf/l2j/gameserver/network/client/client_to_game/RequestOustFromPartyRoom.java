...
import net.sf.l2j.gameserver.network.client.game_to_client.PartyMatchList;
...
public final class RequestOustFromPartyRoom extends L2GameClientPacket {
    ...
    protected void runImpl() {
        ...
        if (_room.getOwner() != activeChar) { return; }

        if (activeChar.isInParty() && member.isInParty() && activeChar.getParty().getPartyLeaderOID() == member.getParty().getPartyLeaderOID()) { activeChar.sendPacket(SystemMessageId.CANNOT_DISMISS_PARTY_MEMBER); }
        else {
