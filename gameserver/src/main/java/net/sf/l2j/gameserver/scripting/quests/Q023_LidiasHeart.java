        ...
        switch (st.getState()) {
            case QuestState.STATE_CREATED:
                ...
                if (st2 != null && st2.isCompleted()) {
                    if (player.getLevel() >= 64) { htmltext = "31328-01.htm"; }
                    else { htmltext = "31328-00a.htm"; }
                }
                else { htmltext = "31328-00.htm"; }
                break;
            ...
            case QuestState.STATE_STARTED:
                ...
                switch (npc.getNpcId()) {
                    case INNOCENTIN:
                        if (cond == 1) { htmltext = "31328-03.htm"; }
                        else if (cond == 2) { htmltext = "31328-07.htm"; }
                        else if (cond == 4) { htmltext = "31328-08.htm"; }
                        else if (cond > 5) { htmltext = "31328-21.htm"; }
                        break;
                    ...
                    case BROKEN_BOOKSHELF:
                        if (cond == 2) {
                            ...
                            if (!st.hasQuestItems(LIDIA_DIARY)) { htmltext = (!st.hasQuestItems(LIDIA_HAIRPIN)) ? "31526-02.htm" : "31526-06.htm"; }
                            else if (!st.hasQuestItems(LIDIA_HAIRPIN)) { htmltext = "31526-12.htm"; }
                        }
                        else if (cond > 3) { htmltext = "31526-13.htm"; }
                        break;

                    case GHOST_OF_VON_HELLMANN:
                        if (cond == 6) { htmltext = "31524-01.htm"; }
                        else if (cond > 6) { htmltext = "31524-05.htm"; }
                        break;

                    case TOMBSTONE:
                        if (cond == 6) { htmltext = (_ghost == null) ? "31523-01.htm" : "31523-03.htm"; }
                        else if (cond == 7) { htmltext = "31523-04.htm"; }
                        else if (cond > 7) { htmltext = "31523-06.htm"; }
                        break;
                    ...
                    case VIOLET:
                        ...
                        else if (cond == 9) { htmltext = "31386-02.htm"; }
                        else if (cond == 10) {
                    ...
                    case BOX:
                        if (cond == 9) { htmltext = "31530-01.htm"; }
                        else if (cond == 10) { htmltext = "31530-03.htm"; }
                        break;
                }
                break;

            case QuestState.STATE_COMPLETED:
                if (npc.getNpcId() == VIOLET) { htmltext = "31386-04.htm"; }
