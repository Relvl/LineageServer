...
public class Q431_WeddingMarch extends Quest {
    ...
    public String onAdvEvent(String event, L2Npc npc, L2PcInstance player) {
        ...
        if (event.equalsIgnoreCase("31042-02.htm")) {
            ...
            if (st.getQuestItemsCount(SILVER_CRYSTAL) < 50) { htmltext = "31042-03.htm"; }
            else {
    ...
    public String onTalk(L2Npc npc, L2PcInstance player) {
        ...
        switch (st.getState()) {
            ...
            case QuestState.STATE_STARTED:
                ...
                if (cond == 1) { htmltext = "31042-02.htm"; }
                else if (cond == 2) { htmltext = (st.getQuestItemsCount(SILVER_CRYSTAL) < 50) ? "31042-03.htm" : "31042-04.htm"; }
                break;
        }
    ...
    public String onKill(L2Npc npc, L2PcInstance player, boolean isPet) {
        ...
        if (st.dropItems(SILVER_CRYSTAL, 1, 50, 500000)) { st.set("cond", "2"); }
