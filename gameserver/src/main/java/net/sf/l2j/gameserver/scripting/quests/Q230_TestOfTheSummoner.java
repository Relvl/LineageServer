...
public class Q230_TestOfTheSummoner extends Quest {
    ...
    private static final int[][] LARA_LISTS = {
            {
                    LARA_LIST_1,
                    SAC_OF_REDSPORES,
    ...
    public String onAdvEvent(String event, L2Npc npc, L2PcInstance player) {
        ...
        // ALMORS
            ...
            if (st.hasQuestItems(BEGINNER_ARCANA)) { htmltext = "30635-03.htm"; }
        }
        ...
        // CAMONIELL
            ...
            if (st.hasQuestItems(BEGINNER_ARCANA)) { htmltext = "30636-03.htm"; }
        }
        ...
        // BELTHUS
            ...
            if (st.hasQuestItems(BEGINNER_ARCANA)) { htmltext = "30637-03.htm"; }
        }
        ...
        // BASILLA
            ...
            if (st.hasQuestItems(BEGINNER_ARCANA)) { htmltext = "30638-03.htm"; }
        }
        ...
        // CELESTIEL
            ...
            if (st.hasQuestItems(BEGINNER_ARCANA)) { htmltext = "30639-03.htm"; }
        }
        ...
        // BRYNTHEA
            ...
            if (st.hasQuestItems(BEGINNER_ARCANA)) { htmltext = "30640-03.htm"; }
        }
    ...
    public String onTalk(L2Npc npc, L2PcInstance player) {
        ...
        switch (st.getState()) {
            case QuestState.STATE_CREATED:
                ...
                else if (player.getLevel() < 39) { htmltext = "30634-02.htm"; }
                else { htmltext = "30634-03.htm"; }
                break;

            case QuestState.STATE_STARTED:
                switch (npcId) {
                    case LARA:
                        if (cond == 1) { htmltext = "30063-01.htm"; }
                        else {
                            if (st.getInt("Lara") == 0) // if you havent a part taken, give one
                            { htmltext = "30063-03.htm"; }
                            else {
                                int[] laraPart = LARA_LISTS[st.getInt("Lara") - 1];
                                if (st.getQuestItemsCount(laraPart[1]) < 30 || st.getQuestItemsCount(laraPart[2]) < 30) { htmltext = "30063-05.htm"; }
                                else {
                    ...
                    case GALATEA:
                        if (cond == 1) { htmltext = "30634-09.htm"; }
                        else if (cond == 2 || cond == 3) { htmltext = (!st.hasQuestItems(BEGINNER_ARCANA)) ? "30634-10.htm" : "30634-11.htm"; }
                        else if (cond == 4) {
                    ...
                    case ALMORS:
                        ...
                        if (almorsStat == 1) { htmltext = "30635-01.htm"; }
                        else if (almorsStat == 2) { htmltext = "30635-08.htm"; }
                        else if (almorsStat == 3) // in battle...
                        { htmltext = "30635-09.htm"; }
                        else if (almorsStat == 4) // haha... your summon lose
                        { htmltext = "30635-05.htm"; }
                        else if (almorsStat == 5) { htmltext = "30635-06.htm"; }
                        ...
                        else if (almorsStat == 7) { htmltext = "30635-10.htm"; }
                        break;

                    case CAMONIELL:
                        int camoniellStat = st.getInt("Camoniell");
                        if (camoniellStat == 1) { htmltext = "30636-01.htm"; }
                        else if (camoniellStat == 2) { htmltext = "30636-08.htm"; }
                        else if (camoniellStat == 3) // in battle...
                        { htmltext = "30636-09.htm"; }
                        else if (camoniellStat == 4) // haha... your summon lose
                        { htmltext = "30636-05.htm"; }
                        else if (camoniellStat == 5) { htmltext = "30636-06.htm"; }
                        ...
                        else if (camoniellStat == 7) { htmltext = "30636-10.htm"; }
                        break;

                    case BELTHUS:
                        int belthusStat = st.getInt("Belthus");
                        if (belthusStat == 1) { htmltext = "30637-01.htm"; }
                        else if (belthusStat == 2) { htmltext = "30637-08.htm"; }
                        else if (belthusStat == 3) // in battle...
                        { htmltext = "30637-09.htm"; }
                        else if (belthusStat == 4) // haha... your summon lose
                        { htmltext = "30637-05.htm"; }
                        else if (belthusStat == 5) { htmltext = "30637-06.htm"; }
                        ...
                        else if (belthusStat == 7) { htmltext = "30637-10.htm"; }
                        break;

                    case BASILLA:
                        int basillaStat = st.getInt("Basilla");
                        if (basillaStat == 1) { htmltext = "30638-01.htm"; }
                        else if (basillaStat == 2) { htmltext = "30638-08.htm"; }
                        else if (basillaStat == 3) // in battle...
                        { htmltext = "30638-09.htm"; }
                        else if (basillaStat == 4) // haha... your summon lose
                        { htmltext = "30638-05.htm"; }
                        else if (basillaStat == 5) { htmltext = "30638-06.htm"; }
                        ...
                        else if (basillaStat == 7) { htmltext = "30638-10.htm"; }
                        break;

                    case CELESTIEL:
                        int celestielStat = st.getInt("Celestiel");
                        if (celestielStat == 1) { htmltext = "30639-01.htm"; }
                        else if (celestielStat == 2) { htmltext = "30639-08.htm"; }
                        else if (celestielStat == 3) // in battle...
                        { htmltext = "30639-09.htm"; }
                        else if (celestielStat == 4) // haha... your summon lose
                        { htmltext = "30639-05.htm"; }
                        else if (celestielStat == 5) { htmltext = "30639-06.htm"; }
                        ...
                        else if (celestielStat == 7) { htmltext = "30639-10.htm"; }
                        break;

                    case BRYNTHEA:
                        int bryntheaStat = st.getInt("Brynthea");
                        if (bryntheaStat == 1) { htmltext = "30640-01.htm"; }
                        else if (bryntheaStat == 2) { htmltext = "30640-08.htm"; }
                        else if (bryntheaStat == 3) // in battle...
                        { htmltext = "30640-09.htm"; }
                        else if (bryntheaStat == 4) // haha... your summon lose
                        { htmltext = "30640-05.htm"; }
                        else if (bryntheaStat == 5) { htmltext = "30640-06.htm"; }
                        ...
                        else if (bryntheaStat == 7) { htmltext = "30640-10.htm"; }
                        break;
                }
                break;
    ...
    public String onDeath(L2Character killer, L2PcInstance player) {
        if (!(killer instanceof L2Attackable)) { return null; }
    ...
    public String onKill(L2Npc npc, L2PcInstance player, boolean isPet) {
        ...
        switch (npcId) {
            case GIANT_FUNGUS:
                if (st.getInt("Lara") == 1) { st.dropItems(SAC_OF_REDSPORES, 1, 30, 800000); }
                break;

            case LETO_LIZARDMAN:
            case LETO_LIZARDMAN_ARCHER:
                if (st.getInt("Lara") == 1) { st.dropItems(LETO_LIZARDMAN_AMULET, 1, 30, 250000); }
                break;

            case LETO_LIZARDMAN_SOLDIER:
            case LETO_LIZARDMAN_WARRIOR:
                if (st.getInt("Lara") == 1) { st.dropItems(LETO_LIZARDMAN_AMULET, 1, 30, 500000); }
                break;

            case LETO_LIZARDMAN_SHAMAN:
            case LETO_LIZARDMAN_OVERLORD:
                if (st.getInt("Lara") == 1) { st.dropItems(LETO_LIZARDMAN_AMULET, 1, 30, 750000); }
                break;

            case MANASHEN_GARGOYLE:
                if (st.getInt("Lara") == 2) { st.dropItems(SHARDS_OF_MANASHEN, 1, 30, 800000); }
                break;

            case KARUL_BUGBEAR:
                if (st.getInt("Lara") == 2) { st.dropItems(KARUL_BUGBEAR_TOTEM, 1, 30, 800000); }
                break;

            case BREKA_ORC:
            case BREKA_ORC_ARCHER:
            case BREKA_ORC_WARRIOR:
                if (st.getInt("Lara") == 3) { st.dropItems(BREKA_ORC_TOTEM, 1, 30, 250000); }
                break;

            case BREKA_ORC_SHAMAN:
            case BREKA_ORC_OVERLORD:
                if (st.getInt("Lara") == 3) { st.dropItems(BREKA_ORC_TOTEM, 1, 30, 500000); }
                break;

            case FETTERED_SOUL:
                if (st.getInt("Lara") == 3) { st.dropItems(CRIMSON_BLOODSTONE, 1, 30, 600000); }
                break;

            case WINDSUS:
                if (st.getInt("Lara") == 4) { st.dropItems(TUSK_OF_WINDSUS, 1, 30, 700000); }
                break;

            case TYRANT:
            case TYRANT_KINGPIN:
                if (st.getInt("Lara") == 4) { st.dropItems(TALONS_OF_TYRANT, 1, 30, 500000); }
                break;

            case NOBLE_ANT:
            case NOBLE_ANT_LEADER:
                if (st.getInt("Lara") == 5) { st.dropItems(WINGS_OF_DRONEANT, 1, 30, 600000); }
                break;

            case WYRM:
                if (st.getInt("Lara") == 5) { st.dropItems(FANGS_OF_WYRM, 1, 30, 500000); }
                break;
