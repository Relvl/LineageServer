...
public class L2ClanHallManagerInstance extends L2MerchantInstance {
        ...
        if (condition == COND_OWNER) {
            ...
            if (actualCommand.equalsIgnoreCase("banish_foreigner")) {
                ...
                if ((player.getClanPrivileges() & L2Clan.CP_CH_DISMISS) == L2Clan.CP_CH_DISMISS) {
                    if (val.equalsIgnoreCase("list")) { html.setFile("data/html/clanHallManager/banish-list.htm"); }
                    else if (val.equalsIgnoreCase("banish")) {
                        getClanHall().banishForeigners();
                        html.setFile("data/html/clanHallManager/banish.htm");
                    }
                }
                else { html.setFile("data/html/clanHallManager/not_authorized.htm"); }
                ...
                if ((player.getClanPrivileges() & L2Clan.CP_CH_OPEN_DOOR) == L2Clan.CP_CH_OPEN_DOOR) {
                    ...
                    else { html.setFile("data/html/clanHallManager/door.htm"); }
                }
                else { html.setFile("data/html/clanHallManager/not_authorized.htm"); }
                ...
                if (val.equalsIgnoreCase("tele")) {
                    ...
                    if (chf == null) { html.setFile("data/html/clanHallManager/chamberlain-nac.htm"); }
                    else { html.setFile("data/html/clanHallManager/tele" + getClanHall().getLocation() + chf.getLvl() + ".htm"); }
                    ...
                    ClanHallFunction chf = getClanHall().getFunction(ClanHall.FUNC_ITEM_CREATE);
                    if (chf == null) {
                        NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
                    ...
                    ClanHallFunction chf = getClanHall().getFunction(ClanHall.FUNC_SUPPORT);
                    if (chf == null) { html.setFile("data/html/clanHallManager/chamberlain-nac.htm"); }
                    else {
                ...
                else if (val.equalsIgnoreCase("back")) { showChatWindow(player); }
                else {
                    NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
                    html.setFile("data/html/clanHallManager/functions.htm");

                    ClanHallFunction chfExp = getClanHall().getFunction(ClanHall.FUNC_RESTORE_EXP);
                    if (chfExp != null) { html.replace("%xp_regen%", chfExp.getLvl()); }
                    else { html.replace("%xp_regen%", "0"); }

                    ClanHallFunction chfHp = getClanHall().getFunction(ClanHall.FUNC_RESTORE_HP);
                    if (chfHp != null) { html.replace("%hp_regen%", chfHp.getLvl()); }
                    else { html.replace("%hp_regen%", "0"); }

                    ClanHallFunction chfMp = getClanHall().getFunction(ClanHall.FUNC_RESTORE_MP);
                    if (chfMp != null) { html.replace("%mp_regen%", chfMp.getLvl()); }
                    else { html.replace("%mp_regen%", "0"); }
                ...
                if ((player.getClanPrivileges() & L2Clan.CP_CH_SET_FUNCTIONS) == L2Clan.CP_CH_SET_FUNCTIONS) {
                    if (val.equalsIgnoreCase("recovery")) {
                        if (st.hasMoreTokens()) {
                            if (getClanHall().getOwnerId() == 0) { return; }
                            ...
                            if (val.equalsIgnoreCase("hp_cancel")) {
                                ...
                                if (!getClanHall().updateFunctions(player, ClanHall.FUNC_RESTORE_HP, percent, fee, Config.CH_HPREG_FEE_RATIO, chf == null)) { html.setFile("data/html/clanHallManager/low_adena.htm"); }
                                else { revalidateDeco(player); }
                                ...
                                ClanHallFunction chf = getClanHall().getFunction(ClanHall.FUNC_RESTORE_MP);
                                if (chf != null && chf.getLvl() == percent) {
                                    html.setFile("data/html/clanHallManager/functions-used.htm");
                                    html.replace("%val%", val + "%");
                                    html.replace("%objectId%", getObjectId());
                                ...
                                if (!getClanHall().updateFunctions(player, ClanHall.FUNC_RESTORE_MP, percent, fee, Config.CH_MPREG_FEE_RATIO, chf == null)) { html.setFile("data/html/clanHallManager/low_adena.htm"); }
                                else { revalidateDeco(player); }
                                ...
                                ClanHallFunction chf = getClanHall().getFunction(ClanHall.FUNC_RESTORE_EXP);
                                if (chf != null && chf.getLvl() == percent) {
                                    html.setFile("data/html/clanHallManager/functions-used.htm");
                                    html.replace("%val%", val + "%");
                                    html.replace("%objectId%", getObjectId());
                                ...
                                if (!getClanHall().updateFunctions(player, ClanHall.FUNC_RESTORE_EXP, percent, fee, Config.CH_EXPREG_FEE_RATIO, chf == null)) { html.setFile("data/html/clanHallManager/low_adena.htm"); }
                                else { revalidateDeco(player); }
                        ...
                        if (st.hasMoreTokens()) {
                            ...
                            if (val.equalsIgnoreCase("item_cancel")) {
                                ...
                                if (!getClanHall().updateFunctions(player, ClanHall.FUNC_ITEM_CREATE, lvl, fee, Config.CH_ITEM_FEE_RATIO, chf == null)) { html.setFile("data/html/clanHallManager/low_adena.htm"); }
                                else { revalidateDeco(player); }
                                ...
                                if (!getClanHall().updateFunctions(player, ClanHall.FUNC_TELEPORT, lvl, fee, Config.CH_TELE_FEE_RATIO, chf == null)) { html.setFile("data/html/clanHallManager/low_adena.htm"); }
                                else { revalidateDeco(player); }
                                ...
                                if (!getClanHall().updateFunctions(player, ClanHall.FUNC_SUPPORT, lvl, fee, Config.CH_SUPPORT_FEE_RATIO, chf == null)) { html.setFile("data/html/clanHallManager/low_adena.htm"); }
                                else { revalidateDeco(player); }
                            ...
                            ClanHallFunction chfTel = getClanHall().getFunction(ClanHall.FUNC_TELEPORT);
                            if (chfTel != null) {
                            ...
                            ClanHallFunction chfSup = getClanHall().getFunction(ClanHall.FUNC_SUPPORT);
                            if (chfSup != null) {
                            ...
                            ClanHallFunction chfCreate = getClanHall().getFunction(ClanHall.FUNC_ITEM_CREATE);
                            if (chfCreate != null) {
                        ...
                        if (st.hasMoreTokens()) {
                            ...
                            if (val.equalsIgnoreCase("curtains_cancel")) {
                                ...
                                if (!getClanHall().updateFunctions(player, ClanHall.FUNC_DECO_CURTAINS, lvl, fee, Config.CH_CURTAIN_FEE_RATIO, chf == null)) { html.setFile("data/html/clanHallManager/low_adena.htm"); }
                                else { revalidateDeco(player); }
                                ...
                                ClanHallFunction chf = getClanHall().getFunction(ClanHall.FUNC_DECO_FRONTPLATEFORM);
                                if (chf != null && chf.getLvl() == lvl) {
                                    html.setFile("data/html/clanHallManager/functions-used.htm");
                                    html.replace("%val%", "Stage " + val);
                                    html.replace("%objectId%", getObjectId());
                                ...
                                if (!getClanHall().updateFunctions(player, ClanHall.FUNC_DECO_FRONTPLATEFORM, lvl, fee, Config.CH_FRONT_FEE_RATIO, chf == null)) { html.setFile("data/html/clanHallManager/low_adena.htm"); }
                                else { revalidateDeco(player); }
                            ...
                            ClanHallFunction chfCurtains = getClanHall().getFunction(ClanHall.FUNC_DECO_CURTAINS);
                            if (chfCurtains != null) {
                            ...
                            ClanHallFunction chfPlateform = getClanHall().getFunction(ClanHall.FUNC_DECO_FRONTPLATEFORM);
                ...
                ClanHallFunction chf = getClanHall().getFunction(ClanHall.FUNC_SUPPORT);
                if (chf == null || chf.getLvl() == 0) { return; }
                ...
                try {
                    ...
                    L2Skill skill = SkillTable.getInfo(id, lvl);
                    if (skill.getSkillType() == L2SkillType.SUMMON) { player.doSimultaneousCast(skill); }
                    else {
                        if (!((skill.getMpConsume() + skill.getMpInitialConsume()) > getCurrentMp())) { doCast(skill); }
                        else {
                            NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
                ...
                if (list != null) {
                    if (player.getInventory().reduceAdena(EItemProcessPurpose.TELEPORT, list.getPrice(), this, true)) { player.teleToLocation(list.getX(), list.getY(), list.getZ(), 0); }
                }
                ...
                if (player.getClan().getLevel() == 0) { player.sendPacket(SystemMessageId.ONLY_LEVEL_1_CLAN_OR_HIGHER_CAN_USE_WAREHOUSE); }
                else {
    ...
    public void showChatWindow(L2PcInstance player) {
        ...
        int condition = validateCondition(player);
        if (condition == COND_OWNER) { filename = "data/html/clanHallManager/chamberlain.htm"; }
    ...
    protected int validateCondition(L2PcInstance player) {
        ...
        if (player.getClan() != null) {
            if (getClanHall().getOwnerId() == player.getClanId()) { return COND_OWNER; }
    ...
    public final ClanHall getClanHall() {
        if (_clanHallId < 0) {
            ...
            if (temp != null) { _clanHallId = temp.getId(); }
