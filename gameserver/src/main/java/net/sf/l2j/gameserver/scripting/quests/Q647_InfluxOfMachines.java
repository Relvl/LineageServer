...
public class Q647_InfluxOfMachines extends Quest {
    ...
    public Q647_InfluxOfMachines() {
        ...
        for (int i = 22052; i < 22079; i++) { addKillId(i); }
    }
    ...
    public String onTalk(L2Npc npc, L2PcInstance player) {
        ...
        switch (st.getState()) {
            ...
            case QuestState.STATE_STARTED:
                ...
                if (cond == 1) { htmltext = "32069-04.htm"; }
                else if (cond == 2) { htmltext = "32069-05.htm"; }
                break;
        }
    ...
    public String onKill(L2Npc npc, L2PcInstance player, boolean isPet) {
        ...
        if (st.dropItems(DESTROYED_GOLEM_SHARD, 1, 500, 300000)) { st.set("cond", "2"); }
