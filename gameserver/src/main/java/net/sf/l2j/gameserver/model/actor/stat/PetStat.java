...
public class PetStat extends SummonStat {
    ...
    public final boolean addLevel(byte value) {
        ...
        if (levelIncreased) { getActiveChar().broadcastPacket(new SocialAction(getActiveChar(), 15)); }
    ...
    public void setLevel(byte value) {
        ...
        L2ItemInstance controlItem = getActiveChar().getControlItem();
    ...
    public int getPAtkSpd() {
        ...
        if (getActiveChar().isHungry()) { val = val / 2; }
