...
import net.sf.l2j.gameserver.network.client.game_to_client.ExGetBossRecord;
...
public class RequestGetBossRecord extends L2GameClientPacket {
    ...
    protected void runImpl() {
        ...
        if (_bossId != 0) { _log.info("C5: RequestGetBossRecord: d: " + _bossId + " ActiveChar: " + activeChar); }
