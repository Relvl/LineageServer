...
public class Q044_HelpTheSon extends Quest {
    ...
    public String onTalk(L2Npc npc, L2PcInstance player) {
        ...
        switch (st.getState()) {
            ...
            case QuestState.STATE_STARTED:
                ...
                switch (npc.getNpcId()) {
                    case LUNDY:
                        if (cond == 1) { htmltext = (!st.hasQuestItems(WORK_HAMMER)) ? "30827-01a.htm" : "30827-02.htm"; }
                        else if (cond == 2) { htmltext = "30827-03a.htm"; }
                        else if (cond == 3) { htmltext = "30827-04.htm"; }
                        else if (cond == 4) { htmltext = "30827-05a.htm"; }
                        else if (cond == 5) { htmltext = "30827-06.htm"; }
                        break;

                    case DRIKUS:
                        if (cond == 4) { htmltext = "30505-05.htm"; }
                        else if (cond == 5) { htmltext = "30505-06a.htm"; }
                        break;
                }
                break;
    ...
    public String onKill(L2Npc npc, L2PcInstance player, boolean isPet) {
        ...
        if (st.dropItemsAlways(GEMSTONE_FRAGMENT, 1, 30)) { st.set("cond", "3"); }
