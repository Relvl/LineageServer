    ...
    public String onTalk(L2Npc npc, L2PcInstance player) {
        ...
        switch (st.getState()) {
            ...
            case QuestState.STATE_STARTED:
                if (st.getQuestItemsCount(RELICS) >= 1000) { htmltext = "31538-04.htm"; }
                else if (st.hasQuestItems(ENTRANCE)) { htmltext = "31538-06.htm"; }
                else { htmltext = "31538-07.htm"; }
                break;
        }
