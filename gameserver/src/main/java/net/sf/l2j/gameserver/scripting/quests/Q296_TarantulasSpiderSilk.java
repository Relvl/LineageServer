...
public class Q296_TarantulasSpiderSilk extends Quest {
            ...
            case QuestState.STATE_STARTED:
                switch (npc.getNpcId()) {
                    case MION:
                        ...
                        if (count == 0) { htmltext = "30519-04.htm"; }
                        else {
    ...
    public String onKill(L2Npc npc, L2PcInstance player, boolean isPet) {
        ...
        int rnd = Rnd.get(100);
        if (rnd > 95) { st.dropItemsAlways(TARANTULA_SPINNERETTE, 1, 0); }
        else if (rnd > 45) { st.dropItemsAlways(TARANTULA_SPIDER_SILK, 1, 0); }
