    ...
    public String onTalk(L2Npc npc, L2PcInstance player) {
        ...
        switch (st.getState()) {
            case QuestState.STATE_CREATED:
                if (player.getClassId() != ClassId.cleric && player.getClassId() != ClassId.oracle && player.getClassId() != ClassId.shillienOracle && player.getClassId() != ClassId.orcShaman) { htmltext = "30648-02.htm"; }
                else if (player.getLevel() < 35) { htmltext = "30648-01.htm"; }
                else { htmltext = "30648-03.htm"; }
                break;
            ...
            case QuestState.STATE_STARTED:
                ...
                switch (npc.getNpcId()) {
                    case SANTIAGO:
                        if (cond < 17) { htmltext = "30648-09.htm"; }
                        else if (cond == 17) {
                    ...
                    case TANAPI:
                        ...
                        else if (cond < 5) { htmltext = "30571-02.htm"; }
                        else if (cond >= 5) {
                    ...
                    case ANCESTOR_MARTANKUS:
                        ...
                        else if (cond == 3) { htmltext = "30649-02.htm"; }
                        else if (cond == 4) { htmltext = "30649-03.htm"; }
                        break;
                    ...
                    case GAURI_TWINKLEROCK:
                        ...
                        else if (cond > 6) { htmltext = "30550-02.htm"; }
                        break;
                    ...
                    case DORF:
                        ...
                        else if (cond > 7) { htmltext = "30651-03.htm"; }
                        break;

                    case GERALD:
                        if (cond == 7 && !st.hasQuestItems(BOOK_OF_GERALD)) { htmltext = "30650-01.htm"; }
                    ...
                    case PRIMOS:
                        ...
                        else if (cond > 8) { htmltext = "30117-02.htm"; }
                        break;
                    ...
                    case PETRON:
                        ...
                        else if (cond == 10) { htmltext = "30036-02.htm"; }
                        else if (cond == 11) {
                        ...
                        else if (cond > 11) { htmltext = "30036-04.htm"; }
                        break;

                    case ANDELLIA:
                        if (cond == 12) {
                            if (player.getLevel() < 36) { htmltext = "30362-01a.htm"; }
                            else {
                        ...
                        else if (cond == 13) { htmltext = (Rnd.nextBoolean()) ? "30362-02.htm" : "30362-02a.htm"; }
                        else if (cond == 14) { htmltext = "30362-07.htm"; }
                        else if (cond == 15) { htmltext = "30362-03.htm"; }
                        else if (cond == 16) { htmltext = "30362-06.htm"; }
                        break;

                    case URUHA:
                        if (cond == 14) { htmltext = "30652-01.htm"; }
                        else if (cond == 15) { htmltext = "30652-03.htm"; }
                        break;
                    ...
                    case CASIAN:
                        ...
                        else if (cond == 17) { htmltext = "30612-02.htm"; }
                        break;
                }
                break;
    ...
    public String onKill(L2Npc npc, L2PcInstance player, boolean isPet) {
        ...
        switch (npc.getNpcId()) {
            case LAVA_SALAMANDER:
                if (st.getInt("cond") == 3 && st.dropItems(ESSENCE_OF_FLAME, 1, 1, 200000)) { st.set("cond", "4"); }
                break;

            case NAHIR:
                if (st.getInt("cond") == 10 && st.dropItems(HAIR_OF_NAHIR, 1, 1, 200000)) { st.set("cond", "11"); }
                break;

            case BLACK_WILLOW:
                if (st.getInt("cond") == 13 && st.dropItems(DEBRIS_OF_WILLOW, 1, 1, 200000)) { st.set("cond", "14"); }
                break;
        }
