...
public class L2SepulcherMonsterInstance extends L2MonsterInstance {
    ...
    public void onSpawn() {
        ...
        switch (getNpcId()) {
            ...
            case 18156:
            case 18157:
                if (_victimSpawnKeyBoxTask != null) { _victimSpawnKeyBoxTask.cancel(true); }
                _victimSpawnKeyBoxTask = ThreadPoolManager.getInstance().scheduleEffect(new VictimSpawnKeyBox(this), 300000);
                if (_victimShout != null) { _victimShout.cancel(true); }
            ...
            case 18242:
            case 18243:
                if (_changeImmortalTask != null) { _changeImmortalTask.cancel(true); }
    ...
    private class VictimShout implements Runnable {
        ...
        public void run() {
            ...
            broadcastPacket(new NpcSay(getObjectId(), EChatType.ALL, getNpcId(), "forgive me!!"));
        }
    }
    ...
    private class VictimSpawnKeyBox implements Runnable {
        ...
        public void run() {
            ...
            FourSepulchersManager.getInstance().spawnKeyBox(_activeChar);
            broadcastPacket(new NpcSay(getObjectId(), EChatType.ALL, getNpcId(), "Many thanks for rescue me."));
            if (_victimShout != null) { _victimShout.cancel(true); }
        }
    }
}