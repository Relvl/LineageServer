    ...
    public String onTalk(L2Npc npc, L2PcInstance player) {
        ...
        switch (st.getState()) {
            case QuestState.STATE_CREATED:
                if (player.getClassId() == ClassId.rogue || player.getClassId() == ClassId.elvenScout || player.getClassId() == ClassId.assassin) { htmltext = (player.getLevel() < 35) ? "30106-02.htm" : "30106-03.htm"; }
                else { htmltext = "30106-00.htm"; }
                break;
            ...
            case QuestState.STATE_STARTED:
                ...
                switch (npc.getNpcId()) {
                    case DUFNER:
                        if (cond == 1) { htmltext = "30106-06.htm"; }
                        else if (cond > 1) {
                            if (!st.hasQuestItems(TERRY_REPORT)) { htmltext = "30106-07.htm"; }
                            else {
                    ...
                    case TERRY:
                        if (cond == 1) { htmltext = "30064-01.htm"; }
                        else if (cond == 2) { htmltext = "30064-04.htm"; }
                        else if (cond == 3) { htmltext = "30064-05.htm"; }
                        else if (cond == 4) { htmltext = "30064-08.htm"; }
                        else if (cond == 5) { htmltext = "30064-09.htm"; }
                        else if (cond == 6) { htmltext = "30064-11.htm"; }
                        else if (cond == 7) {
                        ...
                        else if (cond == 8) { htmltext = "30064-13.htm"; }
                        else if (cond > 8 && cond < 14) { htmltext = "30064-14.htm"; }
                        else if (cond == 14) {
                            if (!st.hasQuestItems(TERRY_ORDER_3)) { htmltext = "30064-15.htm"; }
                            else if (player.getLevel() < 36) { htmltext = "30064-20.htm"; }
                            else {
                        ...
                        else if (cond == 15 || cond == 16) { htmltext = "30064-22.htm"; }
                        else if (cond == 17) {
                            ...
                            else { htmltext = "30064-24.htm"; }
                        }
                        break;

                    case VIKTOR:
                        if (cond == 6) { htmltext = "30684-01.htm"; }
                        else if (cond == 7) { htmltext = "30684-05.htm"; }
                        else if (cond == 8) { htmltext = "30684-12.htm"; }
                        else if (cond == 9) { htmltext = "30684-13.htm"; }
                        else if (cond == 10) { htmltext = "30684-14.htm"; }
                        else if (cond == 11) { htmltext = "30684-16.htm"; }
                        else if (cond > 11) { htmltext = "30684-17.htm"; }
                        break;

                    case MARINA:
                        if (cond == 11) { htmltext = "30715-01.htm"; }
                        else if (cond == 12) { htmltext = "30715-03.htm"; }
                        else if (cond == 13) { htmltext = "30715-04.htm"; }
                        else if (st.hasQuestItems(ANALYSIS_RESULT)) { htmltext = "30715-06.htm"; }
                        break;
                    ...
                    case BRUNON:
                        ...
                        else if (cond == 13) { htmltext = "30526-02.htm"; }
                        break;
                }
                break;
    ...
    public String onKill(L2Npc npc, L2PcInstance player, boolean isPet) {
        ...
        switch (npc.getNpcId()) {
            case NEER_GHOUL_BERSERKER:
                if (cond == 2 && st.dropItems(MYSTERIOUS_RUNESTONE, 1, 1, 100000)) { st.set("cond", "3"); }
                break;

            case ANT_CAPTAIN:
                if (cond == 4 && st.dropItems(ANT_RUNESTONE, 1, 1, 250000) && st.hasQuestItems(OL_MAHUM_RUNESTONE, TURAK_BUGBEAR_RUNESTONE, TUREK_RUNESTONE)) { st.set("cond", "5"); }
                break;

            case OL_MAHUM_CAPTAIN:
                if (cond == 4 && st.dropItems(OL_MAHUM_RUNESTONE, 1, 1, 250000) && st.hasQuestItems(ANT_RUNESTONE, TURAK_BUGBEAR_RUNESTONE, TUREK_RUNESTONE)) { st.set("cond", "5"); }
                break;

            case TURAK_BUGBEAR_WARRIOR:
                if (cond == 4 && st.dropItems(TURAK_BUGBEAR_RUNESTONE, 1, 1, 250000) && st.hasQuestItems(ANT_RUNESTONE, OL_MAHUM_RUNESTONE, TUREK_RUNESTONE)) { st.set("cond", "5"); }
                break;

            case TUREK_ORC_WARLORD:
                if (cond == 4 && st.dropItems(TUREK_RUNESTONE, 1, 1, 250000) && st.hasQuestItems(ANT_RUNESTONE, OL_MAHUM_RUNESTONE, TURAK_BUGBEAR_RUNESTONE)) { st.set("cond", "5"); }
                break;

            case MEDUSA:
                if (cond == 9 && st.dropItems(MEDUSA_SCALES, 1, 10, 300000)) { st.set("cond", "10"); }
                break;

            case MARSH_STAKATO_DRONE:
                if ((cond == 15 || cond == 16) && st.dropItems(ABYSS_RUNESTONE_1, 1, 1, 250000) && st.hasQuestItems(ABYSS_RUNESTONE_2, ABYSS_RUNESTONE_3, ABYSS_RUNESTONE_4)) { st.set("cond", "17"); }
                break;

            case BREKA_ORC_OVERLORD:
                if ((cond == 15 || cond == 16) && st.dropItems(ABYSS_RUNESTONE_2, 1, 1, 250000) && st.hasQuestItems(ABYSS_RUNESTONE_1, ABYSS_RUNESTONE_3, ABYSS_RUNESTONE_4)) { st.set("cond", "17"); }
                break;

            case ANT_WARRIOR_CAPTAIN:
                if ((cond == 15 || cond == 16) && st.dropItems(ABYSS_RUNESTONE_3, 1, 1, 250000) && st.hasQuestItems(ABYSS_RUNESTONE_1, ABYSS_RUNESTONE_2, ABYSS_RUNESTONE_4)) { st.set("cond", "17"); }
                break;

            case LETO_LIZARDMAN_WARRIOR:
                if ((cond == 15 || cond == 16) && st.dropItems(ABYSS_RUNESTONE_4, 1, 1, 250000) && st.hasQuestItems(ABYSS_RUNESTONE_1, ABYSS_RUNESTONE_2, ABYSS_RUNESTONE_3)) { st.set("cond", "17"); }
                break;
        }
