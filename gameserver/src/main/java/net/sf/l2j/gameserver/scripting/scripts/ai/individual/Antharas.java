...
public class Antharas extends AbstractNpcAI {
    ...
    public String onAdvEvent(String event, L2Npc npc, L2PcInstance player) {
        ...
        else if (event.equalsIgnoreCase("spawn_1")) { ANTHARAS_LAIR.broadcastPacket(new SpecialCamera(npc.getObjectId(), 700, 13, -19, 0, 20000, 0, 0, 1, 0)); }
        ...
        else if (event.equalsIgnoreCase("spawn_3")) { ANTHARAS_LAIR.broadcastPacket(new SpecialCamera(npc.getObjectId(), 3700, 0, -3, 0, 10000, 0, 0, 1, 0)); }
        ...
        else if (event.equalsIgnoreCase("spawn_5")) { ANTHARAS_LAIR.broadcastPacket(new SpecialCamera(npc.getObjectId(), 1100, 0, -3, 300, 7000, 0, 0, 1, 0)); }
    ...
    private static L2Skill getRandomSkill(L2Npc npc) {
        ...
        if (hpRatio < 0.25) {
            ...
            if (playersAround[1] >= 10 && Rnd.get(100) < 80) { return FrequentSkill.ANTHARAS_TAIL.getSkill(); }

            if (playersAround[0] >= 10) {
                if (Rnd.get(100) < 40) { return FrequentSkill.ANTHARAS_DEBUFF.getSkill(); }

                if (Rnd.get(100) < 10) { return FrequentSkill.ANTHARAS_JUMP.getSkill(); }
            }

            if (Rnd.get(100) < 10) { return FrequentSkill.ANTHARAS_METEOR.getSkill(); }
        }
        else if (hpRatio < 0.5) {
            if (playersAround[1] >= 10 && Rnd.get(100) < 80) { return FrequentSkill.ANTHARAS_TAIL.getSkill(); }
            ...
            if (Rnd.get(100) < 7) { return FrequentSkill.ANTHARAS_METEOR.getSkill(); }
        }
        else if (hpRatio < 0.75) {
            if (playersAround[1] >= 10 && Rnd.get(100) < 80) { return FrequentSkill.ANTHARAS_TAIL.getSkill(); }

            if (playersAround[0] >= 10 && Rnd.get(100) < 10) { return FrequentSkill.ANTHARAS_JUMP.getSkill(); }

            if (Rnd.get(100) < 5) { return FrequentSkill.ANTHARAS_METEOR.getSkill(); }
        }
        else {
            if (playersAround[1] >= 10 && Rnd.get(100) < 80) { return FrequentSkill.ANTHARAS_TAIL.getSkill(); }

            if (Rnd.get(100) < 3) { return FrequentSkill.ANTHARAS_METEOR.getSkill(); }
        }

        if (Rnd.get(100) < 6) { return FrequentSkill.ANTHARAS_BREATH.getSkill(); }

        if (Rnd.get(100) < 50) { return FrequentSkill.ANTHARAS_NORMAL_ATTACK.getSkill(); }

        if (Rnd.get(100) < 5) {
            if (Rnd.get(100) < 50) { return FrequentSkill.ANTHARAS_FEAR.getSkill(); }
