...
public class Q406_PathToAnElvenKnight extends Quest {
    ...
    public String onAdvEvent(String event, L2Npc npc, L2PcInstance player) {
        ...
        if (event.equalsIgnoreCase("30327-05.htm")) {
            if (player.getClassId() != ClassId.elvenFighter) { htmltext = (player.getClassId() == ClassId.elvenKnight) ? "30327-02a.htm" : "30327-02.htm"; }
            else if (player.getLevel() < 19) { htmltext = "30327-03.htm"; }
            else if (st.hasQuestItems(ELVEN_KNIGHT_BROOCH)) { htmltext = "30327-04.htm"; }
        }
    ...
    public String onTalk(L2Npc npc, L2PcInstance player) {
        ...
        switch (st.getState()) {
            ...
            case QuestState.STATE_STARTED:
                ...
                switch (npc.getNpcId()) {
                    case SORIUS:
                        if (cond == 1) { htmltext = (!st.hasQuestItems(TOPAZ_PIECE)) ? "30327-07.htm" : "30327-08.htm"; }
                        else if (cond == 2) {
                        ...
                        else if (cond > 2 && cond < 6) { htmltext = "30327-11.htm"; }
                        else if (cond == 6) {
                    ...
                    case KLUTO:
                        ...
                        else if (cond == 4) { htmltext = (!st.hasQuestItems(EMERALD_PIECE)) ? "30317-03.htm" : "30317-04.htm"; }
                        else if (cond == 5) {
                        ...
                        else if (cond == 6) { htmltext = "30317-06.htm"; }
                        break;
                }
                break;
        }
    ...
    public String onKill(L2Npc npc, L2PcInstance player, boolean isPet) {
        ...
        switch (npc.getNpcId()) {
            ...
            case 20054:
            case 20060:
                if (st.getInt("cond") == 1 && st.dropItems(TOPAZ_PIECE, 1, 20, 700000)) { st.set("cond", "2"); }
                break;

            case 20782:
                if (st.getInt("cond") == 4 && st.dropItems(EMERALD_PIECE, 1, 20, 500000)) { st.set("cond", "5"); }
                break;
        }
