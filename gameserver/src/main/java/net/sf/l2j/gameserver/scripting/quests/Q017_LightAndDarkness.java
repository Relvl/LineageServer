                ...
                switch (npc.getNpcId()) {
                    case HIERARCH:
                        if (cond == 5) {
                            ...
                            if (st.hasQuestItems(BLOOD_OF_SAINT)) { htmltext = "31517-05.htm"; }
                            else {
                    ...
                    case SAINT_ALTAR_1:
                        if (cond == 1) { htmltext = "31508-01.htm"; }
                        else if (cond > 1) { htmltext = "31508-04.htm"; }
                        break;

                    case SAINT_ALTAR_2:
                        if (cond == 2) { htmltext = "31509-01.htm"; }
                        else if (cond > 2) { htmltext = "31509-04.htm"; }
                        break;

                    case SAINT_ALTAR_3:
                        if (cond == 3) { htmltext = "31510-01.htm"; }
                        else if (cond > 3) { htmltext = "31510-04.htm"; }
                        break;

                    case SAINT_ALTAR_4:
                        if (cond == 4) { htmltext = "31511-01.htm"; }
                        else if (cond > 4) { htmltext = "31511-04.htm"; }
                        break;
                }
                break;
