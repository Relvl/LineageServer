...
public class GrandBossTeleporters extends Quest {
    ...
    public String onAdvEvent(String event, L2Npc npc, L2PcInstance player) {
        ...
        if (event.equalsIgnoreCase("baium")) {
            ...
            if (player.isFlying()) { htmltext = "31862-05.htm"; }
            // Player hasn't blooded fabric, cancel it.
            else if (!st.hasQuestItems(4295)) { htmltext = "31862-03.htm"; }
        ...
        else if (event.equalsIgnoreCase("baium_story")) { htmltext = "31862-02.htm"; }
        else if (event.equalsIgnoreCase("baium_exit")) { player.teleToLocation(baiumTeleOut[Rnd.get(baiumTeleOut.length)], 100); }
    ...
    public String onFirstTalk(L2Npc npc, L2PcInstance player) {
        ...
        switch (npc.getNpcId()) {
            ...
            case 31862:
                ...
                if (status == Baium.AWAKE) { htmltext = "31862-01.htm"; }
                else if (status == Baium.DEAD) { htmltext = "31862-04.htm"; }
                else { htmltext = "31862-00.htm"; }
                break;
        }
    ...
    public String onTalk(L2Npc npc, L2PcInstance player) {
        ...
        switch (npc.getNpcId()) {
            case 13001:
                ...
                if (status == Antharas.FIGHTING) { htmltext = "13001-02.htm"; }
                else if (status == Antharas.DEAD) { htmltext = "13001-01.htm"; }
                    ...
                    if (st.hasQuestItems(3865)) {
                        ...
                        if (status == Antharas.DORMANT) {
                            ...
                            EScript.AI_Antharas.getQuest().startQuestTimer("beginning", Config.WAIT_TIME_ANTHARAS, null, null, false);
                        }
                    }
            ...
            case 31385:
                ...
                if (status == 0 || status == 1) {
                    if (_valakasPlayersCount >= 200) { htmltext = "31385-03.htm"; }
                        ...
                        if (status == 0) {
                            ...
                            EScript.AI_Valakas.getQuest().startQuestTimer("beginning", Config.WAIT_TIME_VALAKAS, valakas, null, false);
                        }
                    }
            ...
            case 31540:
                if (_valakasPlayersCount < 50) { htmltext = "31540-01.htm"; }
                else if (_valakasPlayersCount < 100) { htmltext = "31540-02.htm"; }
                else if (_valakasPlayersCount < 150) { htmltext = "31540-03.htm"; }
                else if (_valakasPlayersCount < 200) { htmltext = "31540-04.htm"; }
            ...
            case 32109:
                if (!player.isInParty()) { htmltext = "32109-03.htm"; }
                else if (!player.getParty().isLeader(player)) { htmltext = "32109-01.htm"; }
                else {
                    if (st.hasQuestItems(8784)) {
                        ...
                        if (status == Sailren.DORMANT) {
                            ...
                            for (L2PcInstance member : party) {
                                if (member.getLevel() < 70) { return "32109-06.htm"; }

                                if (!Util.checkIfInRange(1000, player, member, true)) { return "32109-07.htm"; }
                            }
                            ...
                            EScript.AI_Sailren.getQuest().startQuestTimer("beginning", 60000, null, null, false);
                        }
                        else if (status == Sailren.DEAD) { htmltext = "32109-04.htm"; }
                        else { htmltext = "32109-05.htm"; }
                    }
                    else { htmltext = "32109-02.htm"; }
                }
                break;
        }
