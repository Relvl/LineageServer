    ...
    public String onTalk(L2Npc npc, L2PcInstance player) {
        ...
        switch (st.getState()) {
            ...
            case QuestState.STATE_STARTED:
                int supplyItems = st.getQuestItemsCount(SUPPLY_ITEM);
                if (supplyItems == 0) { htmltext = "30873-3.htm"; }
                else {
                    int reward = 6000 + (supplyItems * 100) + (st.getQuestItemsCount(RECIPE_OF_SUPPLY) * 6000);
