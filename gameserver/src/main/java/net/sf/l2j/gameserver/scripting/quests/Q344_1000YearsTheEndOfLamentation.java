    ...
    public String onAdvEvent(String event, L2Npc npc, L2PcInstance player) {
        ...
        if (event.equalsIgnoreCase("30754-04.htm")) {
            ...
            if (!st.hasQuestItems(ARTICLE_DEAD_HERO)) { htmltext = "30754-06a.htm"; }
                ...
                int amount = st.getQuestItemsCount(ARTICLE_DEAD_HERO);
    ...
    public String onTalk(L2Npc npc, L2PcInstance player) {
        ...
        switch (st.getState()) {
            ...
            case QuestState.STATE_STARTED:
                ...
                switch (npc.getNpcId()) {
                    case GILMORE:
                        if (cond == 1) { htmltext = (st.hasQuestItems(ARTICLE_DEAD_HERO)) ? "30754-05.htm" : "30754-09.htm"; }
                        else if (cond == 2) { htmltext = (st.get("success") != null) ? "30754-16.htm" : "30754-15.htm"; }
                        break;
