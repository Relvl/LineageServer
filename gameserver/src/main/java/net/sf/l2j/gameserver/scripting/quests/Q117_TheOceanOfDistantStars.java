...
public class Q117_TheOceanOfDistantStars extends Quest {
            ...
            case QuestState.STATE_STARTED:
                ...
                switch (npc.getNpcId()) {
                    case ANCIENT_GHOST:
                        ...
                        else if (cond > 1 && cond < 9) { htmltext = "32055-02.htm"; }
                        else if (cond == 9) { htmltext = "32055-03.htm"; }
                        else if (cond > 9) { htmltext = "32055-05.htm"; }
                        break;

                    case OBI:
                        if (cond == 2) { htmltext = "32052-01.htm"; }
                        else if (cond > 2 && cond < 6) { htmltext = "32052-02.htm"; }
                        else if (cond == 6) { htmltext = "32052-03.htm"; }
                        else if (cond == 7) { htmltext = "32052-04.htm"; }
                        else if (cond == 8) { htmltext = "32052-05.htm"; }
                        else if (cond > 8) { htmltext = "32052-06.htm"; }
                        break;
                    ...
                    case ABEY:
                        ...
                        else if (cond == 5) { htmltext = "32053-05.htm"; }
                        else if (cond > 5) { htmltext = "32053-06.htm"; }
                        break;

                    case BOX:
                        if (cond == 4) { htmltext = "32076-01.htm"; }
                        else if (cond > 4) { htmltext = "32076-03.htm"; }
                        break;
    ...
    public String onKill(L2Npc npc, L2PcInstance player, boolean isPet) {
        ...
        if (st.dropItems(GREY_STAR, 1, 1, 200000)) { st.set("cond", "8"); }
