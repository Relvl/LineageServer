    ...
    public boolean useAdminCommand(String command, L2PcInstance activeChar) {
        if (command.startsWith("admin_ride")) {
            ...
            if (st.hasMoreTokens()) {
                ...
                if (mount.equals("wyvern") || mount.equals("2")) { _petRideId = 12621; }
                else if (mount.equals("strider") || mount.equals("1")) { _petRideId = 12526; }
                else {
            ...
            else if (activeChar.getPet() != null) { activeChar.getPet().unSummon(activeChar); }

            activeChar.mount(_petRideId, 0, false);
        }
        else if (command.equals("admin_unride")) { activeChar.dismount(); }
