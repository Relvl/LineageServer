    ...
    public String onTalk(L2Npc npc, L2PcInstance player) {
        ...
        switch (st.getState()) {
            case QuestState.STATE_CREATED:
                if (player.getLevel() < 75) { htmltext = "31370-03.htm"; }
                else if (player.getAllianceWithVarkaKetra() >= 3 && st.hasQuestItems(KETRA_ALLIANCE_3) && !st.hasQuestItems(TOTEM_OF_VALOR)) { htmltext = "31370-01.htm"; }
