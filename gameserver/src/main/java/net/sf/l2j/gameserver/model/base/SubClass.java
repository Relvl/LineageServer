...
public final class SubClass {
    ...
    public void setExp(long expValue) {
        if (expValue > Experience.LEVEL[Experience.MAX_LEVEL]) { expValue = Experience.LEVEL[Experience.MAX_LEVEL]; }
    ...
    public void setLevel(byte levelValue) {
        if (levelValue > (Experience.MAX_LEVEL - 1)) { levelValue = (Experience.MAX_LEVEL - 1); }
        else if (levelValue < 40) { levelValue = 40; }
