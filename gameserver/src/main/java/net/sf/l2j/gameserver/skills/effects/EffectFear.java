...
public class EffectFear extends L2Effect {
    ...
    public boolean onStart() {
        ...
        if (getEffected() instanceof L2NpcInstance || getEffected() instanceof L2SiegeFlagInstance || getEffected() instanceof L2SiegeSummonInstance) { return false; }

        if (getEffected().isAfraid()) { return false; }
    ...
    public boolean onActionTime() {
        ...
        if (!(getEffected() instanceof L2PetInstance)) { getEffected().setRunning(); }

        getEffected().getAI().setIntention(EIntention.MOVE_TO, new HeadedLocation(posX, posY, posZ, 0));
        return true;
    }
