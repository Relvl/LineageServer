...
public class Q103_SpiritOfCraftsman extends Quest {
    ...
    public String onTalk(L2Npc npc, L2PcInstance player) {
        ...
        switch (st.getState()) {
            case QuestState.STATE_CREATED:
                if (player.getRace() != PlayerRace.DarkElf) { htmltext = "30307-00.htm"; }
                else if (player.getLevel() < 11) { htmltext = "30307-02.htm"; }
                else { htmltext = "30307-03.htm"; }
                break;
            ...
            case QuestState.STATE_STARTED:
                ...
                switch (npc.getNpcId()) {
                    case KARROD:
                        if (cond < 8) { htmltext = "30307-06.htm"; }
                        else if (cond == 8) {
                    ...
                    case CECKTINON:
                        ...
                        else if (cond > 1 && cond < 5) { htmltext = "30132-02.htm"; }
                        else if (cond == 5) {
                        ...
                        else if (cond == 6) { htmltext = "30132-04.htm"; }
                        else if (cond == 7) {
                        ...
                        else if (cond == 8) { htmltext = "30132-06.htm"; }
                        break;
                    ...
                    case HARNE:
                        ...
                        else if (cond == 3) { htmltext = "30144-02.htm"; }
                        else if (cond == 4) {
                        ...
                        else if (cond == 5) { htmltext = "30144-04.htm"; }
                        break;
                }
                break;
    ...
    public String onKill(L2Npc npc, L2PcInstance player, boolean isPet) {
        ...
        switch (npc.getNpcId()) {
            ...
            case 20518:
            case 20455:
                if (st.getInt("cond") == 3 && st.dropItems(BONE_FRAGMENT, 1, 10, 300000)) { st.set("cond", "4"); }
                break;
