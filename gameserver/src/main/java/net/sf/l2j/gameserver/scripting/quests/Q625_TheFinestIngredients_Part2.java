...
public class Q625_TheFinestIngredients_Part2 extends Quest {
    ...
    public Q625_TheFinestIngredients_Part2() {
        ...
        switch (RaidBossSpawnManager.getInstance().getRaidBossStatusId(ICICLE_EMPEROR_BUMBALUMP)) {
            case UNDEFINED:
                LOGGER.warn(qn + ": can not find spawned L2RaidBoss id=" + ICICLE_EMPEROR_BUMBALUMP);
                break;
    ...
    public String onAdvEvent(String event, L2Npc npc, L2PcInstance player) {
        ...
        // Yeti's Table
            ...
            if (st.hasQuestItems(FOOD_FOR_BUMBALUMP)) {
                ...
                else { htmltext = "31542-04.htm"; }
            }
            else { htmltext = "31542-03.htm"; }
        }
    ...
    public String onTalk(L2Npc npc, L2PcInstance player) {
        ...
        switch (st.getState()) {
            ...
            case STATE_STARTED:
                ...
                switch (npc.getNpcId()) {
                    case JEREMY:
                        if (cond == 1) { htmltext = "31521-05.htm"; }
                        else if (cond == 2) { htmltext = "31521-06.htm"; }
                        else { htmltext = "31521-07.htm"; }
                        break;

                    case YETI_TABLE:
                        if (cond == 1) { htmltext = "31542-01.htm"; }
                        else if (cond == 2) { htmltext = "31542-05.htm"; }
                        break;
                }
                break;
        }
    ...
    private void spawnNpc() {
        ...
        if (_npc == null) { _npc = addSpawn(YETI_TABLE, 157136, -121456, -2363, 40000, false, 0, false); }
    }
    ...
    private static void despawnRaid(L2Npc raid) {
        ...
        if (!raid.isDead()) { raid.teleToLocation(-104700, -252700, -15542, 0); }
