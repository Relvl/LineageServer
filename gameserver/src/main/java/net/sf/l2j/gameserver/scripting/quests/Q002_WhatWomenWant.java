...
public class Q002_WhatWomenWant extends Quest {
    ...
    public String onAdvEvent(String event, L2Npc npc, L2PcInstance player) {
        ...
        if (event.equalsIgnoreCase("30223-04.htm")) {
            ...
            st.takeItems(ARUJIEN_LETTER_3, 1);
            st.rewardItems(ItemConst.ADENA_ID, 450);
    ...
    public String onTalk(L2Npc npc, L2PcInstance player) {
        ...
        switch (st.getState()) {
            case QuestState.STATE_CREATED:
                if (player.getRace() != PlayerRace.Elf && player.getRace() != PlayerRace.Human) { htmltext = "30223-00.htm"; }
                else if (player.getLevel() < 2) { htmltext = "30223-01.htm"; }
                else { htmltext = "30223-02.htm"; }
                break;
            ...
            case QuestState.STATE_STARTED:
                ...
                switch (npc.getNpcId()) {
                    case ARUJIEN:
                        if (st.hasQuestItems(ARUJIEN_LETTER_1)) { htmltext = "30223-05.htm"; }
                        else if (st.hasQuestItems(ARUJIEN_LETTER_3)) { htmltext = "30223-07.htm"; }
                        else if (st.hasQuestItems(ARUJIEN_LETTER_2)) { htmltext = "30223-06.htm"; }
                        else if (st.hasQuestItems(POETRY_BOOK)) { htmltext = "30223-11.htm"; }
                    ...
                    case MIRABEL:
                        ...
                        else if (cond > 1) { htmltext = "30146-02.htm"; }
                        break;
                    ...
                    case HERBIEL:
                        ...
                        else if (cond > 2) { htmltext = "30150-02.htm"; }
                        break;

                    case GREENIS:
                        if (cond > 0 && cond < 4) { htmltext = "30157-01.htm"; }
                        else if (cond == 4) {
                        ...
                        else if (cond == 5) { htmltext = "30157-03.htm"; }
                        break;
                }
                break;
