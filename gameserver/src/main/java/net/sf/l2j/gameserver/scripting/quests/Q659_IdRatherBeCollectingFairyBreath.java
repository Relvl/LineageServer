    ...
    public String onAdvEvent(String event, L2Npc npc, L2PcInstance player) {
        ...
        if (event.equalsIgnoreCase("30634-03.htm")) {
            ...
            if (count > 0) {
                ...
                if (count < 10) { st.rewardItems(ItemConst.ADENA_ID, count * 50); }
                else { st.rewardItems(ItemConst.ADENA_ID, count * 50 + 5365); }
            }
        }
        else if (event.equalsIgnoreCase("30634-08.htm")) { st.exitQuest(true); }
