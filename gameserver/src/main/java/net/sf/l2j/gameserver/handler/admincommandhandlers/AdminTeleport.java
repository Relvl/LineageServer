...
public class AdminTeleport implements IAdminCommandHandler {
    ...
    public boolean useAdminCommand(String command, L2PcInstance activeChar) {
        // runmod
        if (command.equals("admin_runmod") || command.equals("admin_instant_move")) { activeChar.setTeleMode(1); }
        ...
        if (command.equals("admin_tele_areas")) { AdminHelpPage.showHelpPage(activeChar, "tele/other.htm"); }
