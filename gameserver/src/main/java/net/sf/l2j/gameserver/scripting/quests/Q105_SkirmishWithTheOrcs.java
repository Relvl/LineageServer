    ...
    public String onTalk(L2Npc npc, L2PcInstance player) {
        ...
        switch (st.getState()) {
            case QuestState.STATE_CREATED:
                if (player.getRace() != PlayerRace.Elf) { htmltext = "30218-00.htm"; }
                else if (player.getLevel() < 10) { htmltext = "30221-01.htm"; }
                else { htmltext = "30218-02.htm"; }
                break;

            case QuestState.STATE_STARTED:
                int cond = st.getInt("cond");
                if (cond == 1) { htmltext = "30218-05.htm"; }
                else if (cond == 2) {
                ...
                else if (cond == 3) { htmltext = "30218-07.htm"; }
                else if (cond == 4) {
                    ...
                    if (player.isMageClass()) { st.giveItems(RED_SUNSET_STAFF, 1); }
                    else { st.giveItems(RED_SUNSET_SWORD, 1); }
