...
public final class RequestSellItem extends L2GameClientPacket {
    ...
    protected void runImpl() {
        ...
        {
            if (merchant.getTemplate().getNpcId() != _listId - 1000000) { return; }
        }
        ...
        String htmlFolder = "";
        if (merchant instanceof L2MerchantInstance) { htmlFolder = "merchant"; }
        else if (merchant instanceof L2FishermanInstance) { htmlFolder = "fisherman"; }
