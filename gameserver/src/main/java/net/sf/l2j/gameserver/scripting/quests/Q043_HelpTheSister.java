    ...
    public String onTalk(L2Npc npc, L2PcInstance player) {
        ...
        switch (st.getState()) {
            ...
            case QuestState.STATE_STARTED:
                ...
                switch (npc.getNpcId()) {
                    case COOPER:
                        if (cond == 1) { htmltext = (!st.hasQuestItems(CRAFTED_DAGGER)) ? "30829-01a.htm" : "30829-02.htm"; }
                        else if (cond == 2) { htmltext = "30829-03a.htm"; }
                        else if (cond == 3) { htmltext = "30829-04.htm"; }
                        else if (cond == 4) { htmltext = "30829-05a.htm"; }
                        else if (cond == 5) { htmltext = "30829-06.htm"; }
                        break;

                    case GALLADUCCI:
                        if (cond == 4) { htmltext = "30097-05.htm"; }
                        else if (cond == 5) { htmltext = "30097-06a.htm"; }
                        break;
                }
                break;
