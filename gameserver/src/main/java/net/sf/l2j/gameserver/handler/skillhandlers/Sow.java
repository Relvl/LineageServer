...
public class Sow implements ISkillHandler {
    ...
    public void useSkill(L2Character activeChar, L2Skill skill, L2Object[] targets) {
        ...
        if (activeChar.isPlayer() && activeChar.getActingPlayer().getInventory().destroyItemByItemId(EItemProcessPurpose.CONSUME, seedId, 1, activeChar.getActingPlayer(), target, false) == null) { return; }
