    ...
    public String onTalk(L2Npc npc, L2PcInstance player) {
        ...
        switch (st.getState()) {
            ...
            case QuestState.STATE_STARTED:
                ...
                switch (npc.getNpcId()) {
                    case ALVAH:
                        if (cond < 4) { htmltext = "30381-02a.htm"; }
                        else if (cond == 4) { htmltext = "30381-03.htm"; }
                        else if (cond == 5) {
                            ...
                            else { htmltext = "30381-04a.htm"; }
                        }
                        else if (cond == 6) {
                            if (st.hasQuestItems(WEAPON_TRADE_CONTRACT, ATTACK_DIRECTIVES)) { htmltext = "30381-06.htm"; }
                            else { htmltext = "30381-05a.htm"; }
                        }
                        else if (cond > 6 && cond < 11) { htmltext = "30381-07a.htm"; }
                        else if (cond == 11) {
                    ...
                    case ARODIN:
                        if (cond == 1) { htmltext = "30207-01.htm"; }
                        else if (cond == 2) { htmltext = "30207-01a.htm"; }
                        else if (cond == 3) {
                            ...
                            else { htmltext = "30207-01a.htm"; }
                        }
                        else if (cond > 3) { htmltext = "30207-03a.htm"; }
                        break;
                    ...
                    case TYRA:
                        if (cond == 2) {
                            ...
                            else { htmltext = "30420-01b.htm"; }
                        }
                        else if (cond == 3) { htmltext = "30420-01a.htm"; }
                        else if (cond > 3) { htmltext = "30420-02.htm"; }
                        break;
                    ...
                    case NETI:
                        ...
                        else if (cond > 7) { htmltext = "30425-02.htm"; }
                        break;

                    case ROLENTO:
                        if (cond == 8) { htmltext = "30437-01.htm"; }
                        else if (cond > 8) { htmltext = "30437-03a.htm"; }
                        break;

                    case BURAI:
                        if (cond == 9 && st.hasQuestItems(CERTIFICATE, CARGO_BOX, ATTACK_DIRECTIVES)) { htmltext = "30617-01.htm"; }
                        else if (cond == 10) {
        ...
        switch (npcId) {
            ...
            case 20499:
                if (st.getInt("cond") == 2 && !st.dropItems(BLADE_MOLD, 1, 20, CHANCES.get(npcId))) {
                    int count = st.getQuestItemsCount(BLADE_MOLD);
                    if (count == 5 || (count >= 10 && Rnd.get(100) < 25)) { addSpawn(27190, player, false, 0, true); }
                }
                break;
            ...
            case 20066:
                if (st.getInt("cond") == 10) { st.dropItems(OL_MAHUM_HEAD, 1, 30, 500000); }
                break;
        }
