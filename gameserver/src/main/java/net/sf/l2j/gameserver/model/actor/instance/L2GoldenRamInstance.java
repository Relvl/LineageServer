...
public class L2GoldenRamInstance extends L2NpcInstance {
        ...
        if (st != null) {
            ...
            switch (npcId) {
                ...
                case 31554:
                    ...
                    if (cond >= 2) { filename = "data/html/default/" + npcId + "-1.htm"; }
                    break;
                ...
                case 31556:
                    ...
                    if (cond == 2) { filename = "data/html/default/" + npcId + "-1.htm"; }
                    else if (cond == 3) { filename = "data/html/default/" + npcId + "-2.htm"; }
                    break;
            }
        }
    ...
    public void onBypassFeedback(L2PcInstance player, String command) {
        ...
        if (actualCommand.contains("buff")) {
            ...
            if (qs != null && qs.getInt("cond") == 3) { MultisellData.getInstance().separateAndSend(Integer.parseInt(command.substring(10).trim()), player, false, getCastle().getTaxRate()); }
        }
