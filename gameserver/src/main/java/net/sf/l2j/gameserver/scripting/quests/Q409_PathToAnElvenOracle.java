...
public class Q409_PathToAnElvenOracle extends Quest {
    ...
    public String onAdvEvent(String event, L2Npc npc, L2PcInstance player) {
        ...
        else if (event.equalsIgnoreCase("30428-06.htm")) { addSpawn(27035, -93194, 147587, -2672, 2000, false, 0, true); }
    ...
    public String onTalk(L2Npc npc, L2PcInstance player) {
        ...
        switch (st.getState()) {
            case QuestState.STATE_CREATED:
                if (player.getClassId() != ClassId.elvenMage) { htmltext = (player.getClassId() == ClassId.oracle) ? "30293-02a.htm" : "30293-02.htm"; }
                else if (player.getLevel() < 19) { htmltext = "30293-03.htm"; }
                else if (st.hasQuestItems(LEAF_OF_ORACLE)) { htmltext = "30293-04.htm"; }
                else { htmltext = "30293-01.htm"; }
                break;
            ...
            case QuestState.STATE_STARTED:
                ...
                switch (npc.getNpcId()) {
                    case MANUEL:
                        if (cond == 1) { htmltext = "30293-06.htm"; }
                        else if (cond == 2 || cond == 3) { htmltext = "30293-09.htm"; }
                        else if (cond > 3 && cond < 7) { htmltext = "30293-07.htm"; }
                        else if (cond == 7) {
                    ...
                    case ALLANA:
                        if (cond == 1) { htmltext = "30424-01.htm"; }
                        else if (cond == 3) {
                        ...
                        else if (cond == 4) { htmltext = "30424-03.htm"; }
                        else if (cond == 5) { htmltext = "30424-06.htm"; }
                        else if (cond == 6) {
                        ...
                        else if (cond == 7) { htmltext = "30424-05.htm"; }
                        break;

                    case PERRIN:
                        if (cond == 4) { htmltext = "30428-01.htm"; }
                        else if (cond == 5) {
                        ...
                        else if (cond > 5) { htmltext = "30428-05.htm"; }
                        break;
                }
                break;
        }
