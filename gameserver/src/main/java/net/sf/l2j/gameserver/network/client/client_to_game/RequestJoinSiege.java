...
public final class RequestJoinSiege extends L2GameClientPacket {
    ...
    protected void runImpl() {
        ...
        if (_isJoining == 1) {
            ...
            if (_isAttacker == 1) { castle.getSiege().registerAttacker(activeChar); }
            else { castle.getSiege().registerDefender(activeChar); }
        }
        else { castle.getSiege().removeSiegeClan(activeChar); }
