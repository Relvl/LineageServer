...
public class HerbDropTable {
    private static final Logger LOGGER = LoggerFactory.getLogger(HerbDropTable.class);
        ...
        try {
            ...
            for (Node d = n.getFirstChild(); d != null; d = d.getNextSibling()) {
                if ("group".equalsIgnoreCase(d.getNodeName())) {
                    ...
                    if (_herbGroups.containsKey(groupId)) { category = _herbGroups.get(groupId); }
                    else {
                    ...
                    for (Node cd = d.getFirstChild(); cd != null; cd = cd.getNextSibling()) {
                        ...
                        if ("item".equalsIgnoreCase(cd.getNodeName())) {
                            ...
                            if (ItemTable.getInstance().getTemplate(dropDat.getItemId()) == null) {
                                LOGGER.warn("HerbDropTable: Herb data for undefined item template! GroupId: {}, itemId: {}", groupId, dropDat.getItemId());
                                continue;
                            }
            ...
            LOGGER.error("HerbDropTable: Error while creating table: ", e);
        }
        LOGGER.info("HerbDropTable: Loaded {} herbs groups.", _herbGroups.size());
    }
