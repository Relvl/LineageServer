    ...
    public String onTalk(L2Npc npc, L2PcInstance player) {
        ...
        switch (st.getState()) {
            ...
            case QuestState.STATE_STARTED:
                ...
                switch (npc.getNpcId()) {
                    case DARIN:
                        if (cond == 1) { htmltext = "30048-07.htm"; }
                        else if (cond == 2) {
                        ...
                        else if (cond == 3) { htmltext = "30048-09.htm"; }
                        else if (cond == 4) {
                    ...
                    case ROXXY:
                        ...
                        else if (cond == 2) { htmltext = "30006-02.htm"; }
                        else if (cond > 2) { htmltext = "30006-03.htm"; }
                        break;
                    ...
                    case BAULRO:
                        ...
                        else if (cond == 4) { htmltext = "30033-02.htm"; }
                        break;
                }
                break;
