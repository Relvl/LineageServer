...
public class Q220_TestimonyOfGlory extends Quest {
    ...
    // Checks & Instances
    private static boolean _sonsOfVoltar;
    private static boolean _enkuOrcOverlords;
    private static boolean _makumBugbearThugs;
    ...
    public String onAdvEvent(String event, L2Npc npc, L2PcInstance player) {
        ...
        // KASMAN
            ...
            if (st.hasQuestItems(KASMAN_LETTER_1)) { htmltext = "30501-04.htm"; }
            else {
            ...
            if (st.hasQuestItems(KASMAN_LETTER_2)) { htmltext = "30501-07.htm"; }
            else {
            ...
            if (st.hasQuestItems(KASMAN_LETTER_3)) { htmltext = "30501-10.htm"; }
            else {
        ...
        // MANAKIA
            ...
            if (st.hasQuestItems(MANAKIA_LETTER_1)) { htmltext = "30515-04.htm"; }
            else {
            ...
            if (st.hasQuestItems(MANAKIA_LETTER_2)) { htmltext = "30515-07.htm"; }
            else {
    ...
    public String onTalk(L2Npc npc, L2PcInstance player) {
        ...
        switch (st.getState()) {
            case QuestState.STATE_CREATED:
                if (player.getRace() != PlayerRace.Orc) { htmltext = "30514-01.htm"; }
                else if (player.getLevel() < 37) { htmltext = "30514-02.htm"; }
                else if (player.getClassId().level() != 1) { htmltext = "30514-01a.htm"; }
                else { htmltext = "30514-03.htm"; }
                break;
            ...
            case QuestState.STATE_STARTED:
                ...
                switch (npc.getNpcId()) {
                    case VOKIAN:
                        if (cond == 1) { htmltext = "30514-06.htm"; }
                        else if (cond == 2) {
                        ...
                        else if (cond == 3) { htmltext = "30514-09.htm"; }
                        else if (cond == 8) { htmltext = "30514-10.htm"; }
                        break;

                    case CHIANTA:
                        if (cond == 3) { htmltext = "30642-01.htm"; }
                        else if (cond == 4) { htmltext = "30642-04.htm"; }
                        else if (cond == 5) {
                            if (st.hasQuestItems(CHIANTA_ORDER_2)) {
                                ...
                                else { htmltext = "30642-08.htm"; }
                            }
                            else { htmltext = "30642-05.htm"; }
                        }
                        else if (cond == 6) { htmltext = "30642-10.htm"; }
                        else if (cond == 7) {
                        ...
                        else if (cond == 8) { htmltext = "30642-12.htm"; }
                        else if (cond > 8) { htmltext = "30642-13.htm"; }
                        break;

                    case KASMAN:
                        if (st.hasQuestItems(CHIANTA_ORDER_1)) { htmltext = "30501-01.htm"; }
                        else if (cond > 4) { htmltext = "30501-11.htm"; }
                        break;

                    case MANAKIA:
                        if (st.hasQuestItems(CHIANTA_ORDER_1)) { htmltext = "30515-01.htm"; }
                        else if (cond > 4) { htmltext = "30515-08.htm"; }
                        break;
                    ...
                    case VOLTAR:
                        if (cond > 3) {
                            ...
                            else if (st.hasQuestItems(SCEPTER_OF_BREKA)) { htmltext = "30615-07.htm"; }
                            else if (st.hasQuestItems(CHIANTA_ORDER_1)) { htmltext = "30615-01.htm"; }
                            else if (cond < 9) { htmltext = "30615-08.htm"; }
                        }
                        break;
                    ...
                    case KEPRA:
                        if (cond > 3) {
                            ...
                            else if (st.hasQuestItems(SCEPTER_OF_ENKU)) { htmltext = "30616-07.htm"; }
                            else if (st.hasQuestItems(CHIANTA_ORDER_1)) { htmltext = "30616-01.htm"; }
                            else if (cond < 9) { htmltext = "30616-08.htm"; }
                        }
                        break;
                    ...
                    case BURAI:
                        if (cond > 3) {
                            ...
                            else if (st.hasQuestItems(SCEPTER_OF_TUREK)) { htmltext = "30617-06.htm"; }
                            else if (st.hasQuestItems(CHIANTA_ORDER_1)) { htmltext = "30617-01.htm"; }
                            else if (cond < 8) { htmltext = "30617-07.htm"; }
                        }
                        break;
                    ...
                    case HARAK:
                        if (cond > 3) {
                            ...
                            else if (st.hasQuestItems(SCEPTER_OF_TUNATH)) { htmltext = "30618-04.htm"; }
                            else if (st.hasQuestItems(CHIANTA_ORDER_1)) { htmltext = "30618-01.htm"; }
                            else if (cond < 9) { htmltext = "30618-05.htm"; }
                        }
                        break;
                    ...
                    case DRIKO:
                        if (cond > 3) {
                            if (st.hasQuestItems(KASMAN_LETTER_1)) {
                                ...
                                else { htmltext = "30619-04.htm"; }
                            }
                            else if (st.hasQuestItems(SCEPTER_OF_VUKU)) { htmltext = "30619-06.htm"; }
                            else if (st.hasQuestItems(CHIANTA_ORDER_1)) { htmltext = "30619-01.htm"; }
                            else if (cond < 8) { htmltext = "30619-07.htm"; }
                        }
                        break;

                    case TANAPI:
                        if (cond == 8) { htmltext = "30571-01.htm"; }
                        else if (cond == 9) { htmltext = "30571-04.htm"; }
                        else if (cond == 10) {
                        ...
                        else if (cond == 11) { htmltext = "30571-06.htm"; }
                        break;

                    case KAKAI:
                        if (cond > 7 && cond < 11) { htmltext = "30565-01.htm"; }
                        else if (cond == 11) {
    ...
    public String onKill(L2Npc npc, L2PcInstance player, boolean isPet) {
        ...
        switch (npc.getNpcId()) {
            case TYRANT:
                if (cond == 1 && st.dropItems(TYRANT_TALON, 1, 10, 500000) && st.getQuestItemsCount(GUARDIAN_BASILISK_FANG) + st.getQuestItemsCount(MANASHEN_SHARD) == 20) { st.set("cond", "2"); }
                break;

            case GUARDIAN_BASILISK:
                if (cond == 1 && st.dropItems(GUARDIAN_BASILISK_FANG, 1, 10, 500000) && st.getQuestItemsCount(TYRANT_TALON) + st.getQuestItemsCount(MANASHEN_SHARD) == 20) { st.set("cond", "2"); }
                break;

            case MANASHEN_GARGOYLE:
                if (cond == 1 && st.dropItems(MANASHEN_SHARD, 1, 10, 750000) && st.getQuestItemsCount(TYRANT_TALON) + st.getQuestItemsCount(GUARDIAN_BASILISK_FANG) == 20) { st.set("cond", "2"); }
                break;

            case MARSH_STAKATO_DRONE:
                if (st.hasQuestItems(DRIKO_CONTRACT)) { st.dropItems(STAKATO_DRONE_HUSK, 1, 30, 750000); }
                break;
            ...
            case ENKU_ORC_OVERLORD:
                if (st.hasQuestItems(GLOVE_OF_KEPRA) && st.dropItemsAlways(ENKU_OVERLORD_HEAD, 1, 4)) { st.takeItems(GLOVE_OF_KEPRA, 1); }
                break;

            case MAKUM_BUGBEAR_THUG:
                if (st.hasQuestItems(GLOVE_OF_BURAI) && st.dropItemsAlways(MAKUM_BUGBEAR_HEAD, 1, 2)) { st.takeItems(GLOVE_OF_BURAI, 1); }
                break;
            ...
            case TIMAK_ORC_OVERLORD:
                if (cond == 6 && st.dropItems(TIMAK_ORC_HEAD, 1, 20, 500000 + ((npc.getNpcId() - 20583) * 100000)) && st.getQuestItemsCount(TAMLIN_ORC_SKULL) == 20) { st.set("cond", "7"); }
                break;

            case TAMLIN_ORC:
                if (cond == 6 && st.dropItems(TAMLIN_ORC_SKULL, 1, 20, 500000) && st.getQuestItemsCount(TIMAK_ORC_HEAD) == 20) { st.set("cond", "7"); }
                break;

            case TAMLIN_ORC_ARCHER:
                if (cond == 6 && st.dropItems(TAMLIN_ORC_SKULL, 1, 20, 600000) && st.getQuestItemsCount(TIMAK_ORC_HEAD) == 20) { st.set("cond", "7"); }
                break;
