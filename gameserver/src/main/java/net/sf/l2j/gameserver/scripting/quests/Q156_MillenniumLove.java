    ...
    public String onTalk(L2Npc npc, L2PcInstance player) {
        ...
        switch (st.getState()) {
            ...
            case QuestState.STATE_STARTED:
                switch (npc.getNpcId()) {
                    case LILITH:
                        if (st.hasQuestItems(LILITH_LETTER)) { htmltext = "30368-05.htm"; }
                    ...
                    case BAENEDES:
                        if (st.hasQuestItems(LILITH_LETTER)) { htmltext = "30369-01.htm"; }
                        else if (st.hasQuestItems(THEON_DIARY)) { htmltext = "30369-04.htm"; }
                        break;
                }
                break;
