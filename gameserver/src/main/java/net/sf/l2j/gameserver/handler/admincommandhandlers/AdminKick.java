...
public class AdminKick implements IAdminCommandHandler {
    ...
    public boolean useAdminCommand(String command, L2PcInstance activeChar) {
        if (command.equals("admin_character_disconnect") || command.equals("admin_kick")) { disconnectCharacter(activeChar); }
    ...
    private static void disconnectCharacter(L2PcInstance activeChar) {
        ...
        if (player == activeChar) { activeChar.sendMessage("You cannot disconnect your own character."); }
        else {
