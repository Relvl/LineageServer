...
public class RequestBuyProcure extends L2GameClientPacket {
    ...
    protected void runImpl() {
        ...
        for (Procure i : _items) {
            ...
            item = player.getInventory().addItem(EItemProcessPurpose.MANOR, i.getReward(), i.getCount(), player, manager);
            if (item == null) { continue; }

            playerIU.addRemovedItem(iteme);
            if (item.getCount() > i.getCount()) { playerIU.addModifiedItem(item); }
