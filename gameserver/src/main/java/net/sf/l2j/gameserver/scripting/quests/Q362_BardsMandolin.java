    ...
    public String onTalk(L2Npc npc, L2PcInstance player) {
        ...
        switch (st.getState()) {
            ...
            case QuestState.STATE_STARTED:
                ...
                switch (npc.getNpcId()) {
                    case SWAN:
                        if (cond == 1 || cond == 2) { htmltext = "30957-4.htm"; }
                        else if (cond == 3) {
                        ...
                        else if (cond == 4) { htmltext = "30957-5a.htm"; }
                        else if (cond == 5) { htmltext = "30957-6.htm"; }
                        break;
                    ...
                    case WOODROW:
                        ...
                        else if (cond == 2) { htmltext = "30837-2.htm"; }
                        else if (cond > 2) { htmltext = "30837-3.htm"; }
                        break;
                    ...
                    case GALION:
                        ...
                        else if (cond > 2) { htmltext = "30958-2.htm"; }
                        break;
                    ...
                    case NANARIN:
                        ...
                        else if (cond == 5) { htmltext = "30956-2.htm"; }
                        break;
                }
                break;
        }
