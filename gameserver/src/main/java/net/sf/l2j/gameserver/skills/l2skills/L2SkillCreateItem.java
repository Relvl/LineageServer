...
public class L2SkillCreateItem extends L2Skill {
    ...
    public void useSkill(L2Character activeChar, L2Object[] targets) {
        ...
        if (activeChar instanceof L2Playable) {
            ...
            if (activeChar instanceof L2PcInstance) { player.addItem(EItemProcessPurpose.SKILL, _createItemId[rndid], count, activeChar, true); }
            else if (activeChar instanceof L2PetInstance) {
                activeChar.getInventory().addItem(EItemProcessPurpose.SKILL, _createItemId[rndid], count, player, activeChar);
