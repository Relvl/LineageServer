...
public class Post {
    ...
    public void insertindb(CPost cp) {
        try (Connection con = L2DatabaseFactoryOld.getInstance().getConnection()) {
            ...
            LOGGER.error("Error while saving new Post to db {}", e.getMessage(), e);
        }
    }
    ...
    public void deleteMe(Topic t) {
        ...
        try (Connection con = L2DatabaseFactoryOld.getInstance().getConnection()) {
            ...
            LOGGER.error("Error while deleting post: {}", e.getMessage(), e);
        }
    }
    ...
    private void load(Topic t) {
        try (Connection con = L2DatabaseFactoryOld.getInstance().getConnection()) {
            ...
            LOGGER.error("Data error on Post {}/{} : {}", t.getForumID(), t.getID(), e.getMessage(), e);
        }
    }
