...
public class Q218_TestimonyOfLife extends Quest {
    ...
    public String onTalk(L2Npc npc, L2PcInstance player) {
        ...
        switch (st.getState()) {
            case STATE_CREATED:
                if (player.getRace() != Race.Elf) { htmltext = "30460-01.htm"; }
            ...
            case STATE_STARTED:
                ...
                switch (npc.getNpcId()) {
                    case ASTERIOS:
                        if (cond == 1) { htmltext = "30154-01.htm"; }
                        else if (cond == 2) { htmltext = "30154-08.htm"; }
                        else if (cond == 20) {
                        ...
                        else if (cond == 21) { htmltext = "30154-10.htm"; }
                        break;

                    case PUSHKIN:
                        if (cond == 3) { htmltext = "30300-01.htm"; }
                        else if (cond == 4) { htmltext = "30300-07.htm"; }
                        else if (cond == 5) { htmltext = "30300-08.htm"; }
                        else if (cond == 6) { htmltext = "30300-11.htm"; }
                        else if (cond > 6) { htmltext = "30300-12.htm"; }
                        break;

                    case THALIA:
                        if (cond == 2) { htmltext = "30371-01.htm"; }
                        else if (cond == 3) { htmltext = "30371-04.htm"; }
                        else if (cond > 3 && cond < 6) { htmltext = "30371-05.htm"; }
                        else if (cond == 6) {
                        ...
                        else if (cond == 7) { htmltext = "30371-07.htm"; }
                        else if (cond > 7 && cond < 12) { htmltext = "30371-08.htm"; }
                        else if (cond == 12) { htmltext = "30371-09.htm"; }
                        else if (cond == 13) {
                            if (player.getLevel() < 38) { htmltext = "30371-12.htm"; }
                            else {
                        ...
                        else if (cond == 14) { htmltext = "30371-14.htm"; }
                        else if (cond > 14 && cond < 17) { htmltext = "30371-15.htm"; }
                        else if (cond == 17) {
                        ...
                        else if (cond == 18) { htmltext = "30371-17.htm"; }
                        else if (cond == 19) {
                        ...
                        else if (cond > 19) { htmltext = "30371-19.htm"; }
                        break;

                    case ADONIUS:
                        if (cond == 8) { htmltext = "30375-01.htm"; }
                        else if (cond == 9) { htmltext = "30375-03.htm"; }
                        else if (cond == 10) {
                        ...
                        else if (cond == 11) { htmltext = "30375-05.htm"; }
                        else if (cond > 11) { htmltext = "30375-06.htm"; }
                        break;

                    case ARKENIA:
                        if (cond == 7) { htmltext = "30419-01.htm"; }
                        else if (cond > 7 && cond < 11) { htmltext = "30419-05.htm"; }
                        else if (cond == 11) {
                        ...
                        else if (cond == 12) { htmltext = "30419-07.htm"; }
                        else if (cond > 12) { htmltext = "30419-08.htm"; }
                        break;

                    case CARDIEN:
                        if (cond == 1) { htmltext = "30460-05.htm"; }
                        else if (cond > 1 && cond < 21) { htmltext = "30460-06.htm"; }
                        else if (cond == 21) {
                    ...
                    case ISAEL:
                        if (cond == 14) { htmltext = "30655-01.htm"; }
                        else if (cond == 15) { htmltext = "30655-03.htm"; }
                        else if (cond == 16) {
                            if (st.hasQuestItems(TALINS_PIECES)) {
                                ...
                                for (int itemId : TALINS_PIECES) { st.takeItems(itemId, 1); }

                                st.takeItems(ISAEL_INSTRUCTIONS, 1);
                                st.giveItems(ISAEL_LETTER, 1);
                                st.giveItems(TALINS_SPEAR, 1);
                            }
                            else { htmltext = "30655-03.htm"; }
                        }
                        else if (cond == 17) { htmltext = "30655-05.htm"; }
                        else if (cond > 17) { htmltext = "30655-06.htm"; }
                        break;
    ...
    public String onKill(L2Npc npc, L2PcInstance player, boolean isPet) {
        ...
        switch (npc.getNpcId()) {
            case 20550:
                if (st.getInt("cond") == 4 && st.dropItems(PURE_MITHRIL_ORE, 1, 10, 500000)) { if (st.getQuestItemsCount(WYRM_TALON) >= 20 && st.getQuestItemsCount(ANT_SOLDIER_ACID) >= 20) { st.set("cond", "5"); } }
                break;

            case 20176:
                if (st.getInt("cond") == 4 && st.dropItems(WYRM_TALON, 1, 20, 500000)) { if (st.getQuestItemsCount(PURE_MITHRIL_ORE) >= 10 && st.getQuestItemsCount(ANT_SOLDIER_ACID) >= 20) { st.set("cond", "5"); } }
                break;
            ...
            case 20087:
            case 20088:
                if (st.getInt("cond") == 4 && st.dropItems(ANT_SOLDIER_ACID, 1, 20, 800000)) { if (st.getQuestItemsCount(PURE_MITHRIL_ORE) >= 10 && st.getQuestItemsCount(WYRM_TALON) >= 20) { st.set("cond", "5"); } }
                break;

            case 20233:
                if (st.getInt("cond") == 9 && st.dropItems(SPIDER_ICHOR, 1, 20, 500000) && st.getQuestItemsCount(HARPY_DOWN) >= 20) { st.set("cond", "10"); }
                break;

            case 20145:
                if (st.getInt("cond") == 9 && st.dropItems(HARPY_DOWN, 1, 20, 500000) && st.getQuestItemsCount(SPIDER_ICHOR) >= 20) { st.set("cond", "10"); }
                break;

            case 27077:
                if (st.getInt("cond") == 18 && st.getItemEquipped(EPaperdollSlot.PAPERDOLL_RHAND) == TALINS_SPEAR) {
                    st.set("cond", "19");
                    st.playSound(QuestState.SOUND_MIDDLE);
