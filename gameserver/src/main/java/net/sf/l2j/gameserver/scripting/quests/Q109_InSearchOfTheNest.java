    ...
    public String onTalk(L2Npc npc, L2PcInstance player) {
        ...
        switch (st.getState()) {
            case QuestState.STATE_CREATED:
                ...
                if (player.getLevel() >= 66 && st.hasAtLeastOneQuestItem(RECRUIT_BADGE, SOLDIER_BADGE)) { htmltext = "31553-00.htm"; }
                else { htmltext = "31553-00a.htm"; }
                break;
            ...
            case QuestState.STATE_STARTED:
                ...
                switch (npc.getNpcId()) {
                    case PIERCE:
                        if (cond == 1) { htmltext = "31553-01a.htm"; }
                        else if (cond == 2) { htmltext = "31553-02.htm"; }
                        else if (cond == 3) { htmltext = "31553-03.htm"; }
                        break;

                    case SCOUT_CORPSE:
                        if (cond == 1) { htmltext = "32015-01.htm"; }
                        else if (cond == 2) { htmltext = "32015-02.htm"; }
                        break;

                    case KAHMAN:
                        if (cond == 3) { htmltext = "31554-01.htm"; }
                        break;
                }
                break;
