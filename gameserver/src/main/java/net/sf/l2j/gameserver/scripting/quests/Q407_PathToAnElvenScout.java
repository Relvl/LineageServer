...
public class Q407_PathToAnElvenScout extends Quest {
    ...
    public String onAdvEvent(String event, L2Npc npc, L2PcInstance player) {
        ...
        if (event.equalsIgnoreCase("30328-05.htm")) {
            if (player.getClassId() != ClassId.elvenFighter) { htmltext = (player.getClassId() == ClassId.elvenScout) ? "30328-02a.htm" : "30328-02.htm"; }
            else if (player.getLevel() < 19) { htmltext = "30328-03.htm"; }
            else if (st.hasQuestItems(REISA_RECOMMENDATION)) { htmltext = "30328-04.htm"; }
            else {
    ...
    public String onTalk(L2Npc npc, L2PcInstance player) {
        ...
        switch (st.getState()) {
            ...
            case QuestState.STATE_STARTED:
                ...
                switch (npc.getNpcId()) {
                    case REISA:
                        if (cond == 1) { htmltext = "30328-06.htm"; }
                        else if (cond > 1 && cond < 8) { htmltext = "30328-08.htm"; }
                        else if (cond == 8) {
                    ...
                    case MORETTI:
                        if (cond == 1) { htmltext = "30337-01.htm"; }
                        else if (cond == 2) { htmltext = (!st.hasQuestItems(PRIAS_TORN_LETTER_1)) ? "30337-04.htm" : "30337-05.htm"; }
                        else if (cond == 3) {
                        ...
                        else if (cond > 3 && cond < 7) { htmltext = "30337-09.htm"; }
                        ...
                        else if (cond == 8) { htmltext = "30337-08.htm"; }
                        break;

                    case BABENCO:
                        if (cond == 2) { htmltext = "30334-01.htm"; }
                        break;
                    ...
                    case PRIAS:
                        ...
                        else if (cond == 5) { htmltext = "30426-01.htm"; }
                        else if (cond == 6) {
                        ...
                        else if (cond == 7) { htmltext = "30426-04.htm"; }
                        break;
                }
                break;
        }
    ...
    public String onKill(L2Npc npc, L2PcInstance player, boolean isPet) {
        ...
        else if ((cond == 4 || cond == 5) && st.dropItems(RUSTED_KEY, 1, 1, 600000)) { st.set("cond", "6"); }
