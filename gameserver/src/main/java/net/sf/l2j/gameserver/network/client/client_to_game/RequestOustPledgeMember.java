...
public final class RequestOustPledgeMember extends L2GameClientPacket {
    ...
    protected void runImpl() {
        ...
        else { clan.broadcastToOnlineMembers(new PledgeShowMemberListDelete(_target)); }
        ...
        if (member.isOnline()) { member.getPlayerInstance().sendPacket(SystemMessageId.CLAN_MEMBERSHIP_TERMINATED); }
    }
}