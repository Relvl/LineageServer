...
public class Q126_TheNameOfEvil_2 extends Quest {
    ...
    public final String onAdvEvent(String event, L2Npc npc, L2PcInstance player) {
        ...
        if (event.equalsIgnoreCase("32115-05.htm")) {
        ...
        else if (event.equalsIgnoreCase("32122-87.htm")) { st.giveItems(BONEPOWDER, 1); }
            ...
            if (st.getInt("TI") < 1) { st.set("TI", "1"); }
        }
        else if (event.equalsIgnoreCase("SOL_2Two")) {
            htmltext = "32122-59.htm";
            if (st.getInt("SOL_2") < 1) { st.set("SOL_2", "1"); }
        }
            ...
            if (st.getInt("MI_2") < 1) { st.set("MI_2", "1"); }
    ...
    public String onTalk(L2Npc npc, L2PcInstance player) {
        ...
        switch (st.getState()) {
            case QuestState.STATE_CREATED:
                if (player.getLevel() < 77) { htmltext = "32115-02.htm"; }
                else {
                    QuestState st2 = player.getQuestState(Q125_TheNameOfEvil_1.qn);
                    if (st2 != null && st2.isCompleted()) { htmltext = "32115-01.htm"; }
                    else { htmltext = "32115-04.htm"; }
                }
                break;
            ...
            case QuestState.STATE_STARTED:
                ...
                switch (npc.getNpcId()) {
                    case ASAMANAH:
                        ...
                        else if (cond > 1 && cond < 20) { htmltext = "32115-12.htm"; }
                        else if (cond == 20) { htmltext = "32115-13.htm"; }
                        else if (cond == 21) { htmltext = "32115-22.htm"; }
                        else if (cond == 22) { htmltext = "32115-29.htm"; }
                        break;

                    case ULU_KAIMU:
                        if (cond == 1) { htmltext = "32119-01a.htm"; }
                        else if (cond == 2) { htmltext = "32119-02.htm"; }
                        else if (cond == 3) { htmltext = "32119-08.htm"; }
                        else if (cond == 4) { htmltext = "32119-09.htm"; }
                        else if (cond > 4) { htmltext = "32119-12.htm"; }
                        break;

                    case BALU_KAIMU:
                        if (cond < 5) { htmltext = "32120-02.htm"; }
                        else if (cond == 5) { htmltext = "32120-01.htm"; }
                        else if (cond == 6) { htmltext = "32120-03.htm"; }
                        else if (cond == 7) { htmltext = "32120-08.htm"; }
                        else if (cond > 7) { htmltext = "32120-12.htm"; }
                        break;

                    case CHUTA_KAIMU:
                        if (cond < 8) { htmltext = "32121-02.htm"; }
                        else if (cond == 8) { htmltext = "32121-01.htm"; }
                        else if (cond == 9) { htmltext = "32121-03.htm"; }
                        else if (cond == 10) { htmltext = "32121-10.htm"; }
                        else if (cond > 10) { htmltext = "32121-16.htm"; }
                        break;

                    case WARRIOR_GRAVE:
                        if (cond < 11) { htmltext = "32122-02.htm"; }
                        else if (cond == 11) { htmltext = "32122-01.htm"; }
                        else if (cond == 12) { htmltext = "32122-15.htm"; }
                        else if (cond == 13) { htmltext = "32122-18.htm"; }
                        else if (cond == 14) { htmltext = "32122-24.htm"; }
                        else if (cond == 15) { htmltext = "32122-45.htm"; }
                        else if (cond == 16) { htmltext = "32122-66.htm"; }
                        else if (cond == 17) { htmltext = "32122-84.htm"; }
                        else if (cond == 18) { htmltext = "32122-91.htm"; }
                        break;

                    case SHILEN_STONE_STATUE:
                        if (cond < 18) { htmltext = "32109-03.htm"; }
                        else if (cond == 18) { htmltext = "32109-02.htm"; }
                        else if (cond == 19) { htmltext = "32109-05.htm"; }
                        else if (cond > 19) { htmltext = "32109-04.htm"; }
                        break;

                    case MUSHIKA:
                        if (cond < 22) { htmltext = "32114-02.htm"; }
                        else if (cond == 22) { htmltext = "32114-01.htm"; }
                        else if (cond == 23) { htmltext = "32114-04.htm"; }
                        break;
                }
                break;
