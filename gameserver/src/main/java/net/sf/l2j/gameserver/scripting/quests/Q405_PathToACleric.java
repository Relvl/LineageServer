    ...
    public String onTalk(L2Npc npc, L2PcInstance player) {
        ...
        switch (st.getState()) {
            case QuestState.STATE_CREATED:
                if (player.getClassId() != ClassId.mage) { htmltext = (player.getClassId() == ClassId.cleric) ? "30022-02a.htm" : "30022-02.htm"; }
                else if (player.getLevel() < 19) { htmltext = "30022-03.htm"; }
                else if (st.hasQuestItems(MARK_OF_FATE)) { htmltext = "30022-04.htm"; }
                else { htmltext = "30022-01.htm"; }
                break;
            ...
            case QuestState.STATE_STARTED:
                ...
                switch (npc.getNpcId()) {
                    case ZIGAUNT:
                        if (cond == 1) { htmltext = "30022-06.htm"; }
                        else if (cond == 2) {
                        ...
                        else if (cond > 2 && cond < 6) { htmltext = "30022-07.htm"; }
                        else if (cond == 6) {
                    ...
                    case SIMPLON:
                        ...
                        else if (cond > 1 || st.hasQuestItems(BOOK_OF_SIMPLON)) { htmltext = "30253-02.htm"; }
                        break;
                    ...
                    case PRAGA:
                        if (cond == 1) {
                            ...
                            else if (!st.hasQuestItems(PENDANT_OF_MOTHER)) { htmltext = "30333-02.htm"; }
                        ...
                        else if (cond > 1 || st.hasQuestItems(BOOK_OF_PRAGA)) { htmltext = "30333-04.htm"; }
                        break;
                    ...
                    case VIVYAN:
                        ...
                        else if (cond > 1 || st.hasQuestItems(BOOK_OF_VIVYAN)) { htmltext = "30030-02.htm"; }
                        break;

                    case LIONEL:
                        if (cond < 3) { htmltext = "30408-02.htm"; }
                        else if (cond == 3) {
                        ...
                        else if (cond == 4) { htmltext = "30408-03.htm"; }
                        else if (cond == 5) {
                        ...
                        else if (cond == 6) { htmltext = "30408-05.htm"; }
                        break;
                    ...
                    case GALLINT:
                        ...
                        else if (cond > 4) { htmltext = "30017-02.htm"; }
                        break;
                }
                break;
        }
