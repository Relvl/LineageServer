...
public class Q259_RanchersPlea extends Quest {
    ...
    public String onAdvEvent(String event, L2Npc npc, L2PcInstance player) {
        ...
        if (event.equalsIgnoreCase("30497-03.htm")) {
            ...
            else { htmltext = "<html><body>Incorrect item count</body></html>"; }
        }
            ...
            if (st.getQuestItemsCount(GIANT_SPIDER_SKIN) >= 10) { htmltext = "30405-06.htm"; }
        }
    ...
    public String onTalk(L2Npc npc, L2PcInstance player) {
        ...
        switch (st.getState()) {
            ...
            case QuestState.STATE_STARTED:
                ...
                switch (npc.getNpcId()) {
                    case EDMOND:
                        if (count == 0) { htmltext = "30497-04.htm"; }
                        else {
                            htmltext = "30497-05.htm";
                            st.takeItems(GIANT_SPIDER_SKIN, -1);
                            st.rewardItems(ItemConst.ADENA_ID, ((count >= 10) ? 250 : 0) + count * 25);
                        }
                        break;
