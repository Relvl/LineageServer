...
public class AnnouncementTable {
    ...
    public void reload() {
        ...
        for (Announcement announce : _announcements.values()) { announce.stopTask(); }
        ...
        try {
            ...
            for (Node d = n.getFirstChild(); d != null; d = d.getNextSibling()) {
                if (d.getNodeName().equalsIgnoreCase("announcement")) {
                    ...
                    else { _announcements.put(id, new Announcement(message, critical)); }
    ...
    public void listAnnouncements(L2PcInstance activeChar) {
        ...
        if (_announcements.isEmpty()) { sb.append("<tr><td>The XML file doesn't contain any content.</td></tr>"); }
        else {
    ...
    public boolean addAnnouncement(String message, boolean critical, boolean auto, int initialDelay, int delay, int limit) {
        ...
        else { _announcements.put(_announcements.size(), new Announcement(message, critical)); }
