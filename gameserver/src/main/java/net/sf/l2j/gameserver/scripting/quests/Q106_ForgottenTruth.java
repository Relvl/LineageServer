...
public class Q106_ForgottenTruth extends Quest {
    ...
    public String onTalk(L2Npc npc, L2PcInstance player) {
        ...
        switch (st.getState()) {
            case QuestState.STATE_CREATED:
                if (player.getRace() != PlayerRace.DarkElf) { htmltext = "30358-00.htm"; }
                else if (player.getLevel() < 10) { htmltext = "30358-02.htm"; }
                else { htmltext = "30358-03.htm"; }
                break;
            ...
            case QuestState.STATE_STARTED:
                ...
                switch (npc.getNpcId()) {
                    case THIFIELL:
                        if (cond == 1) { htmltext = "30358-06.htm"; }
                        else if (cond == 2) { htmltext = "30358-06.htm"; }
                        else if (cond == 3) { htmltext = "30358-06.htm"; }
                        else if (cond == 4) {
                            ...
                            if (player.isMageClass()) { st.giveItems(SPIRITSHOT_NO_GRADE, 500); }
                            else { st.giveItems(SOULSHOT_NO_GRADE, 1000); }
                    ...
                    case KARTIA:
                        ...
                        else if (cond == 2) { htmltext = "30133-02.htm"; }
                        else if (cond == 3) {
                        ...
                        else if (cond == 4) { htmltext = "30133-04.htm"; }
                        break;
                }
                break;
    ...
    public String onKill(L2Npc npc, L2PcInstance player, boolean isPet) {
        ...
        if (!st.hasQuestItems(ANCIENT_SCROLL)) { st.dropItems(ANCIENT_SCROLL, 1, 1, 200000); }
        else if (st.dropItems(ANCIENT_CLAY_TABLET, 1, 1, 200000)) { st.set("cond", "3"); }
