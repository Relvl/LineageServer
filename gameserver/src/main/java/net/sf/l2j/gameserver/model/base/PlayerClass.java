...
import static net.sf.l2j.gameserver.model.base.ClassLevel.*;
import static net.sf.l2j.gameserver.model.base.ClassType.*;
import static net.sf.l2j.gameserver.model.base.PlayerRace.*;
...
public enum PlayerClass {
    ...
    public final Set<PlayerClass> getAvailableSubclasses(L2PcInstance player) {
        ...
        if (_level == Third) {
            ...
            if (unavailableClasses != null) { subclasses.removeAll(unavailableClasses); }
        }
