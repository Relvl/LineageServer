...
public class Q352_HelpRoodRaiseANewPet extends Quest {
    ...
    public String onTalk(L2Npc npc, L2PcInstance player) {
        ...
        switch (st.getState()) {
            ...
            case QuestState.STATE_STARTED:
                ...
                if (eggs1 + eggs2 == 0) { htmltext = "31067-05.htm"; }
                else {
                    int reward = 2000;
                    if (eggs1 > 0 && eggs2 == 0) {
    ...
    public String onKill(L2Npc npc, L2PcInstance player, boolean isPet) {
        ...
        if (random < chance) { st.dropItemsAlways(LIENRIK_EGG_1, 1, 0); }
        else if (random < (chance + 4)) { st.dropItemsAlways(LIENRIK_EGG_2, 1, 0); }
