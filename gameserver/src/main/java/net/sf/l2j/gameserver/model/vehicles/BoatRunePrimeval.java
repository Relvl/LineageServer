...
public class BoatRunePrimeval implements Runnable {
    private static final Logger LOGGER = LoggerFactory.getLogger(BoatRunePrimeval.class);
    ...
    public BoatRunePrimeval(L2BoatInstance boat) {
        ...
        ARRIVED_AT_RUNE_2 = new CreatureSay(0, EChatType.BOAT, 801, SystemMessageId.FERRY_LEAVING_FOR_PRIMEVAL_3_MINUTES);
        LEAVING_RUNE = new CreatureSay(0, EChatType.BOAT, 801, SystemMessageId.FERRY_LEAVING_RUNE_FOR_PRIMEVAL_NOW);
        ARRIVED_AT_PRIMEVAL = new CreatureSay(0, EChatType.BOAT, 801, SystemMessageId.FERRY_ARRIVED_AT_PRIMEVAL);
        ARRIVED_AT_PRIMEVAL_2 = new CreatureSay(0, EChatType.BOAT, 801, SystemMessageId.FERRY_LEAVING_FOR_RUNE_3_MINUTES);
        LEAVING_PRIMEVAL = new CreatureSay(0, EChatType.BOAT, 801, SystemMessageId.FERRY_LEAVING_PRIMEVAL_FOR_RUNE_NOW);
        BUSY_RUNE = new CreatureSay(0, EChatType.BOAT, 801, SystemMessageId.FERRY_FROM_PRIMEVAL_TO_RUNE_DELAYED);
        ...
        PRIMEVAL_SOUND = new PlaySound(ESound.itemsound_ship_arrival_departure, _boat.getObjectId(), PRIMEVAL_DOCK.x, PRIMEVAL_DOCK.y, PRIMEVAL_DOCK.z);
    }

    public static void load() {
        L2BoatInstance boat = BoatManager.getInstance().getNewBoat(5, 34381, -37680, -3610, 40785);
        if (boat != null) {
