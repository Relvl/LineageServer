...
public class Q411_PathToAnAssassin extends Quest {
    ...
    public String onAdvEvent(String event, L2Npc npc, L2PcInstance player) {
        ...
        if (event.equalsIgnoreCase("30416-05.htm")) {
            if (player.getClassId() != ClassId.darkFighter) { htmltext = (player.getClassId() == ClassId.assassin) ? "30416-02a.htm" : "30416-02.htm"; }
            else if (player.getLevel() < 19) { htmltext = "30416-03.htm"; }
            else if (st.hasQuestItems(IRON_HEART)) { htmltext = "30416-04.htm"; }
            else {
    ...
    public String onTalk(L2Npc npc, L2PcInstance player) {
        ...
        switch (st.getState()) {
            ...
            case QuestState.STATE_STARTED:
                ...
                switch (npc.getNpcId()) {
                    case TRISKEL:
                        if (cond == 1) { htmltext = "30416-11.htm"; }
                        else if (cond == 2) { htmltext = "30416-07.htm"; }
                        else if (cond == 3 || cond == 4) { htmltext = "30416-08.htm"; }
                        else if (cond == 5) { htmltext = "30416-09.htm"; }
                        else if (cond == 6) { htmltext = "30416-10.htm"; }
                        else if (cond == 7) {
                    ...
                    case ARKENIA:
                        if (cond == 1) { htmltext = "30419-01.htm"; }
                        else if (cond == 2) { htmltext = "30419-07.htm"; }
                        else if (cond == 3 || cond == 4) { htmltext = "30419-10.htm"; }
                        else if (cond == 5) { htmltext = "30419-11.htm"; }
                        else if (cond == 6) {
                        ...
                        else if (cond == 7) { htmltext = "30419-09.htm"; }
                        break;

                    case LEIKAN:
                        if (cond == 2) { htmltext = "30382-01.htm"; }
                        else if (cond == 3) { htmltext = (!st.hasQuestItems(MOONSTONE_BEAST_MOLAR)) ? "30382-05.htm" : "30382-06.htm"; }
                        else if (cond == 4) {
                        ...
                        else if (cond == 5) { htmltext = "30382-09.htm"; }
                        else if (cond > 5) { htmltext = "30382-08.htm"; }
                        break;
                }
                break;
        }
    ...
    public String onKill(L2Npc npc, L2PcInstance player, boolean isPet) {
        ...
        if (npc.getNpcId() == 20369) {
            if (st.getInt("cond") == 3 && st.dropItemsAlways(MOONSTONE_BEAST_MOLAR, 1, 10)) { st.set("cond", "4"); }
        }
