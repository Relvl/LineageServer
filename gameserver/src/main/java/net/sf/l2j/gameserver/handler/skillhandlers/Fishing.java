...
public class Fishing implements ISkillHandler {
    ...
    public void useSkill(L2Character activeChar, L2Skill skill, L2Object[] targets) {
        ...
        if ((weaponItem == null || weaponItem.getItemType() != EWeaponType.FISHINGROD)) {
        ...
        for (L2ZoneType zone : ZoneManager.getZones(x, y)) {
            ...
            if (zone instanceof L2WaterZone) { water = (L2WaterZone) zone; }
        }
        ...
        if (aimingTo != null) {
            ...
            // geodata disabled
                ...
                if (water != null) { z = water.getWaterZ() + 10; }
                else { z = aimingTo.getWaterZ() + 10; }
                canFish = true;
            }
        }
