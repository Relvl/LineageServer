...
public class Q154_SacrificeToTheSea extends Quest {
    ...
    public String onTalk(L2Npc npc, L2PcInstance player) {
        ...
        switch (st.getState()) {
            ...
            case QuestState.STATE_STARTED:
                ...
                switch (npc.getNpcId()) {
                    case ROCKSWELL:
                        if (cond == 1) { htmltext = "30312-05.htm"; }
                        else if (cond == 2) { htmltext = "30312-08.htm"; }
                        else if (cond == 3) { htmltext = "30312-06.htm"; }
                        else if (cond == 4) {
                    ...
                    case CRISTEL:
                        if (cond == 1) { htmltext = (st.hasQuestItems(FOX_FUR)) ? "30051-01.htm" : "30051-01a.htm"; }
                        else if (cond == 2) {
                        ...
                        else if (cond == 3) { htmltext = "30051-03.htm"; }
                        else if (cond == 4) { htmltext = "30051-04.htm"; }
                        break;

                    case ROLFE:
                        if (cond < 3) { htmltext = "30055-03.htm"; }
                        else if (cond == 3) {
                        ...
                        else if (cond == 4) { htmltext = "30055-02.htm"; }
                        break;
                }
                break;
    ...
    public String onKill(L2Npc npc, L2PcInstance player, boolean isPet) {
        ...
        if (st.dropItems(FOX_FUR, 1, 10, 400000)) { st.set("cond", "2"); }
