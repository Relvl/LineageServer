...
public class Shutdown extends Thread {
    ...
    public Shutdown(int seconds, boolean restart) {
        ...
        if (restart) { _shutdownMode = GM_RESTART; }
    ...
    public void run() {
        if (this == SingletonHolder._instance) {
            ...
            if (SingletonHolder._instance._shutdownMode == GM_RESTART) { Runtime.getRuntime().halt(2); }
    ...
    public void startShutdown(L2PcInstance activeChar, String ghostEntity, int seconds, boolean restart) {
        ...
        if (_counterInstance != null) { _counterInstance._abort(); }
