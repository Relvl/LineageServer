...
public class Q426_QuestForFishingShot extends Quest {
    ...
    public Q426_QuestForFishingShot() {
        ...
        for (int mob : MOBS1.keySet()) { addKillId(mob); }
        for (int mob : MOBS2.keySet()) { addKillId(mob); }
        for (int mob : MOBS3.keySet()) { addKillId(mob); }
        for (int mob : MOBS4.keySet()) { addKillId(mob); }
        for (int mob : MOBS5.keySet()) { addKillId(mob); }
        for (int mob : MOBSspecial.keySet()) { addKillId(mob); }
    }
    ...
    public String onKill(L2Npc npc, L2PcInstance player, boolean isPet) {
        ...
        if (MOBS1.containsKey(npcId)) { chance = MOBS1.get(npcId); }
