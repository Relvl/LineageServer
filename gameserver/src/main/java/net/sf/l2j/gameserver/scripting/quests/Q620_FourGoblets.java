...
public class Q620_FourGoblets extends Quest {
    ...
    public Q620_FourGoblets() {
        ...
        for (int id = 18120; id <= 18256; id++) { addKillId(id); }
    }
    ...
    public String onAdvEvent(String event, L2Npc npc, L2PcInstance player) {
        ...
        if (event.equalsIgnoreCase("31452-05.htm")) {
            if (Rnd.nextBoolean()) { htmltext = (Rnd.nextBoolean()) ? "31452-03.htm" : "31452-04.htm"; }
        }
            ...
            else { htmltext = "31453-14.htm"; }
        }
        else if (event.equalsIgnoreCase("31453-13.htm")) {
            if (st.getInt("cond") == 2) { htmltext = "31453-19.htm"; }
        }
            ...
            if (st.hasQuestItems(SEALED_BOX)) {
                ...
                if (!calculateBoxReward(st)) { htmltext = (Rnd.nextBoolean()) ? "31454-09.htm" : "31454-10.htm"; }
                else { htmltext = "31454-08.htm"; }
            }
        }
        ...
        // Ghost Chamberlain of Elmoreden: Teleport to Imperial Tomb entrance
            ...
            if (st.hasQuestItems(SEALED_BOX)) {
                ...
                if (!calculateBoxReward(st)) { htmltext = (Rnd.nextBoolean()) ? "31919-04.htm" : "31919-05.htm"; }
                else { htmltext = "31919-03.htm"; }
            }
        }
    ...
    public String onTalk(L2Npc npc, L2PcInstance player) {
        ...
        if (id == QuestState.STATE_CREATED) { st.set("cond", "0"); }

        if (npcId == GHOST_OF_WIGOTH_1) {
            if (cond == 1) { htmltext = "31452-01.htm"; }
            else if (cond == 2) { htmltext = "31452-02.htm"; }
        }
        else if (npcId == NAMELESS_SPIRIT) {
            if (cond == 0) { htmltext = (player.getLevel() >= 74) ? "31453-01.htm" : "31453-12.htm"; }
            else if (cond == 1) { htmltext = (st.hasQuestItems(GOBLET_OF_ALECTIA, GOBLET_OF_TISHAS, GOBLET_OF_MEKARA, GOBLET_OF_MORIGUL)) ? "31453-15.htm" : "31453-14.htm"; }
            else if (cond == 2) { htmltext = "31453-17.htm"; }
        }
            ...
            if (st.hasQuestItems(GOBLET_OF_ALECTIA, GOBLET_OF_TISHAS, GOBLET_OF_MEKARA, GOBLET_OF_MORIGUL)) { index = 4; }

            boolean gotSealBoxes = st.hasQuestItems(SEALED_BOX);
            boolean gotEnoughRelics = st.getQuestItemsCount(RELIC) >= 1000;

            if (gotSealBoxes && gotEnoughRelics) { index += 3; }
            else if (!gotSealBoxes && gotEnoughRelics) { index += 2; }
            else if (gotSealBoxes) { index += 1; }

            htmltext = "31454-0" + index + ".htm";
        }
        else { htmltext = npcId + "-01.htm"; }
    ...
    private static boolean calculateBoxReward(QuestState st) {
        ...
        if (rnd == 0) {
            ...
            if (Rnd.get(1000) < 848) {
                ...
                else if (i < 184) { st.giveItems(1876, 4); }
                else if (i < 250) { st.giveItems(1881, 6); }
                else if (i < 287) { st.giveItems(5549, 8); }
                else if (i < 484) { st.giveItems(1874, 1); }
                else if (i < 681) { st.giveItems(1889, 1); }
                else if (i < 799) { st.giveItems(1877, 1); }
                else if (i < 902) { st.giveItems(1894, 1); }
                else { st.giveItems(4043, 1); }
            }
            ...
            if (Rnd.get(1000) < 323) {
                ...
                if (i < 335) { st.giveItems(1888, 1); }
                else if (i < 556) { st.giveItems(4040, 1); }
                else if (i < 725) { st.giveItems(1890, 1); }
                else if (i < 872) { st.giveItems(5550, 1); }
                else if (i < 962) { st.giveItems(1893, 1); }
                else if (i < 986) { st.giveItems(4046, 1); }
                else { st.giveItems(4048, 1); }
            }
        }
        else if (rnd == 2) {
            if (Rnd.get(1000) < 847) {
                ...
                if (i < 148) { st.giveItems(1878, 8); }
                else if (i < 175) { st.giveItems(1882, 24); }
                else if (i < 273) { st.giveItems(1879, 4); }
                else if (i < 322) { st.giveItems(1880, 6); }
                else if (i < 357) { st.giveItems(1885, 6); }
                else if (i < 554) { st.giveItems(1875, 1); }
                else if (i < 685) { st.giveItems(1883, 1); }
                else if (i < 803) { st.giveItems(5220, 1); }
                else if (i < 901) { st.giveItems(4039, 1); }
                else { st.giveItems(4044, 1); }
            }
            ...
            if (Rnd.get(1000) < 251) {
                ...
                if (i < 350) { st.giveItems(1887, 1); }
                else if (i < 587) { st.giveItems(4042, 1); }
                else if (i < 798) { st.giveItems(1886, 1); }
                else if (i < 922) { st.giveItems(4041, 1); }
                else if (i < 966) { st.giveItems(1892, 1); }
                else if (i < 996) { st.giveItems(1891, 1); }
                else { st.giveItems(4047, 1); }
            }
        }
        else if (rnd == 3) {
            if (Rnd.get(1000) < 31) {
                ...
                if (i < 223) { st.giveItems(730, 1); }
                else if (i < 893) { st.giveItems(948, 1); }
                else { st.giveItems(960, 1); }
            }
            ...
            if (Rnd.get(1000) < 5) {
                ...
                if (i < 202) { st.giveItems(729, 1); }
                else if (i < 928) { st.giveItems(947, 1); }
                else { st.giveItems(959, 1); }
            }
        }
        else if (rnd == 4) {
            if (Rnd.get(1000) < 329) {
                ...
                if (i < 88) { st.giveItems(6698, 1); }
                else if (i < 185) { st.giveItems(6699, 1); }
                else if (i < 238) { st.giveItems(6700, 1); }
                else if (i < 262) { st.giveItems(6701, 1); }
                else if (i < 292) { st.giveItems(6702, 1); }
                else if (i < 356) { st.giveItems(6703, 1); }
                else if (i < 420) { st.giveItems(6704, 1); }
                else if (i < 482) { st.giveItems(6705, 1); }
                else if (i < 554) { st.giveItems(6706, 1); }
                else if (i < 576) { st.giveItems(6707, 1); }
                else if (i < 640) { st.giveItems(6708, 1); }
                else if (i < 704) { st.giveItems(6709, 1); }
                else if (i < 777) { st.giveItems(6710, 1); }
                else if (i < 799) { st.giveItems(6711, 1); }
                else if (i < 863) { st.giveItems(6712, 1); }
                else if (i < 927) { st.giveItems(6713, 1); }
                else { st.giveItems(6714, 1); }
            }
            ...
            if (Rnd.get(1000) < 54) {
                ...
                if (i < 100) { st.giveItems(6688, 1); }
                else if (i < 198) { st.giveItems(6689, 1); }
                else if (i < 298) { st.giveItems(6690, 1); }
                else if (i < 398) { st.giveItems(6691, 1); }
                else if (i < 499) { st.giveItems(7579, 1); }
                else if (i < 601) { st.giveItems(6693, 1); }
                else if (i < 703) { st.giveItems(6694, 1); }
                else if (i < 801) { st.giveItems(6695, 1); }
                else if (i < 902) { st.giveItems(6696, 1); }
                else { st.giveItems(6697, 1); }
            }
        }
