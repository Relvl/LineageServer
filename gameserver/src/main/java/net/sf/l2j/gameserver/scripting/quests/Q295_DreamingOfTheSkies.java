...
public class Q295_DreamingOfTheSkies extends Quest {
    ...
    public String onTalk(L2Npc npc, L2PcInstance player) {
        ...
        switch (st.getState()) {
            ...
            case QuestState.STATE_STARTED:
                if (st.getInt("cond") == 1) { htmltext = "30536-04.htm"; }
                else {
                    ...
                    if (!st.hasQuestItems(RING_OF_FIREFLY)) {
                        ...
                        st.rewardItems(ItemConst.ADENA_ID, 2400);
                    }
    ...
    public String onKill(L2Npc npc, L2PcInstance player, boolean isPet) {
        ...
        if (st.dropItemsAlways(FLOATING_STONE, (Rnd.get(100) > 25) ? 1 : 2, 50)) { st.set("cond", "2"); }
