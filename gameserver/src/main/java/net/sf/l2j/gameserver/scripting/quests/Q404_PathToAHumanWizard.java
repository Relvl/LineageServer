    ...
    public String onTalk(L2Npc npc, L2PcInstance player) {
        ...
        switch (st.getState()) {
            case QuestState.STATE_CREATED:
                if (player.getClassId() != ClassId.mage) { htmltext = (player.getClassId() == ClassId.wizard) ? "30391-02a.htm" : "30391-01.htm"; }
                else if (player.getLevel() < 19) { htmltext = "30391-02.htm"; }
                else if (st.hasQuestItems(BEAD_OF_SEASON)) { htmltext = "30391-03.htm"; }
                else { htmltext = "30391-04.htm"; }
                break;

            case QuestState.STATE_STARTED:
                switch (npc.getNpcId()) {
                    case PARINA:
                        if (cond < 13) { htmltext = "30391-05.htm"; }
                        else if (cond == 13) {
                    ...
                    case FLAME_SALAMANDER:
                        ...
                        else if (cond == 2) { htmltext = "30411-02.htm"; }
                        else if (cond == 3) {
                        ...
                        else if (cond > 3) { htmltext = "30411-04.htm"; }
                        break;
                    ...
                    case WIND_SYLPH:
                        ...
                        else if (cond == 5) { htmltext = "30412-02.htm"; }
                        else if (cond == 6) {
                        ...
                        else if (cond > 6) { htmltext = "30412-04.htm"; }
                        break;

                    case WASTELAND_LIZARDMAN:
                        if (cond == 5) { htmltext = "30410-01.htm"; }
                        else if (cond > 5) { htmltext = "30410-04.htm"; }
                        break;
                    ...
                    case WATER_UNDINE:
                        ...
                        else if (cond == 8) { htmltext = "30413-02.htm"; }
                        else if (cond == 9) {
                        ...
                        else if (cond > 9) { htmltext = "30413-04.htm"; }
                        break;
                    ...
                    case EARTH_SNAKE:
                        ...
                        else if (cond == 11) { htmltext = "30409-02.htm"; }
                        else if (cond == 12) {
                        ...
                        else if (cond > 12) { htmltext = "30409-04.htm"; }
                        break;
                }
                break;
        }
    ...
    public String onKill(L2Npc npc, L2PcInstance player, boolean isPet) {
        ...
        switch (npc.getNpcId()) {
            case 20359: // Ratman Warrior
                if (st.getInt("cond") == 2 && st.dropItems(KEY_OF_FLAME, 1, 1, 800000)) { st.set("cond", "3"); }
                break;

            case 27030: // Water Seer
                if (st.getInt("cond") == 8 && st.dropItems(SPARKLE_PEBBLE, 1, 2, 800000)) { st.set("cond", "9"); }
                break;

            case 20021: // Red Bear
                if (st.getInt("cond") == 11 && st.dropItems(RED_SOIL, 1, 1, 200000)) { st.set("cond", "12"); }
                break;
        }
