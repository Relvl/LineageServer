...
public class L2MonsterInstance extends L2Attackable {
    ...
    public void onSpawn() {
        if (!isTeleporting()) {
            ...
            else if (_minionList != null) { getMinionList().deleteSpawnedMinions(); }
    ...
    public void onTeleported() {
        ...
        if (_minionList != null) { getMinionList().onMasterTeleported(); }
    }
    ...
    protected void startMaintenanceTask() {
        if (!getTemplate().getMinionData().isEmpty()) { getMinionList().spawnMinions(); }
    }
    ...
    public boolean doDie(L2Character killer) {
        ...
        if (_master != null) { _master.getMinionList().onMinionDie(this, _master.getSpawn().getRespawnDelay() / 2); }
    ...
    public void deleteMe() {
        if (_minionList != null) { getMinionList().onMasterDie(true); }
        else if (_master != null) { _master.getMinionList().onMinionDie(this, 0); }
    ...
    public MinionList getMinionList() {
        if (_minionList == null) { _minionList = new MinionList(this); }
