    ...
    public String onTalk(L2Npc npc, L2PcInstance player) {
        ...
        switch (st.getState()) {
            ...
            case QuestState.STATE_STARTED:
                ...
                switch (npc.getNpcId()) {
                    case BARBADO:
                        if (cond == 1 || cond == 2) { htmltext = "30959-03.htm"; }
                        else if (cond == 3) {
                    ...
                    case SWAN:
                        if (cond == 1) { htmltext = "30957-01.htm"; }
                        else if (cond == 2) {
                            if (stolenItems > 0) {
                                st.set("cond", "3");
                                st.playSound(ESound.ItemSound_quest_middle);
                                ...
                                if (stolenItems == 2) {
                                    ...
                                    st.rewardItems(ItemConst.ADENA_ID, 100);
                                }
                                else { htmltext = "30957-05.htm"; }
                            }
                            else {
                                ...
                                else { htmltext = "30957-03.htm"; }
                            }
                        }
                        else if (cond == 3) { htmltext = "30957-07.htm"; }
                        break;

                    case BEER_CHEST:
                        htmltext = "30960-03.htm";
                        if (cond == 2 && st.hasQuestItems(KEY_2)) { htmltext = "30960-01.htm"; }
                        break;

                    case CLOTH_CHEST:
                        htmltext = "30961-03.htm";
                        if (cond == 2 && st.hasQuestItems(KEY_1)) { htmltext = "30961-01.htm"; }
                        break;
