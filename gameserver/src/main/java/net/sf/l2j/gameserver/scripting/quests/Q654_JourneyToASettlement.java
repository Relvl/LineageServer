...
public class Q654_JourneyToASettlement extends Quest {
    ...
    public String onTalk(L2Npc npc, L2PcInstance player) {
        ...
        switch (st.getState()) {
            ...
            case QuestState.STATE_STARTED:
                ...
                if (cond == 1) { htmltext = "31453-02.htm"; }
                else if (cond == 2) { htmltext = "31453-04.htm"; }
                else if (cond == 3) { htmltext = "31453-05.htm"; }
                break;
        }
    ...
    public String onKill(L2Npc npc, L2PcInstance player, boolean isPet) {
        ...
        if (st.dropItems(ANTELOPE_SKIN, 1, 1, 50000)) { st.set("cond", "3"); }
