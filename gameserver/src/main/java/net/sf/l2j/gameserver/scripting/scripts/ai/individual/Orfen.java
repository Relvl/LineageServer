...
public class Orfen extends AbstractNpcAI {
    ...
    private static final HeadedLocation[] ORFEN_LOCATION =
            {
                    new HeadedLocation(43728, 17220, -4342, 0),
                    new HeadedLocation(55024, 17368, -5412, 0),
                    new HeadedLocation(53504, 21248, -5486, 0),
                    new HeadedLocation(53248, 24576, -5262, 0)
            };
    ...
    public String onAdvEvent(String event, L2Npc npc, L2PcInstance player) {
        if (event.equalsIgnoreCase("orfen_unlock")) {
            ...
            if (_lastAttackTime + 1800000 < System.currentTimeMillis()) {
                ...
                while (index == _currentIndex) { index = Rnd.get(1, 3); }
    ...
    public String onFactionCall(L2Npc npc, L2Npc caller, L2PcInstance attacker, boolean isPet) {
        if (caller == null || npc == null || npc.isCastingNow()) { return super.onFactionCall(npc, caller, attacker, isPet); }
     ...
     */
    private static void goTo(L2Npc npc, HeadedLocation index) {
        ...
        else { npc.getAI().setIntention(EIntention.MOVE_TO, index); }
    }
