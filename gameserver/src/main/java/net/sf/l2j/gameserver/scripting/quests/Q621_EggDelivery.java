    ...
    public String onTalk(L2Npc npc, L2PcInstance player) {
        ...
        switch (st.getState()) {
            ...
            case QuestState.STATE_STARTED:
                ...
                switch (npc.getNpcId()) {
                    case JEREMY:
                        if (cond == 1) { htmltext = "31521-04.htm"; }
                        else if (cond == 6) { htmltext = "31521-05.htm"; }
                        else if (cond == 7) { htmltext = "31521-07.htm"; }
                        break;

                    case PULIN:
                        if (cond == 1 && st.getQuestItemsCount(BOILED_EGGS) == 5) { htmltext = "31543-01.htm"; }
                        else if (cond > 1) { htmltext = "31543-03.htm"; }
                        break;

                    case NAFF:
                        if (cond == 2 && st.getQuestItemsCount(BOILED_EGGS) == 4) { htmltext = "31544-01.htm"; }
                        else if (cond > 2) { htmltext = "31544-03.htm"; }
                        break;

                    case CROCUS:
                        if (cond == 3 && st.getQuestItemsCount(BOILED_EGGS) == 3) { htmltext = "31545-01.htm"; }
                        else if (cond > 3) { htmltext = "31545-03.htm"; }
                        break;

                    case KUBER:
                        if (cond == 4 && st.getQuestItemsCount(BOILED_EGGS) == 2) { htmltext = "31546-01.htm"; }
                        else if (cond > 4) { htmltext = "31546-03.htm"; }
                        break;

                    case BEOLIN:
                        if (cond == 5 && st.getQuestItemsCount(BOILED_EGGS) == 1) { htmltext = "31547-01.htm"; }
                        else if (cond > 5) { htmltext = "31547-03.htm"; }
                        break;

                    case VALENTINE:
                        if (cond == 7) { htmltext = "31584-01.htm"; }
                        break;
                }
                break;
        }
