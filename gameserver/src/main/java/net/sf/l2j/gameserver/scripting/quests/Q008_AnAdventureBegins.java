    ...
    public String onTalk(L2Npc npc, L2PcInstance player) {
        ...
        switch (st.getState()) {
            case QuestState.STATE_CREATED:
                if (player.getLevel() >= 3 && player.getRace() == PlayerRace.DarkElf) { htmltext = "30134-02.htm"; }
                else { htmltext = "30134-01.htm"; }
                break;
            ...
            case QuestState.STATE_STARTED:
                ...
                switch (npc.getNpcId()) {
                    case JASMINE:
                        if (cond == 1 || cond == 2) { htmltext = "30134-04.htm"; }
                        else if (cond == 3) { htmltext = "30134-05.htm"; }
                        break;

                    case ROSELYN:
                        if (cond == 1) { htmltext = "30355-01.htm"; }
                        else if (cond == 2) { htmltext = "30355-03.htm"; }
                        break;

                    case HARNE:
                        if (cond == 2) { htmltext = "30144-01.htm"; }
                        else if (cond == 3) { htmltext = "30144-03.htm"; }
                        break;
                }
                break;
