...
public class Q662_AGameOfCards extends Quest {
    ...
    public Q662_AGameOfCards() {
        ...
        for (int monster : CHANCES.keySet()) { addKillId(monster); }
    }
    ...
    public String onAdvEvent(String event, L2Npc npc, L2PcInstance player) {
        ...
        if (event.equalsIgnoreCase("30845-03.htm")) {
            ...
            if (state == 0 && stateEx == 0 && st.getQuestItemsCount(RED_GEM) >= 50) { htmltext = "30845-05.htm"; }
        }
            ...
            if (state == 0 && stateEx == 0 && st.getQuestItemsCount(RED_GEM) >= 50) {
                ...
                if (i1 >= 57) { i1 = i1 - 56; }
                else if (i1 >= 43) { i1 = i1 - 42; }
                else if (i1 >= 29) { i1 = i1 - 28; }
                else if (i1 >= 15) { i1 = i1 - 14; }

                if (i2 >= 57) { i2 = i2 - 56; }
                else if (i2 >= 43) { i2 = i2 - 42; }
                else if (i2 >= 29) { i2 = i2 - 28; }
                else if (i2 >= 15) { i2 = i2 - 14; }

                if (i3 >= 57) { i3 = i3 - 56; }
                else if (i3 >= 43) { i3 = i3 - 42; }
                else if (i3 >= 29) { i3 = i3 - 28; }
                else if (i3 >= 15) { i3 = i3 - 14; }

                if (i4 >= 57) { i4 = i4 - 56; }
                else if (i4 >= 43) { i4 = i4 - 42; }
                else if (i4 >= 29) { i4 = i4 - 28; }
                else if (i4 >= 15) { i4 = i4 - 14; }

                if (i5 >= 57) { i5 = i5 - 56; }
                else if (i5 >= 43) { i5 = i5 - 42; }
                else if (i5 >= 29) { i5 = i5 - 28; }
                else if (i5 >= 15) { i5 = i5 - 14; }
        ...
        else if (event.equals("First") || event.equals("Second") || event.equals("Third") || event.equals("Fourth") || event.equals("Fifth")) // reply 11 12 13 14 15
        {
            ...
            if (i9 % 32 < 31) {
                ...
                else if (i6 == 0) { htmltext = getHtmlText("30845-19.htm"); }
        ...
        {
            if (st.getQuestItemsCount(RED_GEM) < 50) { htmltext = "30845-21.htm"; }
        }
    ...
    public String onTalk(L2Npc npc, L2PcInstance player) {
        ...
        switch (st.getState()) {
            ...
            case QuestState.STATE_STARTED:
                ...
                if (state == 0 && stateEx == 0) { htmltext = (st.getQuestItemsCount(RED_GEM) < 50) ? "30845-04.htm" : "30845-05.htm"; }
