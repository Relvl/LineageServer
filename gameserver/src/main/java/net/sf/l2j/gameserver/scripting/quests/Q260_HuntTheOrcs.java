    ...
    public String onTalk(L2Npc npc, L2PcInstance player) {
        ...
        switch (st.getState()) {
            case QuestState.STATE_CREATED:
                if (player.getRace() != PlayerRace.Elf) { htmltext = "30221-00.htm"; }
                else if (player.getLevel() < 6) { htmltext = "30221-01.htm"; }
                else { htmltext = "30221-02.htm"; }
                break;
            ...
            case QuestState.STATE_STARTED:
                ...
                if (amulet == 0 && necklace == 0) { htmltext = "30221-04.htm"; }
                else {
