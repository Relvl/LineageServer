    ...
    public String onTalk(L2Npc npc, L2PcInstance player) {
        ...
        switch (st.getState()) {
            case QuestState.STATE_CREATED:
                if (player.getLevel() >= 3 && player.getRace() == PlayerRace.Dwarf) { htmltext = "30533-01.htm"; }
                else { htmltext = "30533-01a.htm"; }
                break;
            ...
            case QuestState.STATE_STARTED:
                ...
                switch (npc.getNpcId()) {
                    case BALANKI:
                        if (cond < 4) { htmltext = "30533-03.htm"; }
                    ...
                    case GERALD:
                        ...
                        else if (cond > 2) { htmltext = "30650-04.htm"; }
                        break;
                }
                break;
