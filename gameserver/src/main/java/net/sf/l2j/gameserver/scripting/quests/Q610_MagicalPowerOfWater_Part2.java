...
public class Q610_MagicalPowerOfWater_Part2 extends Quest {
    ...
    public Q610_MagicalPowerOfWater_Part2() {
        ...
        switch (RaidBossSpawnManager.getInstance().getRaidBossStatusId(SOUL_OF_WATER_ASHUTAR)) {
            case UNDEFINED:
                LOGGER.warn(qn + ": can not find spawned L2RaidBoss id=" + SOUL_OF_WATER_ASHUTAR);
                break;
    ...
    public String onAdvEvent(String event, L2Npc npc, L2PcInstance player) {
        ...
        // Varka's Holy Altar
            ...
            if (st.hasQuestItems(GREEN_TOTEM)) {
                ...
                else { htmltext = "31560-04.htm"; }
            }
            else { htmltext = "31560-03.htm"; }
        }
            ...
            case QuestState.STATE_STARTED:
                ...
                switch (npc.getNpcId()) {
                    ...
                    case VARKAS_HOLY_ALTAR:
                        if (cond == 1) { htmltext = "31560-01.htm"; }
                        else if (cond == 2) { htmltext = "31560-05.htm"; }
                        break;
                }
                break;
        }
    ...
    private void spawnNpc() {
        ...
        if (_npc == null) { _npc = addSpawn(VARKAS_HOLY_ALTAR, 105452, -36775, -1050, 34000, false, 0, false); }
    }
    ...
    private static void despawnRaid(L2Npc raid) {
        ...
        if (!raid.isDead()) { raid.teleToLocation(-105900, -252700, -15542, 0); }
