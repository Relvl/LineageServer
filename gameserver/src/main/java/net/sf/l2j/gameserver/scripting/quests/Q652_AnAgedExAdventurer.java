...
public class Q652_AnAgedExAdventurer extends Quest {
    ...
    private static final HeadedLocation[] SPAWNS =
            {
                    new HeadedLocation(78355, -1325, -3659, 0),
                    new HeadedLocation(79890, -6132, -2922, 0),
                    new HeadedLocation(90012, -7217, -3085, 0),
                    new HeadedLocation(94500, -10129, -3290, 0),
                    new HeadedLocation(96534, -1237, -3677, 0)
            };
    ...
    public String onAdvEvent(String event, L2Npc npc, L2PcInstance player) {
        ...
        if (event.equalsIgnoreCase("32012-02.htm")) {
            ...
            while (chance == _currentPosition) { chance = Rnd.get(5); }
