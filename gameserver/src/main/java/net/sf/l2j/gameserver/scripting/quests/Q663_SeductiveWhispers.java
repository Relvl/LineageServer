        ...
        if (event.equalsIgnoreCase("30846-03.htm")) {
            ...
            if (param1 == i2) {
                ...
                if (i3 % 5 == 0 && i3 != 10) {
                    if ((state % 100) / 10 >= 7) {
                        st.set("state", "4");
                        st.rewardItems(ItemConst.ADENA_ID, 2384000);
            ...
            if (round == 0) { st.rewardItems(ItemConst.ADENA_ID, 40000); }
            else if (round == 1) { st.rewardItems(ItemConst.ADENA_ID, 80000); }
            else if (round == 2) {
                st.rewardItems(ItemConst.ADENA_ID, 110000);
                st.rewardItems(ENCHANT_WEAPON_D, 1);
            }
            else if (round == 3) {
                st.rewardItems(ItemConst.ADENA_ID, 199000);
                st.rewardItems(ENCHANT_WEAPON_C, 1);
            }
            else if (round == 4) {
                st.rewardItems(ItemConst.ADENA_ID, 388000);
                st.rewardItems(RECIPES[Rnd.get(RECIPES.length)], 1);
            }
            else if (round == 5) {
                st.rewardItems(ItemConst.ADENA_ID, 675000);
                st.rewardItems(BLADES[Rnd.get(BLADES.length)], 1);
            }
            else if (round == 6) {
                st.rewardItems(ItemConst.ADENA_ID, 1284000);
            ...
            if (param1 == i2) {
                ...
                if (i3 % 5 == 0 && i3 != 10) {
                    st.set("state", "1");
                    st.set("stateEx", "0");
                    st.rewardItems(ItemConst.ADENA_ID, 800);
    ...
    public String onTalk(L2Npc npc, L2PcInstance player) {
        ...
        switch (st.getState()) {
            ...
            case QuestState.STATE_STARTED:
                ...
                if (state < 4) {
                    if (st.hasQuestItems(SPIRIT_BEAD)) { htmltext = "30846-05.htm"; }
                    else { htmltext = "30846-04.htm"; }
                }
                else if ((state % 10) == 4) { htmltext = "30846-05a.htm"; }
                else if ((state % 10) == 5) { htmltext = "30846-11.htm"; }
                else if ((state % 10) == 6) { htmltext = "30846-15.htm"; }
                else if ((state % 10) == 7) {
                    ...
                    else { htmltext = getHtmlText("30846-16.htm").replace("%wincount%", String.valueOf((state / 10) + 1)); }
                }
                else if (state == 1005) { htmltext = "30846-23.htm"; }
                else if (state == 1006) { htmltext = "30846-26.htm"; }
