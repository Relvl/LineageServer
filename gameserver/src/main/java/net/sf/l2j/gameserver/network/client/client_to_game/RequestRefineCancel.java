...
import net.sf.l2j.gameserver.network.client.game_to_client.ExVariationCancelResult;
...
public final class RequestRefineCancel extends L2GameClientPacket {
    ...
    protected void runImpl() {
        ...
        switch (targetItem.getItem().getCrystalType()) {
            case C:
                if (targetItem.getCrystalCount() < 1720) { price = 95000; }
                else if (targetItem.getCrystalCount() < 2452) { price = 150000; }
                else { price = 210000; }
                break;

            case B:
                if (targetItem.getCrystalCount() < 1746) { price = 240000; }
                else { price = 270000; }
                break;

            case A:
                if (targetItem.getCrystalCount() < 2160) { price = 330000; }
                else if (targetItem.getCrystalCount() < 2824) { price = 390000; }
                else { price = 420000; }
                break;
