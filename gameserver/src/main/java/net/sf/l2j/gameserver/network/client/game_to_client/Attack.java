...
public class Attack extends L2GameServerPacket {
    ...
    public class Hit {
        ...
        Hit(L2Object target, int damage, boolean miss, boolean crit, byte shld) {
            ...
            if (soulshot) { _flags = HITFLAG_USESS | _ssGrade; }

            if (crit) { _flags |= HITFLAG_CRIT; }

            if (shld > 0 && !(target instanceof L2PcInstance && ((L2PcInstance) target).isInOlympiadMode())) { _flags |= HITFLAG_SHLD; }
        }
    }
