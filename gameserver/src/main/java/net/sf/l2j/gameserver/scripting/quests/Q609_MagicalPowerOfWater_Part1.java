...
public class Q609_MagicalPowerOfWater_Part1 extends Quest {
    ...
    public String onAdvEvent(String event, L2Npc npc, L2PcInstance player) {
        ...
        if (event.equalsIgnoreCase("31371-03.htm")) {
            ...
            if (st.getInt("spawned") == 1) { htmltext = "31561-04.htm"; }
            // No Thief's Key in inventory.
            else if (!st.hasQuestItems(THIEF_KEY)) { htmltext = "31561-02.htm"; }
            else {
                st.set("cond", "3");
                ...
                switch (npc.getNpcId()) {
                    ...
                    case ASEFA:
                        if (cond == 1) {
                            ...
                            if (st.getInt("spawned") == 0) { htmltext = "31372-02.htm"; }
                            else {
                    ...
                    case UDAN_BOX:
                        if (cond == 2) { htmltext = "31561-01.htm"; }
                        else if (cond == 3) { htmltext = "31561-05.htm"; }
                        break;
                }
                break;
        }
