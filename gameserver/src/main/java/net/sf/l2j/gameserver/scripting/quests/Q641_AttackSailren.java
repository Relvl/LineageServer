...
public final class Q641_AttackSailren extends Quest {
    ...
    public String onTalk(L2Npc npc, L2PcInstance player) {
        ...
        switch (st.getState()) {
            case QuestState.STATE_CREATED:
                if (player.getLevel() < 77) { htmltext = "32109-3.htm"; }
                else {
            ...
            case QuestState.STATE_STARTED:
                ...
                if (cond == 1) { htmltext = "32109-5.htm"; }
                else if (cond == 2) { htmltext = "32109-7.htm"; }
                break;
        }
    ...
    public String onKill(L2Npc npc, L2PcInstance player, boolean isPet) {
        ...
        if (st.dropItems(GAZKH_FRAGMENT, 1, 30, 50000)) { st.set("cond", "2"); }
