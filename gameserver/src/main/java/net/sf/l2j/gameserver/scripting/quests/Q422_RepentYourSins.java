...
public class Q422_RepentYourSins extends Quest {
    ...
    public String onAdvEvent(String event, L2Npc npc, L2PcInstance player) {
        ...
        if (event.equalsIgnoreCase("Start")) {
            ...
            if (pet != null && pet.getNpcId() == 12564) { htmltext = "30981-16.htm"; }
    ...
    public String onTalk(L2Npc npc, L2PcInstance player) {
        ...
        switch (st.getState()) {
            case QuestState.STATE_CREATED:
                if (player.getPkKills() >= 1) { htmltext = (st.hasQuestItems(LEFT_PENITENT_MANACLES)) ? "30981-18.htm" : "30981-02.htm"; }
                else { htmltext = "30981-01.htm"; }
                break;
            ...
            case QuestState.STATE_STARTED:
                ...
                switch (npc.getNpcId()) {
                    case BLACK_JUDGE:
                        if (cond <= 9) { htmltext = "30981-07.htm"; }
                        ...
                        else if (cond == 14) { htmltext = "30981-09.htm"; }
                        else if (cond == 15) { htmltext = "30981-10.htm"; }
                        else if (cond == 16) {
                            if (st.hasQuestItems(PENITENT_MANACLES)) { htmltext = (findSinEaterLvl(player) > st.getInt("level")) ? "30981-13.htm" : "30981-12.htm"; }
                            else { htmltext = "30981-18.htm"; }
                        }
                        break;
                    ...
                    case KATARI:
                        if (cond == 2) {
                            ...
                            if (st.getQuestItemsCount(RATMAN_SCAVENGER_SKULL) < 10) { htmltext = "30668-02.htm"; }
                            else {
                        ...
                        else if (cond == 10) { htmltext = "30668-04.htm"; }
                        break;
                    ...
                    case PIOTUR:
                        if (cond == 3) {
                            ...
                            if (st.getQuestItemsCount(TUREK_WAR_HOUND_TAIL) < 10) { htmltext = "30597-02.htm"; }
                            else {
                        ...
                        else if (cond == 11) { htmltext = "30597-04.htm"; }
                        break;
                    ...
                    case CASIAN:
                        if (cond == 4) {
                            ...
                            if (!st.hasQuestItems(TYRANT_KINGPIN_HEART)) { htmltext = "30612-02.htm"; }
                            else {
                        ...
                        else if (cond == 12) { htmltext = "30612-04.htm"; }
                        break;
                    ...
                    case JOAN:
                        if (cond == 5) {
                            ...
                            if (st.getQuestItemsCount(TRISALIM_TARANTULA_VENOM_SAC) < 3) { htmltext = "30718-02.htm"; }
                            else {
                        ...
                        else if (cond == 13) { htmltext = "30718-04.htm"; }
                        break;
                    ...
                    case PUSHKIN:
                        ...
                        else if (st.hasAtLeastOneQuestItem(QITEM_PENITENT_MANACLES, PENITENT_MANACLES, LEFT_PENITENT_MANACLES)) { htmltext = "30300-03.htm"; }
                        break;
                }
                break;
        }
    ...
    public String onKill(L2Npc npc, L2PcInstance player, boolean isPet) {
        ...
        switch (npc.getNpcId()) {
            case 20039:
                if (st.getInt("cond") == 6) { st.dropItemsAlways(RATMAN_SCAVENGER_SKULL, 1, 10); }
                break;

            case 20494:
                if (st.getInt("cond") == 7) { st.dropItemsAlways(TUREK_WAR_HOUND_TAIL, 1, 10); }
                break;

            case 20193:
                if (st.getInt("cond") == 8) { st.dropItemsAlways(TYRANT_KINGPIN_HEART, 1, 1); }
                break;

            case 20561:
                if (st.getInt("cond") == 9) { st.dropItemsAlways(TRISALIM_TARANTULA_VENOM_SAC, 1, 3); }
                break;
        }
