...
public class Q039_RedEyedInvaders extends Quest {
        ...
        switch (st.getState()) {
            ...
            case QuestState.STATE_STARTED:
                ...
                switch (npc.getNpcId()) {
                    ...
                    case BATHIS:
                        if (cond == 1) { htmltext = "30332-0.htm"; }
                        else if (cond == 2) { htmltext = "30332-2a.htm"; }
                        else if (cond == 3) { htmltext = "30332-2.htm"; }
                        else if (cond == 4) { htmltext = "30332-3a.htm"; }
                        else if (cond == 5) { htmltext = "30332-4.htm"; }
                        break;
                }
                break;
    ...
    public String onKill(L2Npc npc, L2PcInstance player, boolean isPet) {
        ...
        if (partyMember != null && npcId != ARANEID) {
            ...
            if (st.dropItems(list[0], 1, 100, 500000) && st.getQuestItemsCount(list[1]) == 100) { st.set("cond", "3"); }
        }
        else {
            ...
            if (partyMember != null && npcId != MAILLE_LIZARDMAN) {
                ...
                if (st.dropItems(list[0], 1, 30, list[2]) && st.getQuestItemsCount(list[1]) == 30) { st.set("cond", "5"); }
            }
        }
