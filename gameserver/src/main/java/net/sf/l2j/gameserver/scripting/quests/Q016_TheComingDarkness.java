                ...
                switch (npcId) {
                    case HIERARCH:
                        if (cond == 6) {
                            ...
                            if (st.hasQuestItems(CRYSTAL_OF_SEAL)) { htmltext = "31517-3.htm"; }
                            else {
                    ...
                    case EVIL_ALTAR_4:
                    case EVIL_ALTAR_5:
                        int condAltar = npcId - 31511;

                        if (cond == condAltar) {
                            if (st.hasQuestItems(CRYSTAL_OF_SEAL)) { htmltext = npcId + "-0.htm"; }
                            else { htmltext = "altar_nocrystal.htm"; }
                        }
                        else if (cond > condAltar) { htmltext = npcId + "-2.htm"; }
                        break;
                }
                break;
