    ...
    protected void runImpl() {
        ...
        if (_response == 1) {
            ...
            if (_partyDuel == 1) {
                ...
                if (requestorChannel != null) { requestorChannel.removeParty(requestorParty); }
            ...
            if (_partyDuel == 1) { requestor.sendPacket(SystemMessageId.THE_OPPOSING_PARTY_HAS_DECLINED_YOUR_CHALLENGE_TO_A_DUEL); }
            else { requestor.sendPacket(SystemMessage.getSystemMessage(SystemMessageId.S1_HAS_DECLINED_YOUR_CHALLENGE_TO_A_DUEL).addPcName(activeChar)); }
        }
