...
public class Q618_IntoTheFlame extends Quest {
        ...
        switch (st.getState()) {
            ...
            case QuestState.STATE_STARTED:
                ...
                switch (npc.getNpcId()) {
                    ...
                    case HILDA:
                        if (cond == 1) { htmltext = "31271-01.htm"; }
                        else if (cond == 2) { htmltext = "31271-03.htm"; }
                        else if (cond == 3) { htmltext = "31271-04.htm"; }
                        else if (cond == 4) { htmltext = "31271-06.htm"; }
                        break;
                }
                break;
        }
    ...
    public String onKill(L2Npc npc, L2PcInstance player, boolean isPet) {
        ...
        if (st.dropItems(VACUALITE_ORE, 1, 50, 500000)) { st.set("cond", "3"); }
