    ...
    public String onTalk(L2Npc npc, L2PcInstance player) {
        ...
        switch (st.getState()) {
            case QuestState.STATE_CREATED:
                if (!player.isClanLeader()) { htmltext = "31331-0a.htm"; }
                else if (clan.getLevel() < 6) { htmltext = "31331-0b.htm"; }
                else { htmltext = "31331-0c.htm"; }
                break;
            ...
            case QuestState.STATE_STARTED:
                ...
                if (!st.hasQuestItems(item)) { htmltext = "31331-" + raid + "a.htm"; }
                else {
