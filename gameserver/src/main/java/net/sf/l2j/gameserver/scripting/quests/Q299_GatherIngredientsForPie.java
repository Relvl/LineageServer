...
public class Q299_GatherIngredientsForPie extends Quest {
                ...
                switch (npc.getNpcId()) {
                    case EMILY:
                        if (cond == 1) { htmltext = "30620-1a.htm"; }
                            ...
                            if (st.hasQuestItems(AVELLAN_SPICE)) { htmltext = "30620-4.htm"; }
                            else {
                    ...
                    case LARA:
                        ...
                        else if (cond > 3) { htmltext = "30063-1a.htm"; }
                        break;

                    case BRIGHT:
                        if (cond == 5) { htmltext = "30466-0.htm"; }
                        else if (cond > 5) { htmltext = "30466-1a.htm"; }
                        break;
                }
                break;
        }
    ...
    public String onKill(L2Npc npc, L2PcInstance player, boolean isPet) {
        ...
        if (st.dropItems(HONEY_POUCH, 1, 100, (npc.getNpcId() == 20934) ? 571000 : 625000)) { st.set("cond", "2"); }
