...
import net.sf.l2j.gameserver.network.client.game_to_client.ExDuelAskStart;
    ...
    protected void runImpl() {
        ...
        if (_partyDuel == 1) {
            ...
            if (!partyLeader.isProcessingRequest()) {
                ...
                if (activeCharChannel != null) { activeCharChannel.removeParty(activeCharParty); }

                final L2CommandChannel targetCharChannel = targetCharParty.getCommandChannel();
                if (targetCharChannel != null) { targetCharChannel.removeParty(targetCharParty); }
            ...
            else { activeChar.sendPacket(SystemMessage.getSystemMessage(SystemMessageId.S1_IS_BUSY_TRY_LATER).addPcName(partyLeader)); }
        }
        // 1vs1 duel.
        else {
            ...
            else { activeChar.sendPacket(SystemMessage.getSystemMessage(SystemMessageId.S1_IS_BUSY_TRY_LATER).addPcName(targetChar)); }
        }
    }
}