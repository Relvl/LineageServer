    ...
    public String onTalk(L2Npc npc, L2PcInstance player) {
        ...
        switch (st.getState()) {
            case QuestState.STATE_CREATED:
                if (player.getRace() != PlayerRace.Dwarf) { htmltext = "30523-00.htm"; }
                else if (player.getLevel() < 10) { htmltext = "30523-01.htm"; }
                else { htmltext = "30523-02.htm"; }
                break;
            ...
            case QuestState.STATE_STARTED:
                ...
                switch (npc.getNpcId()) {
                    case GOUPH:
                        if (cond == 1) { htmltext = "30523-04.htm"; }
                        else if (cond > 1 && cond < 7) { htmltext = "30523-05.htm"; }
                        else if (cond == 7) {
                        ...
                        else if (cond > 7 && cond < 12) { htmltext = "30523-07.htm"; }
                        else if (cond == 12) {
                    ...
                    case REEP:
                        ...
                        else if (cond > 1) { htmltext = "30516-02.htm"; }
                        break;

                    case TOROCCO:
                        if (cond == 2) { htmltext = "30555-01.htm"; }
                        else if (cond == 3) { htmltext = "30555-03.htm"; }
                        else if (cond == 7) { htmltext = "30555-04.htm"; }
                        else if (cond > 7) { htmltext = "30555-05.htm"; }
                        break;
                    ...
                    case MARON:
                        ...
                        else if (cond == 4) { htmltext = "30529-02.htm"; }
                        else if (cond > 4) { htmltext = "30529-03.htm"; }
                        break;

                    case BRUNON:
                        if (cond == 4) { htmltext = "30526-01.htm"; }
                        else if (cond == 5) { htmltext = "30526-03.htm"; }
                        else if (cond == 6) {
                        ...
                        else if (cond == 7) { htmltext = "30526-05.htm"; }
                        else if (cond == 8) {
                        ...
                        else if (cond == 9) { htmltext = "30526-07.htm"; }
                        else if (cond > 9) { htmltext = "30526-08.htm"; }
                        break;
                    ...
                    case MURDOC:
                        ...
                        else if (cond == 10) { htmltext = "30521-02.htm"; }
                        else if (cond > 10) { htmltext = "30521-03.htm"; }
                        break;
                    ...
                    case AIRY:
                        ...
                        else if (cond == 11) { htmltext = (Rnd.nextBoolean()) ? "30522-02.htm" : "30522-04.htm"; }
                        else if (cond == 12) { htmltext = "30522-03.htm"; }
                        break;
                }
                break;
    ...
    public String onKill(L2Npc npc, L2PcInstance player, boolean isPet) {
        ...
        switch (npc.getNpcId()) {
            case GOBLIN_BRIGAND_LEADER:
                if (st.getInt("cond") == 5 && st.dropMultipleItems(LEADER_DROPLIST)) { st.set("cond", "6"); }
                break;

            case GOBLIN_BRIGAND_LIEUTENANT:
                if (st.getInt("cond") == 5 && st.dropMultipleItems(LIEUTENANT_DROPLIST)) { st.set("cond", "6"); }
                break;
