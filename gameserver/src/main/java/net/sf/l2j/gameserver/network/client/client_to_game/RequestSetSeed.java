...
public class RequestSetSeed extends L2GameClientPacket {
    ...
    protected void readImpl() {
        _manorId = readD();
        _size = readD();
        if (_size * 12 > buffer.remaining() || _size > 500) {
            _size = 0;
            return;
        }
    ...
    protected void runImpl() {
        ...
        if (Config.ALT_MANOR_SAVE_ALL_ACTIONS) { CastleManager.getInstance().getCastleById(_manorId).saveSeedData(CastleManorManager.PERIOD_NEXT); }
    }
}