...
public class AdminBan implements IAdminCommandHandler {
    ...
    public boolean useAdminCommand(String command, L2PcInstance activeChar) {
        ...
        if (command.startsWith("admin_ban ") || command.equalsIgnoreCase("admin_ban")) {
            ...
            else { banChatOfflinePlayer(activeChar, player, duration, true); }
        }
            ...
            if (targetPlayer != null) {
                ...
                // TODO send unban to login server
            ...
            else { banChatOfflinePlayer(activeChar, player, 0, false); }
        }
            ...
            else { jailOfflinePlayer(activeChar, player, duration); }
        }
            ...
            else { unjailOfflinePlayer(activeChar, player); }
        }
        return true;
    }
