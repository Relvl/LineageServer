...
public class BoatInnadrilTour implements Runnable {
    ...
    public BoatInnadrilTour(L2BoatInstance boat) {
        ...
        ARRIVED_AT_INNADRIL = new CreatureSay(0, EChatType.BOAT, 801, SystemMessageId.INNADRIL_BOAT_ANCHOR_10_MINUTES);
        LEAVE_INNADRIL5 = new CreatureSay(0, EChatType.BOAT, 801, SystemMessageId.INNADRIL_BOAT_LEAVE_IN_5_MINUTES);
        LEAVE_INNADRIL1 = new CreatureSay(0, EChatType.BOAT, 801, SystemMessageId.INNADRIL_BOAT_LEAVE_IN_1_MINUTE);
        LEAVE_INNADRIL0 = new CreatureSay(0, EChatType.BOAT, 801, SystemMessageId.INNADRIL_BOAT_LEAVE_SOON);
        LEAVING_INNADRIL = new CreatureSay(0, EChatType.BOAT, 801, SystemMessageId.INNADRIL_BOAT_LEAVING);

        ARRIVAL20 = new CreatureSay(0, EChatType.BOAT, 801, SystemMessageId.INNADRIL_BOAT_ARRIVE_20_MINUTES);
        ARRIVAL15 = new CreatureSay(0, EChatType.BOAT, 801, SystemMessageId.INNADRIL_BOAT_ARRIVE_15_MINUTES);
        ARRIVAL10 = new CreatureSay(0, EChatType.BOAT, 801, SystemMessageId.INNADRIL_BOAT_ARRIVE_10_MINUTES);
