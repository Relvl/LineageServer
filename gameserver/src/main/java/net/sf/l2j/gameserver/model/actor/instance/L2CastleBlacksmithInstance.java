...
public class L2CastleBlacksmithInstance extends L2NpcInstance {
    ...
    public void onBypassFeedback(L2PcInstance player, String command) {
        ...
        if (validateCondition(player) != COND_OWNER) { return; }
    ...
    public void showChatWindow(L2PcInstance player, int val) {
        ...
        if (condition > COND_ALL_FALSE) {
            ...
            {
                if (val == 0) { filename = "data/html/castleblacksmith/castleblacksmith.htm"; }
                else { filename = "data/html/castleblacksmith/castleblacksmith-" + val + ".htm"; }
            }
        }
    ...
    protected int validateCondition(L2PcInstance player) {
        if (getCastle() != null && player.getClan() != null) {
            ...
            if (getCastle().getOwnerId() == player.getClanId() && (player.getClanPrivileges() & L2Clan.CP_CS_MANOR_ADMIN) == L2Clan.CP_CS_MANOR_ADMIN) { return COND_OWNER; }
        }
