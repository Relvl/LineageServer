...
public class Q021_HiddenTruth extends Quest {
    ...
    public String onAdvEvent(String event, L2Npc npc, L2PcInstance player) {
        ...
        if (event.equalsIgnoreCase("31522-02.htm")) {
            ...
            _vonHellmannPage.getAI().setIntention(EIntention.MOVE_TO, new HeadedLocation(52373, -54296, -3136, 0));
            _vonHellmannPage.broadcastNpcSay("Follow me...");
            startQuestTimer("2", 5000, _vonHellmannPage, player, false);
            return null;
        }
        else if (event.equalsIgnoreCase("2")) {
            _vonHellmannPage.getAI().setIntention(EIntention.MOVE_TO, new HeadedLocation(52279, -53064, -3161, 0));
            startQuestTimer("3", 12000, _vonHellmannPage, player, false);
            return null;
        }
        else if (event.equalsIgnoreCase("3")) {
            _vonHellmannPage.getAI().setIntention(EIntention.MOVE_TO, new HeadedLocation(51909, -51725, -3125, 0));
            startQuestTimer("4", 15000, _vonHellmannPage, player, false);
            return null;
        }
        else if (event.equalsIgnoreCase("4")) {
            _vonHellmannPage.getAI().setIntention(EIntention.MOVE_TO, new HeadedLocation(52438, -51240, -3097, 0));
            _vonHellmannPage.broadcastNpcSay("This where that here...");
            startQuestTimer("5", 5000, _vonHellmannPage, player, false);
            return null;
        }
        else if (event.equalsIgnoreCase("5")) {
            _vonHellmannPage.getAI().setIntention(EIntention.MOVE_TO, new HeadedLocation(52143, -51418, -3085, 0));
