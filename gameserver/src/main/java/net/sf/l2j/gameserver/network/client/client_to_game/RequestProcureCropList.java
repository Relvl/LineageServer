...
public class RequestProcureCropList extends L2GameClientPacket {
    ...
    private static class Crop {
        ...
        public boolean setCrop() {
            ...
            if (Config.ALT_MANOR_SAVE_ALL_ACTIONS) { CastleManager.getInstance().getCastleById(_manorId).updateCrop(_itemId, _crop.getAmount(), CastleManorManager.PERIOD_CURRENT); }
