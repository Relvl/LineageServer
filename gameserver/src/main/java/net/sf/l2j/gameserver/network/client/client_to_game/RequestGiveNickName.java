        ...
        if (activeChar.isNoble() && _target.matches(activeChar.getName())) {
            ...
            if (member != null) {
                ...
                if (playerMember != null) {
                    ...
                    if (activeChar != playerMember) { activeChar.sendPacket(SystemMessage.getSystemMessage(SystemMessageId.CLAN_MEMBER_S1_TITLE_CHANGED_TO_S2).addPcName(playerMember).addString(_title)); }
