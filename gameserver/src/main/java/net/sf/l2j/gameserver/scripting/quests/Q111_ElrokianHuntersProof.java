...
public class Q111_ElrokianHuntersProof extends Quest {
    ...
    public String onAdvEvent(String event, L2Npc npc, L2PcInstance player) {
        ...
        if (event.equalsIgnoreCase("32113-002.htm")) {
            ...
            st.set("cond", "7");
            st.playSound(ESound.EtcSound_elcroki_song_full);
        }
            ...
            st.rewardItems(ItemConst.ADENA_ID, 1022636);
    ...
    public String onTalk(L2Npc npc, L2PcInstance player) {
        ...
        switch (st.getState()) {
            ...
            case QuestState.STATE_STARTED:
                ...
                switch (npc.getNpcId()) {
                    case MARQUEZ:
                        if (cond == 1 || cond == 2) { htmltext = "32113-002.htm"; }
                        else if (cond == 3) { htmltext = "32113-003.htm"; }
                        else if (cond == 4) { htmltext = "32113-009.htm"; }
                        else if (cond == 5) { htmltext = "32113-010.htm"; }
                        break;
                    ...
                    case ASAMAH:
                        if (cond == 2) { htmltext = "32115-001.htm"; }
                        else if (cond == 3) { htmltext = "32115-002.htm"; }
                        else if (cond == 8) { htmltext = "32115-003.htm"; }
                        else if (cond == 9) { htmltext = "32115-004.htm"; }
                        else if (cond == 10) { htmltext = "32115-006.htm"; }
                        else if (cond == 11) {
                    ...
                    case KIRIKASHIN:
                        if (cond < 6) { htmltext = "32116-008.htm"; }
                        else if (cond == 6) {
                            htmltext = "32116-001.htm";
                            st.takeItems(EXPEDITION_LETTER, 1);
                        }
                        else if (cond == 7) { htmltext = "32116-004.htm"; }
                        else if (cond == 12) { htmltext = "32116-006.htm"; }
                        break;
                }
                break;
    ...
    public String onKill(L2Npc npc, L2PcInstance player, boolean isPet) {
        ...
        switch (npc.getNpcId()) {
            ...
            case 22198:
            case 22218:
                if (st.getInt("cond") == 4 && st.dropItems(FRAGMENT, 1, 50, 250000)) { st.set("cond", "5"); }
                break;
            ...
            case 22202:
            case 22219:
                if (st.getInt("cond") == 10 && st.dropItems(CLAW, 1, 10, 650000)) { if (st.getQuestItemsCount(BONE) >= 10 && st.getQuestItemsCount(SKIN) >= 10) { st.set("cond", "11"); } }
                break;
            ...
            case 22210:
            case 22221:
                if (st.getInt("cond") == 10 && st.dropItems(SKIN, 1, 10, 650000)) { if (st.getQuestItemsCount(CLAW) >= 10 && st.getQuestItemsCount(BONE) >= 10) { st.set("cond", "11"); } }
                break;
            ...
            case 22205:
            case 22220:
                if (st.getInt("cond") == 10 && st.dropItems(BONE, 1, 10, 650000)) { if (st.getQuestItemsCount(CLAW) >= 10 && st.getQuestItemsCount(SKIN) >= 10) { st.set("cond", "11"); } }
                break;
        }
