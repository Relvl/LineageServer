...
import net.sf.l2j.gameserver.network.client.game_to_client.ExShowVariationCancelWindow;
import net.sf.l2j.gameserver.network.client.game_to_client.ExShowVariationMakeWindow;
