    ...
    public String onTalk(L2Npc npc, L2PcInstance player) {
        ...
        switch (st.getState()) {
            case QuestState.STATE_CREATED:
                if (player.getClassId().level() != 1) { htmltext = "30191-01a.htm"; }
                else if (player.getRace() != PlayerRace.Human) { htmltext = "30191-02.htm"; }
                else if (player.getLevel() < 37) { htmltext = "30191-01.htm"; }
                else { htmltext = "30191-03.htm"; }
                break;
            ...
            case QuestState.STATE_STARTED:
                ...
                switch (npc.getNpcId()) {
                    case HOLLINT:
                        if (cond < 9) { htmltext = "30191-08.htm"; }
                        else if (cond == 9) {
                        ...
                        else if (cond > 9 && cond < 22) { htmltext = "30191-09.htm"; }
                        else if (cond == 22) {
                        ...
                        else if (cond == 23) { htmltext = "30191-07.htm"; }
                        break;

                    case ASTERIOS:
                        if (cond == 1) { htmltext = "30154-01.htm"; }
                        else if (cond == 2) { htmltext = "30154-04.htm"; }
                        else if (cond == 3) {
                        ...
                        else if (cond > 3) { htmltext = "30154-06.htm"; }
                        break;

                    case THIFIELL:
                        if (cond == 4) { htmltext = "30358-01.htm"; }
                        else if (cond > 4 && cond < 8) { htmltext = "30358-05.htm"; }
                        else if (cond == 8) {
                        ...
                        else if (cond > 8) { htmltext = "30358-04.htm"; }
                        break;
                    ...
                    case CLAYTON:
                        ...
                        else if (cond == 6) { htmltext = "30464-02.htm"; }
                        else if (cond > 6) {
                    ...
                    case SERESIN:
                        if (cond == 10 || cond == 11) { htmltext = "30657-01.htm"; }
                        else if (cond > 11 && cond < 22) { htmltext = "30657-04.htm"; }
                        else if (cond == 22) { htmltext = "30657-05.htm"; }
                        break;

                    case KAKAI:
                        if (cond == 12) { htmltext = "30565-01.htm"; }
                        else if (cond > 12 && cond < 16) { htmltext = "30565-03.htm"; }
                        else if (cond == 16) {
                        ...
                        else if (cond > 16) { htmltext = "30565-05.htm"; }
                        break;

                    case MANAKIA:
                        if (cond == 13) { htmltext = "30515-01.htm"; }
                        else if (cond == 14) { htmltext = "30515-03.htm"; }
                        else if (cond == 15) {
                        ...
                        else if (cond > 15) { htmltext = "30515-05.htm"; }
                        break;

                    case LOCKIRIN:
                        if (cond == 17) { htmltext = "30531-01.htm"; }
                        else if (cond > 17 && cond < 21) { htmltext = "30531-03.htm"; }
                        else if (cond == 21) {
                        ...
                        else if (cond == 22) { htmltext = "30531-05.htm"; }
                        break;

                    case NIKOLA:
                        if (cond == 18) { htmltext = "30621-01.htm"; }
                        else if (cond == 19) { htmltext = "30621-03.htm"; }
                        else if (cond == 20) {
                        ...
                        else if (cond > 20) { htmltext = "30621-05.htm"; }
                        break;
        ...
        switch (npcId) {
            ...
            case MARSH_STAKATO_DRONE:
                if (st.getInt("cond") == 6 && !st.hasQuestItems(STAKATO_ICHOR) && st.dropItemsAlways(STAKATO_FLUIDS, 1, 10)) {
                    ...
                    if (st.hasQuestItems(BASILIK_PLASMA, HONEY_DEW)) { st.set("cond", "7"); }
                }
                break;
            ...
            case ANT_WARRIOR_CAPTAIN:
                if (st.getInt("cond") == 6 && !st.hasQuestItems(HONEY_DEW) && st.dropItemsAlways(GIANT_APHID, 1, 10)) {
                    ...
                    if (st.hasQuestItems(BASILIK_PLASMA, STAKATO_ICHOR)) { st.set("cond", "7"); }
                }
                break;
            ...
            case GUARDIAN_BASILIK:
                if (st.getInt("cond") == 6 && !st.hasQuestItems(BASILIK_PLASMA) && st.dropItemsAlways(BLOOD_GUARDIAN_BASILIK, 1, 10)) {
                    ...
                    if (st.hasQuestItems(HONEY_DEW, STAKATO_ICHOR)) { st.set("cond", "7"); }
                }
                break;

            case WINDSUS:
                if (st.getInt("cond") == 14 && st.dropItems(PARASITE_OF_LOTA, 1, 10, 500000)) { st.set("cond", "15"); }
                break;

            case PORTA:
                if (st.getInt("cond") == 19 && st.dropItemsAlways(HEARTSTONE_OF_PORTA, 1, 10)) { st.set("cond", "20"); }
                break;
        }
