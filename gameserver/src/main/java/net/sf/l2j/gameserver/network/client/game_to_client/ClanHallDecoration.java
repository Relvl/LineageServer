...
public class ClanHallDecoration extends L2GameServerPacket {
    ...
    protected final void writeImpl() {
        ...
        if (_function == null || _function.getLvl() == 0) { writeC(0); }
        ...
        if (_function == null || _function.getLvl() == 0) { writeC(0); }
        else if (_function.getLvl() < 2) { writeC(1); }
        else { writeC(2); }
        ...
        if (_function == null || _function.getLvl() == 0) { writeC(0); }
        else if (_function.getLvl() <= 1) { writeC(1); }
        else { writeC(2); }

        // FUNC_ITEM_CREATE
        _function = _clanHall.getFunction(ClanHall.FUNC_ITEM_CREATE);
        if (_function == null || _function.getLvl() == 0) { writeC(0); }
        else if ((_clanHall.getGrade() == 0 && _function.getLvl() < 2) || _function.getLvl() < 3) { writeC(1); }
        else { writeC(2); }
