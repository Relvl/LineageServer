    ...
    public String onTalk(L2Npc npc, L2PcInstance player) {
        ...
        switch (st.getState()) {
            case QuestState.STATE_CREATED:
                if (st.hasQuestItems(CARADINE_LETTER)) { htmltext = (!player.isSubClassActive() || player.getLevel() < 75) ? "31740-02.htm" : "31740-01.htm"; }
                break;
            ...
            case QuestState.STATE_STARTED:
                ...
                switch (npc.getNpcId()) {
                    case CARADINE:
                        if (cond == 1) { htmltext = "31740-04.htm"; }
                        else if (cond == 2) { htmltext = "31740-06.htm"; }
                        break;

                    case LADY_OF_THE_LAKE:
                        if (cond == 2) { htmltext = (player.getLevel() < 75) ? "31745-06.htm" : "31745-01.htm"; }
                        break;
                }
                break;
