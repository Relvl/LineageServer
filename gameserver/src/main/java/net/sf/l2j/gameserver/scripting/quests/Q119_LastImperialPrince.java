...
public class Q119_LastImperialPrince extends Quest {
    ...
    public String onAdvEvent(String event, L2Npc npc, L2PcInstance player) {
        ...
        if (event.equalsIgnoreCase("31453-04.htm")) {
            ...
            st.rewardItems(ItemConst.ADENA_ID, 68787);
            ...
            case QuestState.STATE_STARTED:
                ...
                switch (npc.getNpcId()) {
                    case NAMELESS_SPIRIT:
                        if (cond == 1) { htmltext = "31453-04a.htm"; }
                        else if (cond == 2) { htmltext = "31453-05.htm"; }
                        break;

                    case DEVORIN:
                        if (cond == 1) { htmltext = "32009-01.htm"; }
                        else if (cond == 2) { htmltext = "32009-04.htm"; }
                        break;
                }
                break;
