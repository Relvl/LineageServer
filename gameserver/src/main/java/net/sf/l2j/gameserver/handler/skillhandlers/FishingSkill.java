...
public class FishingSkill implements ISkillHandler {
    ...
    public void useSkill(L2Character activeChar, L2Skill skill, L2Object[] targets) {
        ...
        if (weaponInst == null || weaponItem == null) { return; }

        int SS = 1;
        int pen = 0;
        if (activeChar.isChargedShot(ShotType.FISH_SOULSHOT)) { SS = 2; }
        ...
        if (SS > 1) { weaponInst.setChargedShot(ShotType.FISH_SOULSHOT, false); }
