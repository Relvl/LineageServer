...
public final class RequestStartPledgeWar extends L2GameClientPacket {
    ...
    protected void runImpl() {
        ...
        for (L2PcInstance member : attackedClan.getOnlineMembers()) { member.broadcastUserInfo(); }

        for (L2PcInstance member : attackerClan.getOnlineMembers()) { member.broadcastUserInfo(); }
    }
}