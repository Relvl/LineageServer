...
public class CellPathFindingStd extends PathCheckerStd {
    ...
    public CellPathFindingStd() {
        ...
        for (int i = 0; i < array.length; i++) {
            ...
            try {
                ...
                LOGGER.error("CellPathFindingStd: Can not load buffer setting: " + buf);
            }
        }

        LOGGER.info("CellPathFindingStd: Loaded " + count + " node buffers.");
    }
    ...
    private static final class BufferHolder {
        ...
        public BufferHolder(int size, int count) {
            ...
            for (int i = 0; i < count; i++) { _buffer.add(new NodeBufferStd(size)); }
        }
    ...
    public List<String> getStat() {
        ...
        if (_postFilterUses > 0) { list.add("Time (ms): total=" + _postFilterElapsed + " avg=" + String.format("%1.2f", (double) _postFilterElapsed / _postFilterUses)); }
