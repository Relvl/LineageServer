...
public class Q022_TragedyInVonHellmannForest extends Quest {
    ...
    private static L2Npc _ghostOfPriestInstance;
    private static L2Npc _soulOfWellInstance;
    ...
    public String onAdvEvent(String event, L2Npc npc, L2PcInstance player) {
        ...
        if (event.equalsIgnoreCase("31334-03.htm")) {
            ...
            if (st2 != null && st2.isCompleted() && player.getLevel() >= 63) { htmltext = "31334-02.htm"; }
        }
            ...
            if (!st.hasQuestItems(CROSS_OF_EINHASAD)) { st.set("cond", "2"); }
            else { htmltext = "31334-06.htm"; }
        }
    ...
    public String onTalk(L2Npc npc, L2PcInstance player) {
        ...
        switch (st.getState()) {
            ...
            case QuestState.STATE_STARTED:
                ...
                switch (npc.getNpcId()) {
                    case TIFAREN:
                        if (cond == 1 || cond == 2 || cond == 3) { htmltext = "31334-05.htm"; }
                        else if (cond == 4) { htmltext = "31334-09.htm"; }
                        else if (cond == 5 || cond == 6) {
                            if (st.hasQuestItems(LOST_SKULL_OF_ELF)) { htmltext = (_ghostOfPriestInstance == null) ? "31334-10.htm" : "31334-11.htm"; }
                            else {
                                htmltext = "31334-09.htm";
                                st.set("cond", "4");
                            }
                        }
                        else if (cond == 7) { htmltext = (_ghostOfPriestInstance != null) ? "31334-15.htm" : "31334-17.htm"; }
                        else if (cond > 7) { htmltext = "31334-18.htm"; }
                        break;
                    ...
                    case INNOCENTIN:
                        ...
                        else if (cond == 3) { htmltext = "31328-02.htm"; }
                        else if (cond == 8) { htmltext = "31328-03.htm"; }
                        else if (cond == 9) { htmltext = "31328-11.htm"; }
                        else if (cond == 14) {
                            if (st.hasQuestItems(REPORT_BOX)) { htmltext = "31328-12.htm"; }
                            else { st.set("cond", "13"); }
                        }
                        else if (cond == 15) { htmltext = "31328-14.htm"; }
                        else if (cond == 16) {
                    ...
                    case GHOST_OF_PRIEST:
                        if (cond == 7) { htmltext = "31528-01.htm"; }
                        else if (cond == 8) { htmltext = "31528-08.htm"; }
                        break;

                    case GHOST_OF_ADVENTURER:
                        if (cond == 9) {
                            if (st.hasQuestItems(LETTER_OF_INNOCENTIN)) { htmltext = "31529-01.htm"; }
                            else {
                                htmltext = "31529-10.htm";
                                st.set("cond", "8");
                            }
                        }
                        else if (cond == 10) { htmltext = "31529-16.htm"; }
                        else if (cond == 11) {
                        ...
                        else if (cond == 12) { htmltext = "31529-17.htm"; }
                        else if (cond == 13) {
                        ...
                        else if (cond > 13) { htmltext = "31529-19.htm"; }
                        break;

                    case WELL:
                        if (cond == 10) { htmltext = "31527-01.htm"; }
                        else if (cond == 11) { htmltext = "31527-03.htm"; }
                        else if (cond == 12) {
                        ...
                        else if (cond > 12) { htmltext = "31527-05.htm"; }
                        break;
                }
                break;
    ...
    public String onAttack(L2Npc npc, L2PcInstance attacker, int damage, boolean isPet) {
        ...
        if (st == null || !st.isStarted() || isPet) { return null; }
