...
public class Q226_TestOfTheHealer extends Quest {
    ...
    public String onAdvEvent(String event, L2Npc npc, L2PcInstance player) {
        ...
        if (event.equalsIgnoreCase("30473-04a.htm")) {
            ...
            if (player.getClassId() == ClassId.knight) { st.giveItems(DIMENSIONAL_DIAMOND, 104); }
            else if (player.getClassId() == ClassId.elvenKnight) { st.giveItems(DIMENSIONAL_DIAMOND, 72); }
            else if (player.getClassId() == ClassId.cleric) { st.giveItems(DIMENSIONAL_DIAMOND, 60); }
            else { st.giveItems(DIMENSIONAL_DIAMOND, 45); }
        }
        ...
        // GUPU
            ...
            else { htmltext = "30658-05.htm"; }
        }
        else if (event.equalsIgnoreCase("30658-03.htm")) { st.set("gupu", "1"); }
    ...
    public String onTalk(L2Npc npc, L2PcInstance player) {
        ...
        switch (st.getState()) {
            case QuestState.STATE_CREATED:
                if (player.getClassId() != ClassId.knight && player.getClassId() != ClassId.elvenKnight && player.getClassId() != ClassId.cleric && player.getClassId() != ClassId.oracle) { htmltext = "30473-01.htm"; }
                else if (player.getLevel() < 39) { htmltext = "30473-02.htm"; }
                else { htmltext = "30473-03.htm"; }
                break;
            ...
            case QuestState.STATE_STARTED:
                ...
                switch (npc.getNpcId()) {
                    case BANDELLOS:
                        if (cond < 23) { htmltext = "30473-05.htm"; }
                        else {
                            ...
                            else { htmltext = "30473-07.htm"; }
                        }
                        break;

                    case PERRIN:
                        if (cond < 3) { htmltext = "30428-01.htm"; }
                        else if (cond == 3) {
                    ...
                    case ALLANA:
                        ...
                        else if (cond > 4) { htmltext = "30424-02.htm"; }
                        break;
                    ...
                    case GUPU:
                        ...
                        else if (cond == 6) { htmltext = "30658-01.htm"; }
                        else if (cond == 7) { htmltext = "30658-04.htm"; }
                        else if (cond == 8) {
                            htmltext = "30658-06.htm";
                            st.takeItems(WINDY_PEBBLES, 1);
                            st.giveItems(GOLDEN_STATUE, 1);
                        }
                        else if (cond > 8) { htmltext = "30658-07.htm"; }
                        break;

                    case WINDY_SHAORING:
                        if (cond == 7) { htmltext = "30660-01.htm"; }
                        else if (st.hasQuestItems(WINDY_PEBBLES)) { htmltext = "30660-04.htm"; }
                        break;
                    ...
                    case SORIUS:
                        ...
                        else if (cond > 9 && cond < 22) { htmltext = "30327-02.htm"; }
                        else if (cond == 22) {
                        ...
                        else if (cond == 23) { htmltext = "30327-04.htm"; }
                        break;

                    case DAURIN_HAMMERCRUSH:
                        if (cond == 10) { htmltext = "30674-01.htm"; }
                        else if (cond == 11) {
                        ...
                        else if (cond > 12) { htmltext = "30674-04.htm"; }
                        break;

                    case PIPER_LONGBOW:
                    case SLEIN_SHINING_BLADE:
                    case KAIN_FLYING_KNIFE:
                        if (cond == 13 || cond == 14) { htmltext = npc.getNpcId() + "-01.htm"; }
                        else if (cond > 14 && cond < 19) { htmltext = npc.getNpcId() + "-02.htm"; }
                    ...
                    case MYSTERIOUS_DARKELF:
                        ...
                        else if (cond == 14) { htmltext = "30661-01.htm"; }
                        else if (cond == 15) {
                        ...
                        else if (cond == 16) { htmltext = "30661-02.htm"; }
                        else if (cond == 17) {
                        ...
                        else if (cond == 18) { htmltext = "30661-03.htm"; }
                        else if (cond == 19) {
                            htmltext = "30661-04.htm";
                            st.set("cond", "20");
                            st.playSound(ESound.ItemSound_quest_middle);
                        }
                        else if (cond == 20 || cond == 21) { htmltext = "30661-04.htm"; }
                        break;

                    case KRISTINA:
                        if (cond > 18 && cond < 22) { htmltext = "30665-01.htm"; }
                        else if (cond > 21) { htmltext = "30665-04.htm"; }
                        else { htmltext = "30665-03.htm"; }
                        break;
                }
                break;
