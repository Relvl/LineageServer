...
public class Clan extends Quest {
    ...
    public String onAdvEvent(String event, L2Npc npc, L2PcInstance player) {
        switch (event) {
            case "9000-03.htm":
                if (!player.isClanLeader()) { return "9000-03-no.htm"; }

            case "9000-04.htm":
                if (!player.isClanLeader()) { return "9000-04-no.htm"; }

            case "9000-05.htm":
                if (!player.isClanLeader()) { return "9000-05-no.htm"; }
            ...
            case "9000-14a.htm":
            case "9000-15.htm":
                if (!player.isClanLeader()) { return "9000-07-no.htm"; }
        }
