...
public class Q211_TrialOfTheChallenger extends Quest {
        ...
        // CHEST_OF_SHYSLASSYS
            ...
            if (st.hasQuestItems(BROKEN_KEY)) {
                if (Rnd.get(10) < 2) {
                    ...
                    st.playSound(ESound.ItemSound_quest_jackpot);
                    ...
                    else if (chance > 40) { st.rewardItems(WHITE_TUNIC_PATTERN, 1); }
                    else { st.rewardItems(IRON_BOOTS_DESIGN, 1); }
                }
                else {
    ...
    public String onTalk(L2Npc npc, L2PcInstance player) {
        ...
        switch (st.getState()) {
            case QuestState.STATE_CREATED:
                ...
                else if (player.getLevel() < 35) { htmltext = "30644-01.htm"; }
                else { htmltext = "30644-03.htm"; }
                break;
            ...
            case QuestState.STATE_STARTED:
                ...
                switch (npc.getNpcId()) {
                    case KASH:
                        if (cond == 1) { htmltext = "30644-06.htm"; }
                        else if (cond == 2) {
                        ...
                        else if (cond == 3) { htmltext = "30644-08.htm"; }
                        else if (cond > 3) { htmltext = "30644-09.htm"; }
                        break;
                    ...
                    case MARTIEN:
                        if (cond == 3) { htmltext = "30645-01.htm"; }
                        else if (cond == 4) { htmltext = "30645-03.htm"; }
                        else if (cond == 5) {
                        ...
                        else if (cond == 6) { htmltext = "30645-05.htm"; }
                        else if (cond == 7) { htmltext = "30645-07.htm"; }
                        else if (cond > 7) { htmltext = "30645-06.htm"; }
                        break;

                    case RALDO:
                        if (cond == 7) { htmltext = "30646-01.htm"; }
                        else if (cond == 8) { htmltext = "30646-06a.htm"; }
                        else if (cond == 10) {
                    ...
                    case FILAUR:
                        if (cond == 8) {
                            ...
                            else { htmltext = "30535-03.htm"; }
                        }
                        else if (cond == 9) {
                            htmltext = "30535-02.htm";
                            st.addRadar(176560, -184969, -3729);
                        }
                        else if (cond == 10) { htmltext = "30535-04.htm"; }
                        break;
                }
                break;
    ...
    public String onKill(L2Npc npc, L2PcInstance player, boolean isPet) {
        ...
        switch (npc.getNpcId()) {
            ...
            case GORR:
                if (st.getInt("cond") == 4 && st.dropItemsAlways(WATCHER_EYE_1, 1, 1)) { st.set("cond", "5"); }
                break;

            case BARAHAM:
                if (st.getInt("cond") == 6 && st.dropItemsAlways(WATCHER_EYE_2, 1, 1)) { st.set("cond", "7"); }
