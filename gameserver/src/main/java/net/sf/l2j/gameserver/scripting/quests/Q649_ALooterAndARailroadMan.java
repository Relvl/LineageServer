...
public class Q649_ALooterAndARailroadMan extends Quest {
    ...
    public String onAdvEvent(String event, L2Npc npc, L2PcInstance player) {
        ...
        if (event.equalsIgnoreCase("32052-1.htm")) {
            ...
            if (st.getQuestItemsCount(THIEF_GUILD_MARK) < 200) { htmltext = "32052-3a.htm"; }
            else {
                st.takeItems(THIEF_GUILD_MARK, -1);
                st.rewardItems(ItemConst.ADENA_ID, 21698);
    ...
    public String onTalk(L2Npc npc, L2PcInstance player) {
        ...
        switch (st.getState()) {
            ...
            case QuestState.STATE_STARTED:
                ...
                if (cond == 1) { htmltext = "32052-2a.htm"; }
                else if (cond == 2) { htmltext = "32052-2.htm"; }
                break;
        }
        return htmltext;
    }
    ...
    public String onKill(L2Npc npc, L2PcInstance player, boolean isPet) {
        ...
        if (st.dropItems(THIEF_GUILD_MARK, 1, 200, 800000)) { st.set("cond", "2"); }
