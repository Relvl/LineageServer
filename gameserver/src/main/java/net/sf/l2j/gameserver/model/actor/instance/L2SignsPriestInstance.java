...
public class L2SignsPriestInstance extends L2NpcInstance {
    ...
    public void onBypassFeedback(L2PcInstance player, String command) {
        if (player.getCurrentFolkNPC() == null || player.getCurrentFolkNPC().getObjectId() != getObjectId()) { return; }
        ...
        if (command.startsWith("SevenSignsDesc")) {
            ...
            switch (val) {
                case 2: // Purchase Record of the Seven Signs
                    ...
                    if (this instanceof L2DawnPriestInstance) { showChatWindow(player, val, "dawn", false); }
                    else { showChatWindow(player, val, "dusk", false); }
                    break;
                ...
                case 33: // "I want to participate" request
                    ...
                    if (oldCabal != SevenSigns.CABAL_NULL) {
                        if (this instanceof L2DawnPriestInstance) { showChatWindow(player, val, "dawn_member", false); }
                        else { showChatWindow(player, val, "dusk_member", false); }
                        return;
                    }
                    else if (player.getClassId().level() == 0) {
                        if (this instanceof L2DawnPriestInstance) { showChatWindow(player, val, "dawn_firstclass", false); }
                        else { showChatWindow(player, val, "dusk_firstclass", false); }
                        return;
                    }
                ...
                case 34: // Pay the participation fee request
                    ...
                    if (player.getClassId().level() < 2 || (adena != null && adena.getCount() >= SevenSigns.ADENA_JOIN_DAWN_COST) || (certif != null && certif.getCount() >= 1)) { fee = false; }

                    if (fee) { showChatWindow(player, SevenSigns.SEVEN_SIGNS_HTML_PATH + "signs_33_dawn_no.htm"); }
                    else { showChatWindow(player, SevenSigns.SEVEN_SIGNS_HTML_PATH + "signs_33_dawn.htm"); }
                    break;
                ...
                case 5:
                    if (this instanceof L2DawnPriestInstance) {
                        if (SevenSigns.getInstance().getPlayerCabal(player.getObjectId()) == SevenSigns.CABAL_NULL) { showChatWindow(player, val, "dawn_no", false); }
                        else { showChatWindow(player, val, "dawn", false); }
                    }
                    else {
                        if (SevenSigns.getInstance().getPlayerCabal(player.getObjectId()) == SevenSigns.CABAL_NULL) { showChatWindow(player, val, "dusk_no", false); }
                        else { showChatWindow(player, val, "dusk", false); }
                    }
                    break;
                ...
                case 21:
                    ...
                    try {
                        ...
                        if (this instanceof L2DawnPriestInstance) { showChatWindow(player, 6, "dawn_failure", false); }
                        else { showChatWindow(player, 6, "dusk_failure", false); }
                        break;
                    }
                    ...
                    switch (contribStoneId) {
                        case SevenSigns.SEAL_STONE_BLUE_ID:
                            ...
                            if (blueContrib > contribBlueStoneCount) { blueContrib = contributionCount; }
                            break;

                        case SevenSigns.SEAL_STONE_GREEN_ID:
                            greenContrib = (Config.ALT_MAXIMUM_PLAYER_CONTRIB - score) / SevenSigns.GREEN_CONTRIB_POINTS;
                            if (greenContrib > contribGreenStoneCount) { greenContrib = contributionCount; }
                            break;

                        case SevenSigns.SEAL_STONE_RED_ID:
                            redContrib = (Config.ALT_MAXIMUM_PLAYER_CONTRIB - score) / SevenSigns.RED_CONTRIB_POINTS;
                            if (redContrib > contribRedStoneCount) { redContrib = contributionCount; }
                            break;
                    }
                    ...
                    if (!contribStonesFound) {
                        ...
                        else { showChatWindow(player, 6, "dusk_low_stones", false); }
                    }
                    else {
                        ...
                        if (this instanceof L2DawnPriestInstance) { showChatWindow(player, 6, "dawn", false); }
                        else { showChatWindow(player, 6, "dusk", false); }
                    }
                    break;
                    ...
                    if (contribScore == Config.ALT_MAXIMUM_PLAYER_CONTRIB) {
                        ...
                        switch (stoneType) {
                            ...
                            case 4:
                                ...
                                if (greenContribCount > greenStoneCount) { greenContribCount = greenStoneCount; }
                                ...
                                if (!stonesFound) {
                                    ...
                                    else { showChatWindow(player, val, "dusk_no_stones", false); }
                                }
                                else {
                        ...
                        if (this instanceof L2DawnPriestInstance) { path = SevenSigns.SEVEN_SIGNS_HTML_PATH + "signs_6_dawn_contribute.htm"; }
                        else { path = SevenSigns.SEVEN_SIGNS_HTML_PATH + "signs_6_dusk_contribute.htm"; }
                ...
                case 9: // Receive Contribution Rewards
                    ...
                    if (SevenSigns.getInstance().isSealValidationPeriod() && playerCabal == winningCabal) {
                        ...
                        if (ancientAdenaReward < 3) {
                            if (this instanceof L2DawnPriestInstance) { showChatWindow(player, 9, "dawn_b", false); }
                            else { showChatWindow(player, 9, "dusk_b", false); }
                            break;
                        }
                ...
                case 17: // Exchange Seal Stones for Ancient Adena (Type Choice) - SevenSigns 17 x
                    ...
                    switch (stoneType) {
                        ...
                        case 4:
                            ...
                            if (ancientAdenaRewardAll == 0) {
                                if (this instanceof L2DawnPriestInstance) { showChatWindow(player, 18, "dawn_no_stones", false); }
                                else { showChatWindow(player, 18, "dusk_no_stones", false); }
                                return;
                            }
                    ...
                    if (this instanceof L2DawnPriestInstance) { path = SevenSigns.SEVEN_SIGNS_HTML_PATH + "signs_17_dawn.htm"; }
                    else { path = SevenSigns.SEVEN_SIGNS_HTML_PATH + "signs_17_dusk.htm"; }
                ...
                case 18: // Exchange Seal Stones for Ancient Adena - SevenSigns 18 xxxx xxxxxx
                    ...
                    try {
                        ...
                        if (this instanceof L2DawnPriestInstance) { showChatWindow(player, 18, "dawn_failed", false); }
                        else { showChatWindow(player, 18, "dusk_failed", false); }
                        break;
                    }
                    ...
                    if (convertItem != null) {
                        ...
                        if (convertCount <= totalCount && convertCount > 0) {
                            ...
                            if (this instanceof L2DawnPriestInstance) { showChatWindow(player, 18, "dawn_low_stones", false); }
                            else { showChatWindow(player, 18, "dusk_low_stones", false); }
                            break;
                        }
                    }
                    else {
                ...
                case 20: // Seal Status (for when joining a cabal)
                    ...
                    if (this instanceof L2DawnPriestInstance) { sb.append("<html><body>Priest of Dawn:<br><font color=\"LEVEL\">[ Seal Status ]</font><br>"); }
                    else { sb.append("<html><body>Dusk Priestess:<br><font color=\"LEVEL\">[ Status of the Seals ]</font><br>"); }

                    for (int i = 1; i < 4; i++) {
                        int sealOwner = SevenSigns.getInstance().getSealOwner(i);

                        if (sealOwner != SevenSigns.CABAL_NULL) { sb.append("[" + SevenSigns.getSealName(i, false) + ": " + SevenSigns.getCabalName(sealOwner) + "]<br>"); }
                        else { sb.append("[" + SevenSigns.getSealName(i, false) + ": Nothingness]<br>"); }
                    }
