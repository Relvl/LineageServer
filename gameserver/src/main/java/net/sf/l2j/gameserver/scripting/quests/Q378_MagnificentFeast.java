    ...
    public String onTalk(L2Npc npc, L2PcInstance player) {
        ...
        switch (st.getState()) {
            ...
            case QuestState.STATE_STARTED:
                ...
                if (cond == 1) { htmltext = "30594-3.htm"; }
                else if (cond == 2) { htmltext = (!st.hasQuestItems(MUSICAL_SCORE)) ? "30594-5.htm" : "30594-5a.htm"; }
                else if (cond == 3) { htmltext = "30594-7.htm"; }
                else if (cond == 4) {
                    ...
                    if (REWARDS.containsKey(score) && st.hasQuestItems(RITRON_DESSERT)) {
                        ...
                        if (adena > 0) { st.rewardItems(ItemConst.ADENA_ID, adena); }

                        st.playSound(ESound.ItemSound_quest_finish);
                        st.exitQuest(true);
                    }
                    else { htmltext = "30594-9.htm"; }
                }
        }
