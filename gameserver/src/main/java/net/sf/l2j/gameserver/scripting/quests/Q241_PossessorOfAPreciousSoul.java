...
public class Q241_PossessorOfAPreciousSoul extends Quest {
    ...
    public String onTalk(L2Npc npc, L2PcInstance player) {
        ...
        switch (st.getState()) {
            ...
            case QuestState.STATE_STARTED:
                if (!player.isSubClassActive()) { break; }

                int cond = st.getInt("cond");
                switch (npc.getNpcId()) {
                    case TALIEN:
                        if (cond == 1) { htmltext = "31739-04.htm"; }
                        else if (cond == 2 || cond == 3) { htmltext = "31739-05.htm"; }
                        else if (cond == 4) { htmltext = "31739-06.htm"; }
                        else if (cond == 5) { htmltext = "31739-08.htm"; }
                        else if (cond == 8) { htmltext = "31739-09.htm"; }
                        else if (cond == 9) { htmltext = "31739-11.htm"; }
                        else if (cond == 10) { htmltext = "31739-12.htm"; }
                        else if (cond == 11) { htmltext = "31739-14.htm"; }
                        break;

                    case GABRIELLE:
                        if (cond == 1) { htmltext = "30753-01.htm"; }
                        else if (cond == 2) { htmltext = "30753-03.htm"; }
                        break;

                    case GILMORE:
                        if (cond == 2) { htmltext = "30754-01.htm"; }
                        else if (cond == 3) { htmltext = "30754-03.htm"; }
                        break;

                    case KANTABILON:
                        if (cond == 5) { htmltext = "31042-01.htm"; }
                        else if (cond == 6) { htmltext = "31042-03.htm"; }
                        else if (cond == 7) { htmltext = "31042-04.htm"; }
                        else if (cond == 8) { htmltext = "31042-06.htm"; }
                        break;

                    case STEDMIEL:
                        if (cond == 9) { htmltext = "30692-01.htm"; }
                        else if (cond == 10) { htmltext = "30692-03.htm"; }
                        break;

                    case VIRGIL:
                        if (cond == 11) { htmltext = "31742-01.htm"; }
                        else if (cond == 12) { htmltext = "31742-03.htm"; }
                        else if (cond == 17) { htmltext = "31742-04.htm"; }
                        else if (cond == 18) { htmltext = "31742-06.htm"; }
                        break;

                    case OGMAR:
                        if (cond == 12) { htmltext = "31744-01.htm"; }
                        else if (cond == 13) { htmltext = "31744-03.htm"; }
                        break;

                    case RAHORAKTI:
                        if (cond == 13) { htmltext = "31336-01.htm"; }
                        else if (cond == 14) { htmltext = "31336-03.htm"; }
                        else if (cond == 15) { htmltext = "31336-04.htm"; }
                        else if (cond == 16) { htmltext = "31336-06.htm"; }
                        break;

                    case KASSANDRA:
                        if (cond == 16) { htmltext = "31743-01.htm"; }
                        else if (cond == 17) { htmltext = "31743-03.htm"; }
                        break;

                    case CARADINE:
                        if (cond == 18) { htmltext = "31740-01.htm"; }
                        else if (cond == 19) { htmltext = "31740-03.htm"; }
                        else if (cond == 21) { htmltext = "31740-04.htm"; }
                        break;

                    case NOEL:
                        if (cond == 19) { htmltext = "31272-01.htm"; }
                        else if (cond == 20) {
                            if (st.hasQuestItems(HELLFIRE_OIL) && st.getQuestItemsCount(LUNARGENT) >= 5) { htmltext = "31272-04.htm"; }
                            else { htmltext = "31272-03.htm"; }
                        }
                        else if (cond == 21) { htmltext = "31272-06.htm"; }
                        break;
                }
                break;
    ...
    public String onKill(L2Npc npc, L2PcInstance player, boolean isPet) {
        ...
        if (st == null || !player.isSubClassActive()) { return null; }
        ...
        switch (npc.getNpcId()) {
            ...
            case MALRUK_SUCCUBUS_2:
                if (st.getInt("cond") == 6 && st.dropItems(MALRUK_SUCCUBUS_CLAW, 1, 10, 100000)) { st.set("cond", "7"); }
                break;

            case MALRUK_SUCCUBUS_TUREN_1:
            case MALRUK_SUCCUBUS_TUREN_2:
                if (st.getInt("cond") == 6 && st.dropItems(MALRUK_SUCCUBUS_CLAW, 1, 10, 120000)) { st.set("cond", "7"); }
                break;
            ...
            case SPLINTER_STAKATO_DRONE_2:
                if (st.getInt("cond") == 14 && st.dropItems(CRIMSON_MOSS, 1, 5, 100000)) { st.set("cond", "15"); }
                break;
        }
        return null;
    }
