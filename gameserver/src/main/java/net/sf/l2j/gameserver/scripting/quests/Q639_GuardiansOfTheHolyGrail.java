...
public class Q639_GuardiansOfTheHolyGrail extends Quest {
    ...
    public Q639_GuardiansOfTheHolyGrail() {
        ...
        for (int id : CHANCES.keySet()) { addKillId(id); }
    }
    ...
    public String onAdvEvent(String event, L2Npc npc, L2PcInstance player) {
        ...
        if (event.equalsIgnoreCase("31350-04.htm")) {
            ...
            int count = st.getQuestItemsCount(SCRIPTURE);
        ...
        switch (st.getState()) {
            ...
            case QuestState.STATE_STARTED:
                ...
                switch (npc.getNpcId()) {
                    ...
                    case GREMORY:
                        if (cond == 1) { htmltext = "32008-01.htm"; }
                        else if (cond == 2) { htmltext = "32008-06.htm"; }
                        else if (cond == 3) { htmltext = "32008-08.htm"; }
                        else if (cond == 4) { htmltext = "32008-10.htm"; }
                        break;

                    case HOLY_GRAIL:
                        if (cond == 2) { htmltext = "32028-01.htm"; }
                        else if (cond > 2) { htmltext = "32028-03.htm"; }
                        break;
                }
                break;
        }
