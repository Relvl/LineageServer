    ...
    public String onTalk(L2Npc npc, L2PcInstance player) {
        ...
        switch (st.getState()) {
            case QuestState.STATE_CREATED:
                if (player.getRace() != PlayerRace.Elf) { htmltext = "30146-01.htm"; }
                else if (player.getLevel() < 3) { htmltext = "30146-01a.htm"; }
                else { htmltext = "30146-02.htm"; }
                break;
            ...
            case QuestState.STATE_STARTED:
                ...
                switch (npc.getNpcId()) {
                    case MIRABEL:
                        if (cond == 1 || cond == 2) { htmltext = "30146-04.htm"; }
                        else if (cond == 3) { htmltext = "30146-05.htm"; }
                        break;

                    case ARIEL:
                        if (cond == 1) { htmltext = "30148-01.htm"; }
                        else if (cond == 2) { htmltext = "30148-03.htm"; }
                        break;

                    case ASTERIOS:
                        if (cond == 2) { htmltext = "30154-01.htm"; }
                        else if (cond == 3) { htmltext = "30154-03.htm"; }
                        break;
                }
                break;
