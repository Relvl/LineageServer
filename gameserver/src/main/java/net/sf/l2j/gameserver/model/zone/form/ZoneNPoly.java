...
public class ZoneNPoly extends L2ZoneForm {
    ...
    public boolean isIntersectsRectangle(int ax1, int ax2, int ay1, int ay2) {
        ...
        for (int i = 0; i < _y.length; i++) {
            ...
            if (isLineSegmentsIntersect(tX, tY, uX, uY, ax1, ay1, ax1, ay2)) { return true; }
            if (isLineSegmentsIntersect(tX, tY, uX, uY, ax1, ay1, ax2, ay1)) { return true; }
            if (isLineSegmentsIntersect(tX, tY, uX, uY, ax2, ay2, ax1, ay2)) { return true; }
            if (isLineSegmentsIntersect(tX, tY, uX, uY, ax2, ay2, ax2, ay1)) { return true; }
        }
    ...
    public void visualizeZone(int z) {
        for (int i = 0; i < _x.length; i++) {
            ...
            if (nextIndex == _x.length) { nextIndex = 0; }
