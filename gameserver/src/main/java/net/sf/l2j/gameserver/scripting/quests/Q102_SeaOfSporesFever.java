...
public class Q102_SeaOfSporesFever extends Quest {
    ...
    public String onTalk(L2Npc npc, L2PcInstance player) {
        ...
        switch (st.getState()) {
            case QuestState.STATE_CREATED:
                if (player.getRace() != PlayerRace.Elf) { htmltext = "30284-00.htm"; }
                else if (player.getLevel() < 12) { htmltext = "30284-08.htm"; }
                else { htmltext = "30284-07.htm"; }
                break;
            ...
            case QuestState.STATE_STARTED:
                ...
                switch (npc.getNpcId()) {
                    case ALBERIUS:
                        if (cond == 1) { htmltext = "30284-03.htm"; }
                        else if (cond == 2 || cond == 3) { htmltext = "30284-09.htm"; }
                        else if (cond == 4) {
                        ...
                        else if (cond == 5) { htmltext = "30284-05.htm"; }
                        else if (cond == 6) {
                    ...
                    case COBENDELL:
                        ...
                        else if (cond == 2) { htmltext = "30156-04.htm"; }
                        else if (cond == 5) { htmltext = "30156-07.htm"; }
                        else if (cond == 3) {
                        ...
                        else if (cond == 4) { htmltext = "30156-06.htm"; }
                        break;
    ...
    public String onKill(L2Npc npc, L2PcInstance player, boolean isPet) {
        ...
        if (st.dropItems(DRYAD_TEARS, 1, 10, 300000)) { st.set("cond", "3"); }
    ...
    private static void checkItem(QuestState st, int itemId) {
        if (st.hasQuestItems(itemId)) {
            ...
            else { st.set("medicines", String.valueOf(medicinesLeft)); }
        }
    }
}